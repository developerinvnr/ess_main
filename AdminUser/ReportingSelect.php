...
<?php  $sql2 = mysql_query("SELECT * FROM core_designation WHERE id=".$Res['DesigId'], $con) or die(mysql_error()); $Res2 = mysql_fetch_assoc($sql2); ?>
	 <input type="hidden" class="All_180" id="RepDesigName"  value="<?php echo $Res2['designation_name']; ?>" >
