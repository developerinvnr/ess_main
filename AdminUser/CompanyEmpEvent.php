...
<html>
<title><?php if ($_REQUEST['v'] == 'C') {
            echo 'Corporate Anniversary';
         } elseif ($_REQUEST['v'] == 'M') {
   ...
   <center>
      <table border="0">
         <tr>
            ...
            <td style="width:950px;display:<?php if ($_REQUEST['v'] == 'C') {
                                                echo 'block';
                                             } else {
                                                echo 'none';
                                             } ?>;" />
            <?php $Y = date("Y");
            if (date("m") == 01 or date("m") == 03 or date("m") == 05 or date("m") == 07 or date("m") == 08 or date("m") == 10 or date("m") == 12) {
               $day = 31;
            } elseif (date("m") == 02) {
               if ($Y == 2012 or $Y == 2016 or $Y == 2020 or $Y == 2024 or $Y == 2028 or $Y == 2032 or $Y == 2036 or $Y == 2040) {
                  $day = 29;
               } else {
                  $day = 28;
               }
            } elseif (date("m") == 04 or date("m") == 06 or date("m") == 09 or date("m") == 11) {
               $day = 30;
            }
            $Be_7D_1 = date("Y-m-01", strtotime('-2555 day'));
            $Be_7D_2 = date("Y-m-31" . $day, strtotime('-2555 day'));
            $Be_5D_1 = date("Y-m-01", strtotime('-1825 day'));
            $Be_5D_2 = date("Y-m-31" . $day, strtotime('-1825 day'));
            $Be_3D_1 = date("Y-m-01", strtotime('-1095 day'));
            $Be_3D_2 = date("Y-m-31" . $day, strtotime('-1095 day'));
            $Be_1D_1 = date("Y-m-01", strtotime('-365 day'));
            $Be_1D_2 = date("Y-m-31" . $day, strtotime('-365 day'));

            $S7 = mysql_query("select hrm_employee.EmployeeID,Fname,Sname,Lname,Gender,DepartmentId,DesigId,HqId,Married,DateJoining,DR,TerrId from hrm_employee INNER JOIN hrm_employee_personal ON hrm_employee.EmployeeID=hrm_employee_personal.EmployeeID INNER JOIN hrm_employee_general ON hrm_employee.EmployeeID=hrm_employee_general.EmployeeID where hrm_employee_general.DateJoining>='" . $Be_7D_1 . "' AND hrm_employee_general.DateJoining<='" . $Be_7D_2 . "' AND hrm_employee.EmpStatus='A' AND hrm_employee.CompanyId=" . $_REQUEST['c'] . " AND hrm_employee_general.DepartmentId!=18 order by DateJoining ASC", $con);
            $S5 = mysql_query("select hrm_employee.EmployeeID,Fname,Sname,Lname,Gender,DepartmentId,DesigId,HqId,Married,DateJoining,DR,TerrId from hrm_employee INNER JOIN hrm_employee_personal ON hrm_employee.EmployeeID=hrm_employee_personal.EmployeeID INNER JOIN hrm_employee_general ON hrm_employee.EmployeeID=hrm_employee_general.EmployeeID where hrm_employee_general.DateJoining>='" . $Be_5D_1 . "' AND hrm_employee_general.DateJoining<='" . $Be_5D_2 . "' AND hrm_employee.EmpStatus='A' AND hrm_employee.CompanyId=" . $_REQUEST['c'] . " AND hrm_employee_general.DepartmentId!=18  order by DateJoining ASC", $con);
            $S3 = mysql_query("select hrm_employee.EmployeeID,Fname,Sname,Lname,Gender,DepartmentId,DesigId,HqId,Married,DateJoining,DR,TerrId from hrm_employee INNER JOIN hrm_employee_personal ON hrm_employee.EmployeeID=hrm_employee_personal.EmployeeID INNER JOIN hrm_employee_general ON hrm_employee.EmployeeID=hrm_employee_general.EmployeeID where hrm_employee_general.DateJoining>='" . $Be_3D_1 . "' AND hrm_employee_general.DateJoining<='" . $Be_3D_2 . "' AND hrm_employee.EmpStatus='A' AND hrm_employee.CompanyId=" . $_REQUEST['c'] . " AND hrm_employee_general.DepartmentId!=18  order by DateJoining ASC", $con);
            $S1 = mysql_query("select hrm_employee.EmployeeID,Fname,Sname,Lname,Gender,DepartmentId,DesigId,HqId,Married,DateJoining,DR,TerrId from hrm_employee INNER JOIN hrm_employee_personal ON hrm_employee.EmployeeID=hrm_employee_personal.EmployeeID INNER JOIN hrm_employee_general ON hrm_employee.EmployeeID=hrm_employee_general.EmployeeID where hrm_employee_general.DateJoining>='" . $Be_1D_1 . "' AND hrm_employee_general.DateJoining<='" . $Be_1D_2 . "' AND hrm_employee.EmpStatus='A' AND hrm_employee.CompanyId=" . $_REQUEST['c'] . " AND hrm_employee_general.DepartmentId!=18 order by DateJoining ASC", $con);
                  ...
                  <td style="width:880px;">
                     <table border="1">
                        <?php while ($RS7 = mysql_fetch_array($S7)) {
                           ...
                           $rowrelv7 = mysql_num_rows($srelv7);
                           $resrelv7 = mysql_fetch_assoc($srelv7);
                           if ($rowrelv7 == 0 or ($rowrelv7 > 0 and $resrelv7['HR_Approved'] == 'N') or ($rowrelv7 > 0 and $resrelv7['HR_Approved'] == 'Y' and date("Y-m-d") < $resrelv7['HR_RelievingDate'])) {
                              ...
                              if ($RS7['DR'] == 'Y') {
                                 ...
                                 $M = 'Mr.';
                              } elseif ($RS7['Gender'] == 'F' and $RS7['Married'] == 'Y') {
                                 $M = 'Mrs.';
                              } elseif ($RS7['Gender'] == 'F' and $RS7['Married'] == 'N') {
                                 $M = 'Miss.';
                              }
                              $EmpName = $M . ' ' . $RS7['Fname'] . ' ' . $RS7['Sname'] . ' ' . $RS7['Lname'];
                              $sqlDept = mysql_query("select department_code from core_departments where id=" . $RS7['DepartmentId'], $con);
                              $resDept = mysql_fetch_assoc($sqlDept);
                              $sqlDesig = mysql_query("select designation_name from core_designation where id=" . $RS7['DesigId'], $con);
                              $resDesig = mysql_fetch_assoc($sqlDesig);
                              $sqlHq = mysql_query("select city_village_name as HqName from core_city_village_by_state where id=" . $RS7['HqId'], $con);
                              $resHq = mysql_fetch_assoc($sqlHq);
                              $sqlTerr=mysql_query("select territory_name from core_territory where id=".$RS7['TerrId'], $con); $resTerr=mysql_fetch_assoc($sqlTerr);
                              ?>
                              <tr>
                                 ...
                                 <td class="s100" valign="top">&nbsp;<?php echo $resDept['department_code']; ?></td>
                                 <td class="s200" valign="top">&nbsp;<?php echo $resDesig['designation_name']; ?></td>
                                 <td class="s150" valign="top">&nbsp;<?= $RS7['TerrId']> 0 ? $resTerr['territory_name']: $resHq['HqName']; ?></td>
                              </tr>
                        <?php }
                        } ?>
                     </table>
                  ...
                  <td style="width:880px;">
                     <table border="1">
                        <?php while ($RS5 = mysql_fetch_array($S5)) {
                           ...
                           $rowrelv5 = mysql_num_rows($srelv5);
                           $resrelv5 = mysql_fetch_assoc($srelv5);
                           if ($rowrelv5 == 0 or ($rowrelv5 > 0 and $resrelv5['HR_Approved'] == 'N') or ($rowrelv5 > 0 and $resrelv5['HR_Approved'] == 'Y' and date("Y-m-d") < $resrelv5['HR_RelievingDate'])) {
                              ...
                              if ($RS5['DR'] == 'Y') {
                                 ...
                                 $M = 'Mr.';
                              } elseif ($RS5['Gender'] == 'F' and $RS5['Married'] == 'Y') {
                                 $M = 'Mrs.';
                              } elseif ($RS5['Gender'] == 'F' and $RS5['Married'] == 'N') {
                                 $M = 'Miss.';
                              }
                              $EmpName = $M . ' ' . $RS5['Fname'] . ' ' . $RS5['Sname'] . ' ' . $RS5['Lname'];
                              $sqlDept = mysql_query("select department_code from core_departments where id=" . $RS5['DepartmentId'], $con);
                              $resDept = mysql_fetch_assoc($sqlDept);
                              $sqlDesig = mysql_query("select designation_name from core_designation where id=" . $RS5['DesigId'], $con);
                              $resDesig = mysql_fetch_assoc($sqlDesig);
                              $sqlHq = mysql_query("select city_village_name as HqName from core_city_village_by_state where id=" . $RS5['HqId'], $con);
                              $resHq = mysql_fetch_assoc($sqlHq); ?>
                              <tr>
                  ...
                  <td style="width:880px;">
                     <table border="1">
                        <?php while ($RS3 = mysql_fetch_array($S3)) {
                           ...
                           $rowrelv3 = mysql_num_rows($srelv3);
                           $resrelv3 = mysql_fetch_assoc($srelv3);
                           if ($rowrelv3 == 0 or ($rowrelv3 > 0 and $resrelv3['HR_Approved'] == 'N') or ($rowrelv3 > 0 and $resrelv3['HR_Approved'] == 'Y' and date("Y-m-d") < $resrelv3['HR_RelievingDate'])) {
                              ...
                              if ($RS3['DR'] == 'Y') {
                                 ...
                                 $M = 'Mr.';
                              } elseif ($RS3['Gender'] == 'F' and $RS3['Married'] == 'Y') {
                                 $M = 'Mrs.';
                              } elseif ($RS3['Gender'] == 'F' and $RS3['Married'] == 'N') {
                                 $M = 'Miss.';
                              }
                              $EmpName = $M . ' ' . $RS3['Fname'] . ' ' . $RS3['Sname'] . ' ' . $RS3['Lname'];
                              $sqlDept = mysql_query("select department_code from core_departments where id=" . $RS3['DepartmentId'], $con);
                              $resDept = mysql_fetch_assoc($sqlDept);
                              $sqlDesig = mysql_query("select designation_name from core_designation where id=" . $RS3['DesigId'], $con);
                              $resDesig = mysql_fetch_assoc($sqlDesig);
                              $sqlHq = mysql_query("select city_village_name as HqName from core_city_village_by_state where id=" . $RS3['HqId'], $con);
                              $resHq = mysql_fetch_assoc($sqlHq); ?>
                              <tr>
                  ...
                  <td style="width:880px;">
                     <table border="1">
                        <?php while ($RS1 = mysql_fetch_array($S1)) {
                           ...
                           $rowrelv = mysql_num_rows($srelv);
                           $resrelv = mysql_fetch_assoc($srelv);
                           if ($rowrelv == 0 or ($rowrelv > 0 and $resrelv['HR_Approved'] == 'N') or ($rowrelv > 0 and $resrelv['HR_Approved'] == 'Y' and date("Y-m-d") < $resrelv['HR_RelievingDate'])) {
                              ...
                              if ($RS1['DR'] == 'Y') {
                                 ...
                                 $M = 'Mr.';
                              } elseif ($RS1['Gender'] == 'F' and $RS1['Married'] == 'Y') {
                                 $M = 'Mrs.';
                              } elseif ($RS1['Gender'] == 'F' and $RS1['Married'] == 'N') {
                                 $M = 'Miss.';
                              }
                              $EmpName = $M . ' ' . $RS1['Fname'] . ' ' . $RS1['Sname'] . ' ' . $RS1['Lname'];
                              $sqlDept = mysql_query("select department_code from core_departments where id=" . $RS1['DepartmentId'], $con);
                              $resDept = mysql_fetch_assoc($sqlDept);
                              $sqlDesig = mysql_query("select designation_name from core_designation where id=" . $RS1['DesigId'], $con);
                              $resDesig = mysql_fetch_assoc($sqlDesig);
                              $sqlHq = mysql_query("select city_village_name as HqName from core_city_village_by_state where id=" . $RS1['HqId'], $con);
                              $resHq = mysql_fetch_assoc($sqlHq); ?>
                              <tr>
            ...
            <td style="width:950px;display:<?php if ($_REQUEST['v'] == 'M') {
                                                echo 'block';
                                             } else {
                                                echo 'none';
                                             } ?>;" />
                  ...
                  <td style="width:880px;" valign="top">
                     <table border="1" bgcolor="#FFFFFF">
                        ...
                        <?php while ($resEventAnn = mysql_fetch_array($sqlEventAnn)) {
                           ...
                           $rowAnnE = mysql_num_rows($sAnnE);
                           $resAnnE = mysql_fetch_assoc($sAnnE);
                           if ($rowAnnE == 0 or ($rowAnnE > 0 and $resAnnE['HR_Approved'] == 'N') or ($rowAnnE > 0 and $resAnnE['HR_Approved'] == 'Y' and date("Y-m-d") < $resAnnE['HR_RelievingDate'])) {
                              ...
                              if ($resEventAnn['DR'] == 'Y') {
                                 $M = 'Dr.';
                              } elseif ($resEventAnn['Gender'] == 'M') {
                                 $M = 'Mr.';
                              } elseif ($resEventAnn['Gender'] == 'F' and $resEventAnn['Married'] == 'Y') {
                                 $M = 'Mrs.';
                              } elseif ($resEventAnn['Gender'] == 'F' and $resEventAnn['Married'] == 'N') {
                                 $M = 'Miss.';
                              }
                              $EmpNameAnn = $M . ' ' . $resEventAnn['Fname'] . ' ' . $resEventAnn['Sname'] . ' ' . $resEventAnn['Lname'];
                              $sqlDept = mysql_query("select department_code from core_departments where id=" . $resEventAnn['DepartmentId'], $con);
                              $resDept = mysql_fetch_assoc($sqlDept);
                              $sqlDesig = mysql_query("select designation_name from core_designation where id=" . $resEventAnn['DesigId'], $con);
                              $resDesig = mysql_fetch_assoc($sqlDesig);
                              $sqlHq = mysql_query("select city_village_name as HqName from core_city_village_by_state where id=" . $resEventAnn['HqId'], $con);
                              $resHq = mysql_fetch_assoc($sqlHq); ?>
                              <tr bgcolor="#FFFFFF">
            ...
            <?php /******************************************************* Birthday ****************************************************************************/ ?>
            <td style="width:950px;display:<?php if ($_REQUEST['v'] == 'B') {
                                                echo 'block';
                                             } else {
                                                echo 'none';
                                             } ?>;" />
                  ...
                  <td style="width:880px;" valign="top">
                     <table border="1" bgcolor="#FFFFFF">
                        ...
                        <?php while ($resEventDOB = mysql_fetch_array($sqlEventDOB)) {
                           ...
                           $rowDobE = mysql_num_rows($sDobE);
                           $resDobE = mysql_fetch_assoc($sDobE);
                           if ($rowDobE == 0 or ($rowDobE > 0 and $resDobE['HR_Approved'] == 'N') or ($rowDobE > 0 and $resDobE['HR_Approved'] == 'Y' and date("Y-m-d") < $resDobE['HR_RelievingDate'])) {
                              ...
                              if ($resEventDOB['DR'] == 'Y') {
                                 $M = 'Dr.';
                              } elseif ($resEventDOB['Gender'] == 'M') {
                                 $M = 'Mr.';
                              } elseif ($resEventDOB['Gender'] == 'F' and $resEventDOB['Married'] == 'Y') {
                                 $M = 'Mrs.';
                              } elseif ($resEventDOB['Gender'] == 'F' and $resEventDOB['Married'] == 'N') {
                                 $M = 'Miss.';
                              }
                              $EmpNameDOB = $M . ' ' . $resEventDOB['Fname'] . ' ' . $resEventDOB['Sname'] . ' ' . $resEventDOB['Lname'];
                              $sqlDept2 = mysql_query("select department_code from core_departments where id=" . $resEventDOB['DepartmentId'], $con);
                              $resDept2 = mysql_fetch_assoc($sqlDept2);
                              $sqlDesig2 = mysql_query("select designation_name from core_designation where id=" . $resEventDOB['DesigId'], $con);
                              $resDesig2 = mysql_fetch_assoc($sqlDesig2);
                              $sqlHq2 = mysql_query("select city_village_name as HqName from core_city_village_by_state where id=" . $resEventDOB['HqId'], $con);
                              $resHq2 = mysql_fetch_assoc($sqlHq2); ?>
                              <tr bgcolor="#FFFFFF">
                                 ...
                                 <td class="s100" valign="top">&nbsp;<?php echo $resDept2['department_code']; ?></td>
                                 <td class="s200" valign="top">&nbsp;<?php echo $resDesig2['designation_name']; ?></td>
