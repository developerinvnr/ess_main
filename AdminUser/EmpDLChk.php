...
{ 
 ...
 {      
	...
	if($sql)
	{
	 $res=mysql_fetch_assoc($sql);
    	 ...
    	 if($res['VCode']!='' && $res['EmployeeID'] > 100000){
    	     $Ref_ID = ($res['EmployeeID']-20000);
    	     $query = mysql_query("update hrm_employee set Ref_ID='".$Ref_ID."' where EmployeeID=".$_POST['Eid'],$con); 
    	     $EmployeeID = $Ref_ID;
    	 }else{
 ...
 { 
    ...
    $earr = array();
    $query = mysql_query("select * from hrm_employee where EmployeeID=".$_POST['Eid'],$con);
