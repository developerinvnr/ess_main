...
$sql_statement=mysql_query("select e.EmployeeID,EmpCode,Fname,Sname,Lname,DepartmentId,CostCenter from hrm_employee e INNER JOIN hrm_employee_general g ON e.EmployeeID=g.EmployeeID where e.EmpStatus='A' AND ".$ConDQ." AND e.CompanyId=".$CompanyId." order by ECode ASC", $con);
...
$SqlEmp=mysql_query("select e.EmployeeID,EmpCode,Fname,Sname,Lname,DepartmentId,CostCenter from hrm_employee e INNER JOIN hrm_employee_general g ON e.EmployeeID=g.EmployeeID where e.EmpStatus='A' AND ".$ConDQ." AND e.CompanyId=".$CompanyId." order by ECode ASC LIMIT ".$from.",".$offset, $con);

/*
if($_REQUEST['d']>0){$SqlEmp=mysql_query("select hrm_employee.*,hrm_employee_general.* from hrm_employee INNER JOIN hrm_employee_general ON hrm_employee.EmployeeID=hrm_employee_general.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee_general.DepartmentId=".$_REQUEST['d']." AND hrm_employee.CompanyId=".$CompanyId." order by ECode ASC", $con);}
    if($_REQUEST['d']=='all'){$SqlEmp=mysql_query("select hrm_employee.*,hrm_employee_general.* from hrm_employee INNER JOIN hrm_employee_general ON hrm_employee.EmployeeID=hrm_employee_general.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee.CompanyId=".$CompanyId." order by ECode ASC", $con);}*/
