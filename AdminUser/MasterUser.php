...
<td class="font1">&nbsp;<?php if($ResultUser['User_status']=='A'){echo 'Active';}else{echo 'Deactive';}?></td>
	 ...
	 <td align="center" valign="middle">
<?php if($_SESSION['User_Permission']=='Edit'){?>
<?php if($_SESSION['UserType']=='S' OR $_SESSION['UserType']=='A') { ?><a href="#"><img src="images/edit.png" border="0" alt="Edit" onClick="edit(<?php echo $ResultUser['AXAUESRUser_Id']; ?>)"></a>&nbsp;&nbsp;<a href="#"><img src="images/delete.png" alt="Delete" border="0" onClick="del(<?php echo $ResultUser['AXAUESRUser_Id']; ?>)"></a><?php if($_SESSION['UserType']=='S' OR $_SESSION['UserType']=='A') {?>&nbsp;&nbsp;<a href="#"><img src="images/key.png" alt="Delete" border="0" onClick="Logkey(<?php echo $ResultUser['AXAUESRUser_Id']; ?>)"></a><?php } } ?>
<?php } ?>
</td>
	 <td align="center">
<?php if($_SESSION['User_Permission']=='Edit'){?>
