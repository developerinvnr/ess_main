...
{    $SqlUpPayM = mysql_query("UPDATE hrm_employee_key_paymonth SET Jan='".$_POST['Jan']."', Feb='".$_POST['Feb']."', Mar='".$_POST['Mar']."', Apr='".$_POST['Apr']."', May='".$_POST['May']."', Jun='".$_POST['Jun']."', Jul='".$_POST['Jul']."', Aug='".$_POST['Aug']."', Sep='".$_POST['Sep']."', Oct='".$_POST['Oct']."', Nov='".$_POST['Nov']."', Decm='".$_POST['Dec']."' WHERE CompanyId=".$CompanyId." AND EmpPayMKeyId=".$_POST['EditPayMId'], $con) or die(mysql_error());
     ...
     { 
         ...
         $SqlUpIns = mysql_query("insert into hrm_employee_key_paymonth_prodate(CompanyId, Jan, Feb, Mar, Apr, May, Jun, Jul, Aug, Sep, Oct, Nov, Decm, UppDate, UpBy) values(".$CompanyId.", '".$_POST['Jan']."', '".$_POST['Feb']."', '".$_POST['Mar']."', '".$_POST['Apr']."', '".$_POST['May']."', '".$_POST['Jun']."', '".$_POST['Jul']."', '".$_POST['Aug']."', '".$_POST['Sep']."', '".$_POST['Oct']."', '".$_POST['Nov']."', '".$_POST['Dec']."', '".date("Y-m-d")."', ".$UserId.")", $con);
         $msgEmpPayM = "Data has been Updeted successfully...";
