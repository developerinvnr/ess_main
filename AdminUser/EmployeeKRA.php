...
{   
    ...
    window.location="EmployeeKRA.php?act=Revert&valu=true&rr=234&rtr=4&Dpp=55&rest=false&e="+value+"&YI="+YeId+"&DpId="+DI+"&YeId="+YeId; 
    }
    else{ return false; }
}
...
{ var YeId = document.getElementById("YearE").value; var x = "EmployeeKRA.php?act=checked&valu=true&rr=234&rtr=4&Dpp=55&rest=false&DpId="+v+"&YeId="+YeId+"&tt=44&rtr=r%r";  window.location=x;}				
...
function SetK(EI,YI)
{ var DI=document.getElementById("DId").value;  window.location="EmployeeKRA.php?action=SetKRA&EI="+EI+"&YI="+YI+"&DpId="+DI+"&YeId="+YI;}		
...
{ var DI=document.getElementById("DId").value;  window.location="EmployeeKRA.php?action=SetFormBB&EI="+EI+"&YI="+YI+"&DpId="+DI+"&YeId="+YI;}
	...
	<tr>
		...
		<td align="center" width="100%" valign="top">
		   <table border="0" style="width:100%;">
		     <tr>
			  <td align="left" class="heading" style="width:200px;"> Employee KRA</td>
...
<table border="1" id="table1" style="width:100%;">
 ...
 <tr bgcolor="#7a6189">
   ...
   <td  class="th" style="width:5%;">EC</td>
   <td  class="th" style="width:20%;">Name</td>
   <td  class="th" style="width:13%;">HeadQuater</td>
