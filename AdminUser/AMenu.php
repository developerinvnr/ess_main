...
<?php /************************************************************************ Master Open ***********************************************************/ ?>	 
  <li class="top"><a href="#" id="products" class="top_link"><span class="down">Master</span></a>
    <ul class="sub">
	 ...
	 <?php } ?> 
	 <?php if($_SESSION['Master']==1 OR $UserId==60){?>
	   <li><a href="vertical.php?act=checkdept&d=23&rr=false&rr=98&ff=23&dd=3&d=4&ed=2">Dept. Vertical-Section</a></li>  
	 <?php } ?>
...
<?php /************************************************************************ Master Close ***********************************************************/ ?>	  
<?php } if($UserId!=12 AND $UserId!=13 AND $UserId!=27 AND $UserId!=59 AND $UserId!=61) { ?>
<?php /************************************************************************ Processing Open ***********************************************************/ ?>	 
...
<li><a href="EmpLTASub.php?ls=10&wer=123&aa=grtd&er=er%re%tr%rr&trt=equalthen&sys=%tr%tr&se=reew&w=ee102&prd=2018&dd=11&ee=s1s&aa=grtd&er=er%re%tr%rr&trt=equalthen">LTA Decl<sup>n</sup>/Subm<sup>n</sup></a></li> 
	...
	<li><a href="#" class="fly">Upload Document</a>
	 <ul>
	  <li><a href="Up_VNRImpct.php">VNR Impact</a></li>
	...
	<li><a href="CtcCRev.php">CTC - Reverse Cal.</a></li>
	<li><a href="employee_image_download.php">Employee Image</a></li>
...
<?php /************************************************************************ PMS Open ***********************************************************/ ?>	 
  ...
  <li><a href="#" class="fly">Form/ FeedBack</a>
   ...
   <li><a href="#" class="fly">Setting</a>
	...
	<?php if($_SESSION['UserType']=='S' AND  ($_SESSION['PMS']==1 OR $_SESSION['PMS_OpenCloseMenu']==1)){?>
        ...
        <?php if($_SESSION['PMS']==1 OR $_SESSION['PMS_IncDistri']==1){?>
         <li><a href="MinMaxVertical.php?act=checkdept&dr=23&rr=false&rr=98&ff=23&dd=3&d=4&ed=2">Vertical / Section (Min/Max)</a></li>
   ...
   <?php if($_SESSION['PMS']==1 OR $_SESSION['PMS_Report']==1){?><li><a href="AppsalPmseIncHis.php?YI=<?php echo $YearId; ?>&Sts=A">Increment History</a></li><?php } ?>
...
<?php if($UserId!=27 AND $UserId!=59 AND $UserId!=60 AND $UserId!=61){ if($_SESSION['UserType']=="S" OR $_SESSION['UserType']=="A" OR $_SESSION['UserType']=="U"){ ?>
