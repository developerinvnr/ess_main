  ...
  <table border="0" style="width:85%;">
   <tr>
	...
	<table border="0" style="width:100%;">
	 <tr>
	  ...
	  <?php if($_REQUEST['YI']!=13){?><option value="13">2024-2025</option><?php } ?>
	  <?php if($_REQUEST['YI']!=12){?><option value="12">2023-2024</option><?php } ?>
	  <?php if($_REQUEST['YI']!=11){?><option value="11">2022-2023</option><?php } ?>
	  ...
	  <td class="tdc" style="width:150px;"><select class="sell" name="DeptInc" id="DeptInc" onChange="SelectDept(this.value)"><option value="" style="margin-left:0px;" <?php if($_REQUEST['action']!='Dept'){echo 'selected';} ?>>Select Department</option><?php $SqlDeptI=mysql_query("select * from core_departments where id!=18 AND is_active=1 order by department_name", $con); while($ResDeptI=mysql_fetch_array($SqlDeptI)) { ?><option value="<?php echo $ResDeptI['DepartmentId']; ?>" <?php if($_REQUEST['action']=='Dept' AND $_REQUEST['value']==$ResDeptI['id']){echo 'selected';} ?>><?php echo '&nbsp;'.$ResDeptI['department_name'];?></option><?php } ?><option value="<?php echo 'Over';  ?>">&nbsp;<?php echo 'All'; ?></option></select></td>	
   ...
   <tr>
    ...
    <?php if($_REQUEST['action']=='Over') { $Action='ORGANIZATION'; }
          elseif($_REQUEST['action']=='Dept'){ $sqlDe=mysql_query("select department_name as DepartmentName from core_departments where id=".$_REQUEST['value'], $con); $resDe=mysql_fetch_assoc($sqlDe); $Action='DEPARTMENT:&nbsp;'.$resDe['DepartmentName']; }
	 ...
	 <tr bgcolor="#FF8000" style="height:26px;">	
	  ...
	  <?php                                             //<date('Y-02-01')
	   if(date("Y-m-d")>=date('Y-01-01') AND date("Y-m-d")<date('Y-03-25') AND $_REQUEST['YI']==$YearId){ 
...
<?php if(date("Y-m-d")>=date('Y-01-01') AND date("Y-m-d")<date('Y-03-25') AND $_REQUEST['YI']==$YearId){ 
                                                       //<date('Y-02-01') ?>
