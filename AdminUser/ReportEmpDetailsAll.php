...
{ 
  ...
  window.location='ReportEmpDetailsAll.php?action=DeptGeneral&dept='+dept+"&sts="+sts;
}
...
{   var ComId=document.getElementById("ComId").value; 
    ...
    window.open("ExportReportAllCSV.php?action=GeneralExport&value="+dept+"&C="+ComId+"&Y="+YId+"&sts="+sts,"PrintForm","menubar=yes,scrollbars=yes,resizable=no,directories=no,width=20,height=20");
    
}

function ExportLabourWelfare() 
{
    var ComId=document.getElementById("ComId").value; 
	var YId=document.getElementById("YId").value; 
	var dept=document.getElementById("deptid").value;
	var sts=document.getElementById("stsid").value;
	window.open("ExportLabourWelfareCSV.php?action=GeneralExport&value="+dept+"&C="+ComId+"&Y="+YId+"&sts="+sts,"PrintForm","menubar=yes,scrollbars=yes,resizable=no,directories=no,width=20,height=20");
}
   ...
   <table border="0" style="width:100%;border:hidden;">
    <tr>
	 <td style="font-family:Times New Roman;color:#96730A;font-weight:bold;font-size:20px;width:120%;">
		<i>Employee All Details Reports:</i>
		&nbsp;&nbsp;&nbsp;
		...
		&nbsp;&nbsp;
		<a href="#" onClick="ExportLabourWelfare()" style="font-size:12px;">Export Labour Welfare</a>
		<?php } ?>
	 </td>	 
	</tr>
   </table>
