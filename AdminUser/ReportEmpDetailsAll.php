                            ...
                            <table border="0" style="margin-top:0px; width:95%; height:400px;">
                                <tr>
                                    ...
                                    <td align="" width="100%" valign="top">
                                        ...
                                        <td align="center" style="color:#FFFFFF;"
                                                                class="All_80"><b>Vehicle Policy</b></td>                        
...
?>
                                        ...
                                        <?php $sqlSec=mysql_query("select SectionName from hrm_department_section where SectionId=".$res['EmpSection'], $con); $resSec=mysql_fetch_assoc($sqlSec); ?>
                                                            <td align=""
                                                                class="All_150" valign="top">
                                                                <?php echo strtoupper($resSec['SectionName']); ?></td>                        
...
$respl=mysql_fetch_assoc($sqlpl); $PolyName=$respl['PolicyName']; } ?>                                              <td align="center" valign="top" style="" class="All_80">
                                                    <?php echo $PolyName; ?></td>
