...
{  
  if($_REQUEST['value']==0)
  { $sql=mysql_query("select ".$qry." where e.CompanyId=".$CompanyId." AND e.EmpStatus='A' AND g.DateJoining<='".$YYear."-09-30' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.Appraiser_EmployeeID!=0 order by e.ECode ASC", $con); 
  }
  else{ $sql=mysql_query("select ".$qry." where e.CompanyId=".$CompanyId." AND e.EmpStatus='A' AND g.DateJoining<='".$YYear."-09-30' AND p.AssessmentYear=".$_REQUEST['YI']." AND g.DepartmentId=".$_REQUEST['value']." AND p.Appraiser_EmployeeID!=0 order by e.ECode ASC", $con); 
  
  }
}
elseif($_REQUEST['ee']=='App')
{ $sql=mysql_query("select ".$qry." where e.CompanyId=".$CompanyId." AND e.EmpStatus='A' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.Appraiser_EmployeeID=".$_REQUEST['value']." AND p.Appraiser_EmployeeID!=0 order by e.ECode ASC", $con);
}
elseif($_REQUEST['ee']=='Rev')
{ $sql=mysql_query("select ".$qry." where e.CompanyId=".$CompanyId." AND e.EmpStatus='A' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.Reviewer_EmployeeID=".$_REQUEST['value']." AND p.Appraiser_EmployeeID!=0 order by e.ECode ASC", $con);
}
elseif($_REQUEST['ee']=='Rev2')
{ $sql=mysql_query("select ".$qry." where e.CompanyId=".$CompanyId." AND e.EmpStatus='A' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.Rev2_EmployeeID=".$_REQUEST['value']." AND p.Appraiser_EmployeeID!=0 order by e.ECode ASC", $con);
}
elseif($_REQUEST['ee']=='Hod')
{ $sql=mysql_query("select ".$qry." where e.CompanyId=".$CompanyId." AND e.EmpStatus='A' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.HOD_EmployeeID=".$_REQUEST['value']." AND p.Appraiser_EmployeeID!=0 order by e.ECode ASC", $con);
}
...
$sqlGrade=mysql_query("select grade_name as GradeValue from core_grades where id=".$res['HR_CurrGradeId'], $con); $resGrade=mysql_fetch_assoc($sqlGrade);
 ?>	   
	 ...
	 <tr bgcolor="#FFFFFF" id="TR<?php echo $Sno; ?>">
		...
		<td class="tdc"><?php echo $resGrade['GradeValue']; ?></td>
...
<?php if($res['Hod_EmpDesignation']!=$res['HR_CurrDesigId']){ $sqlDesigH=mysql_query("select designation_name as DesigName from core_designation where id=".$res['Hod_EmpDesignation']." AND CompanyId=".$CompanyId, $con); $resDesigH=mysql_fetch_assoc($sqlDesigH); $DesigH=$resDesigH['DesigName']; }else{$DesigH='';}
if($res['Hod_EmpGrade']!=$res['HR_CurrGradeId']){ $sqlGH=mysql_query("select grade_name as GradeValue from core_grades where id=".$res['Hod_EmpGrade']." AND CompanyId=".$CompanyId, $con); $resGH=mysql_fetch_assoc($sqlGH); $GradeH=$resGH['GradeValue']; }else{$GradeH='';} ?>	
...
{  
  if($_REQUEST['value']==0)
  { $sql2=mysql_query("select SUM(EmpCurrGrossPM) as PGross, SUM(Hod_ProIncSalary) as ISGross, SUM(Hod_ProCorrSalary) as CoGross, SUM(Hod_IncNetMonthalySalary) as IncGross, SUM(Hod_GrossMonthlySalary) as TGross from hrm_employee INNER JOIN hrm_employee_general ON hrm_employee.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee_pms ON hrm_employee.EmployeeID=hrm_employee_pms.EmployeeID where hrm_employee.CompanyId=".$CompanyId." AND hrm_employee.EmpStatus='A' AND hrm_employee_general.DateJoining<='".$YYear."-09-30' AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_pms.Appraiser_EmployeeID!=0 order by hrm_employee.EmpCode ASC", $con); }
  else{ $sql2=mysql_query("select SUM(EmpCurrGrossPM) as PGross, SUM(Hod_ProIncSalary) as ISGross, SUM(Hod_ProCorrSalary) as CoGross, SUM(Hod_IncNetMonthalySalary) as IncGross, SUM(Hod_GrossMonthlySalary) as TGross from hrm_employee INNER JOIN hrm_employee_general ON hrm_employee.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee_pms ON hrm_employee.EmployeeID=hrm_employee_pms.EmployeeID where hrm_employee.CompanyId=".$CompanyId." AND hrm_employee.EmpStatus='A' AND hrm_employee_general.DateJoining<='".$YYear."-09-30' AND hrm_employee_pms.AssessmentYear=".$_REQUEST['YI']." AND hrm_employee_general.DepartmentId=".$_REQUEST['value']." AND hrm_employee_pms.Appraiser_EmployeeID!=0 order by hrm_employee.EmpCode ASC", $con); }
}
elseif($_REQUEST['ee']=='App')
