...
<td class="td1" style="font-size:11px; width:160px;" align="center"><select style="font-size:12px; width:158px; height:20px; background-color:#DDFFBB;" name="DeptInc" id="DeptInc" onChange="SelectEHodStdInc(this.value,<?php echo $_REQUEST['YI']; ?>,'d')"><option value="" style="margin-left:0px;" selected>SELECT DEPARTMENT</option><?php $SqlDept=mysql_query("select * from core_departments where is_active=1 order by department_name", $con); while($ResDept=mysql_fetch_array($SqlDept)) { ?><option value="<?php echo $ResDept['id']; ?>"><?php echo '&nbsp;'.$ResDept['department_name'];?></option><?php } ?><option value="0">&nbsp;All</option></select></td>
...
<?php 
$qry="e.EmployeeID,EmpCode,Fname,Sname,Lname,EmpPmsId,EmpCurrGrossPM,HOD_EmployeeID,Hod_ProCorrSalary,HodSubmit_IncStatus,Hod_GrossMonthlySalary,DateJoining,HR_CurrDesigId,HR_CurrGradeId,HR_Curr_DepartmentId,designation_name as DesigName,department_name as DepartmentCode from hrm_employee e INNER JOIN hrm_employee_general g ON e.EmployeeID=g.EmployeeID INNER JOIN hrm_employee_pms p ON e.EmployeeID=p.EmployeeID left JOIN core_designation de ON p.HR_CurrDesigId=de.id LEFT JOIN core_departments d ON p.HR_Curr_DepartmentId=d.id";
if($_REQUEST['ee']=='Dept')
{  
  if($_REQUEST['value']==0)
  { 
    if($_REQUEST['act']=='g' AND $_REQUEST['gg']==1){$sql=mysql_query("select ".$qry." where e.CompanyId=".$CompanyId." AND e.EmpStatus='A' AND g.DateJoining<='".$YYear."-06-30' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.Appraiser_EmployeeID!=0 order by HR_CurrGradeId ASC, ECode ASC", $con);}
	elseif($_REQUEST['act']=='g' AND $_REQUEST['gg']==2){$sql=mysql_query("select ".$qry." where e.CompanyId=".$CompanyId." AND e.EmpStatus='A' AND g.DateJoining<='".$YYear."-06-30' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.Appraiser_EmployeeID!=0 order by HR_CurrGradeId DESC, ECode ASC", $con);}
	elseif($_REQUEST['act']=='de' AND $_REQUEST['gg']==1){$sql=mysql_query("select ".$qry." where e.CompanyId=".$CompanyId." AND e.EmpStatus='A' AND g.DateJoining<='".$YYear."-06-30' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.Appraiser_EmployeeID!=0 order by de.DesigName ASC, HR_CurrGradeId ASC, ECode ASC", $con);}
	elseif($_REQUEST['act']=='de' AND $_REQUEST['gg']==2){$sql=mysql_query("select ".$qry." where e.CompanyId=".$CompanyId." AND e.EmpStatus='A' AND g.DateJoining<='".$YYear."-06-30' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.Appraiser_EmployeeID!=0 order by de.DesigName DESC, HR_CurrGradeId ASC, ECode ASC", $con);}
	elseif($_REQUEST['act']=='dept' AND $_REQUEST['gg']==1){$sql=mysql_query("select ".$qry." where e.CompanyId=".$CompanyId." AND e.EmpStatus='A' AND g.DateJoining<='".$YYear."-06-30' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.Appraiser_EmployeeID!=0 order by d.DepartmentCode ASC, HR_CurrGradeId ASC, ECode ASC", $con);}
	elseif($_REQUEST['act']=='dept' AND $_REQUEST['gg']==2){$sql=mysql_query("select ".$qry." where e.CompanyId=".$CompanyId." AND e.EmpStatus='A' AND g.DateJoining<='".$YYear."-06-30' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.Appraiser_EmployeeID!=0 order by d.DepartmentCode DESC, HR_CurrGradeId ASC, ECode ASC", $con);}
	else{$sql=mysql_query("select ".$qry." where e.CompanyId=".$CompanyId." AND e.EmpStatus='A' AND g.DateJoining<='".$YYear."-06-30' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.Appraiser_EmployeeID!=0 order by ECode ASC", $con);}
  }
  else
  { 
    if($_REQUEST['act']=='g' AND $_REQUEST['gg']==1){$sql=mysql_query("select ".$qry." where e.CompanyId=".$CompanyId." AND e.EmpStatus='A' AND g.DateJoining<='".$YYear."-06-30' AND p.AssessmentYear=".$_REQUEST['YI']." AND g.DepartmentId=".$_REQUEST['value']." AND p.Appraiser_EmployeeID!=0 order by HR_CurrGradeId ASC, ECode ASC", $con);}
	elseif($_REQUEST['act']=='g' AND $_REQUEST['gg']==2){$sql=mysql_query("select ".$qry." where e.CompanyId=".$CompanyId." AND e.EmpStatus='A' AND g.DateJoining<='".$YYear."-06-30' AND p.AssessmentYear=".$_REQUEST['YI']." AND g.DepartmentId=".$_REQUEST['value']." AND p.Appraiser_EmployeeID!=0 order by HR_CurrGradeId DESC, ECode ASC", $con);}
	elseif($_REQUEST['act']=='de' AND $_REQUEST['gg']==1){$sql=mysql_query("select ".$qry." where e.CompanyId=".$CompanyId." AND e.EmpStatus='A' AND g.DateJoining<='".$YYear."-06-30' AND p.AssessmentYear=".$_REQUEST['YI']." AND g.DepartmentId=".$_REQUEST['value']." AND p.Appraiser_EmployeeID!=0 order by DesigName ASC, HR_CurrGradeId ASC, ECode ASC", $con);}
	elseif($_REQUEST['act']=='de' AND $_REQUEST['gg']==2){$sql=mysql_query("select ".$qry." where e.CompanyId=".$CompanyId." AND e.EmpStatus='A' AND g.DateJoining<='".$YYear."-06-30' AND p.AssessmentYear=".$_REQUEST['YI']." AND g.DepartmentId=".$_REQUEST['value']." AND p.Appraiser_EmployeeID!=0 order by DesigName DESC, HR_CurrGradeId ASC, ECode ASC", $con);}
	elseif($_REQUEST['act']=='dept' AND $_REQUEST['gg']==1){$sql=mysql_query("select ".$qry." where e.CompanyId=".$CompanyId." AND e.EmpStatus='A' AND g.DateJoining<='".$YYear."-06-30' AND p.AssessmentYear=".$_REQUEST['YI']." AND g.DepartmentId=".$_REQUEST['value']." AND p.Appraiser_EmployeeID!=0 order by DepartmentCode ASC, HR_CurrGradeId ASC, ECode ASC", $con);}
	elseif($_REQUEST['act']=='dept' AND $_REQUEST['gg']==2){$sql=mysql_query("select ".$qry." where e.CompanyId=".$CompanyId." AND e.EmpStatus='A' AND g.DateJoining<='".$YYear."-06-30' AND p.AssessmentYear=".$_REQUEST['YI']." AND g.DepartmentId=".$_REQUEST['value']." AND p.Appraiser_EmployeeID!=0 order by DepartmentCode DESC, HR_CurrGradeId ASC, ECode ASC", $con);}
	else{$sql=mysql_query("select ".$qry." where e.CompanyId=".$CompanyId." AND e.EmpStatus='A' AND g.DateJoining<='".$YYear."-06-30' AND p.AssessmentYear=".$_REQUEST['YI']." AND g.DepartmentId=".$_REQUEST['value']." AND p.Appraiser_EmployeeID!=0 order by ECode ASC", $con);}
  }
}
elseif($_REQUEST['ee']=='App')
{ 
   if($_REQUEST['act']=='g' AND $_REQUEST['gg']==1){$sql=mysql_query("select ".$qry." where e.CompanyId=".$CompanyId." AND e.EmpStatus='A' AND g.DateJoining<='".$YYear."-06-30' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.Appraiser_EmployeeID=".$_REQUEST['value']." AND p.Appraiser_EmployeeID!=0 order by HR_CurrGradeId ASC, ECode ASC", $con);}
	elseif($_REQUEST['act']=='g' AND $_REQUEST['gg']==2){$sql=mysql_query("select ".$qry." where e.CompanyId=".$CompanyId." AND e.EmpStatus='A' AND g.DateJoining<='".$YYear."-06-30' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.Appraiser_EmployeeID=".$_REQUEST['value']." AND p.Appraiser_EmployeeID!=0 order by HR_CurrGradeId DESC, ECode ASC", $con);}
	elseif($_REQUEST['act']=='de' AND $_REQUEST['gg']==1){$sql=mysql_query("select ".$qry." where e.CompanyId=".$CompanyId." AND e.EmpStatus='A' AND g.DateJoining<='".$YYear."-06-30' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.Appraiser_EmployeeID=".$_REQUEST['value']." AND p.Appraiser_EmployeeID!=0 order by DesigName ASC, HR_CurrGradeId ASC, ECode ASC", $con);}
	elseif($_REQUEST['act']=='de' AND $_REQUEST['gg']==2){$sql=mysql_query("select ".$qry." where e.CompanyId=".$CompanyId." AND e.EmpStatus='A' AND g.DateJoining<='".$YYear."-06-30' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.Appraiser_EmployeeID=".$_REQUEST['value']." AND p.Appraiser_EmployeeID!=0 order by DesigName DESC, HR_CurrGradeId ASC, ECode ASC", $con);}
	elseif($_REQUEST['act']=='dept' AND $_REQUEST['gg']==1){$sql=mysql_query("select ".$qry." where e.CompanyId=".$CompanyId." AND e.EmpStatus='A' AND g.DateJoining<='".$YYear."-06-30' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.Appraiser_EmployeeID=".$_REQUEST['value']." AND p.Appraiser_EmployeeID!=0 order by DepartmentCode ASC, HR_CurrGradeId ASC, ECode ASC", $con);}
	elseif($_REQUEST['act']=='dept' AND $_REQUEST['gg']==2){$sql=mysql_query("select ".$qry." where e.CompanyId=".$CompanyId." AND e.EmpStatus='A' AND g.DateJoining<='".$YYear."-06-30' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.Appraiser_EmployeeID=".$_REQUEST['value']." AND p.Appraiser_EmployeeID!=0 order by DepartmentCode DESC, HR_CurrGradeId ASC, ECode ASC", $con);}
	else{$sql=mysql_query("select ".$qry." where e.CompanyId=".$CompanyId." AND e.EmpStatus='A' AND g.DateJoining<='".$YYear."-06-30' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.Appraiser_EmployeeID=".$_REQUEST['value']." AND p.Appraiser_EmployeeID!=0 order by ECode ASC", $con);}

}
elseif($_REQUEST['ee']=='Rev')
{ 
   if($_REQUEST['act']=='g' AND $_REQUEST['gg']==1){$sql=mysql_query("select ".$qry." where e.CompanyId=".$CompanyId." AND e.EmpStatus='A' AND g.DateJoining<='".$YYear."-06-30' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.Reviewer_EmployeeID=".$_REQUEST['value']." AND p.Appraiser_EmployeeID!=0 order by HR_CurrGradeId ASC, ECode ASC", $con);}
	elseif($_REQUEST['act']=='g' AND $_REQUEST['gg']==2){$sql=mysql_query("select ".$qry." where e.CompanyId=".$CompanyId." AND e.EmpStatus='A' AND g.DateJoining<='".$YYear."-06-30' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.Reviewer_EmployeeID=".$_REQUEST['value']." AND p.Appraiser_EmployeeID!=0 order by HR_CurrGradeId DESC, ECode ASC", $con);}
	elseif($_REQUEST['act']=='de' AND $_REQUEST['gg']==1){$sql=mysql_query("select ".$qry." where e.CompanyId=".$CompanyId." AND e.EmpStatus='A' AND g.DateJoining<='".$YYear."-06-30' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.Reviewer_EmployeeID=".$_REQUEST['value']." AND p.Appraiser_EmployeeID!=0 order by DesigName ASC, HR_CurrGradeId ASC, ECode ASC", $con);}
	elseif($_REQUEST['act']=='de' AND $_REQUEST['gg']==2){$sql=mysql_query("select ".$qry." where e.CompanyId=".$CompanyId." AND e.EmpStatus='A' AND g.DateJoining<='".$YYear."-06-30' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.Reviewer_EmployeeID=".$_REQUEST['value']." AND p.Appraiser_EmployeeID!=0 order by DesigName DESC, HR_CurrGradeId ASC, ECode ASC", $con);}
	elseif($_REQUEST['act']=='dept' AND $_REQUEST['gg']==1){$sql=mysql_query("select ".$qry." where e.CompanyId=".$CompanyId." AND e.EmpStatus='A' AND g.DateJoining<='".$YYear."-06-30' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.Reviewer_EmployeeID=".$_REQUEST['value']." AND p.Appraiser_EmployeeID!=0 order by DepartmentCode ASC, HR_CurrGradeId ASC, ECode ASC", $con);}
	elseif($_REQUEST['act']=='dept' AND $_REQUEST['gg']==2){$sql=mysql_query("select ".$qry." where e.CompanyId=".$CompanyId." AND e.EmpStatus='A' AND g.DateJoining<='".$YYear."-06-30' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.Reviewer_EmployeeID=".$_REQUEST['value']." AND p.Appraiser_EmployeeID!=0 order by DepartmentCode DESC, HR_CurrGradeId ASC, ECode ASC", $con);}
	else{$sql=mysql_query("select ".$qry." where e.CompanyId=".$CompanyId." AND e.EmpStatus='A' AND g.DateJoining<='".$YYear."-06-30' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.Reviewer_EmployeeID=".$_REQUEST['value']." AND p.Appraiser_EmployeeID!=0 order by ECode ASC", $con);}

}
elseif($_REQUEST['ee']=='Hod')
{ 
   if($_REQUEST['act']=='g' AND $_REQUEST['gg']==1){$sql=mysql_query("select ".$qry." where e.CompanyId=".$CompanyId." AND e.EmpStatus='A' AND g.DateJoining<='".$YYear."-06-30' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.HOD_EmployeeID=".$_REQUEST['value']." AND p.Appraiser_EmployeeID!=0 order by HR_CurrGradeId ASC, ECode ASC", $con);}
	elseif($_REQUEST['act']=='g' AND $_REQUEST['gg']==2){$sql=mysql_query("select ".$qry." where e.CompanyId=".$CompanyId." AND e.EmpStatus='A' AND g.DateJoining<='".$YYear."-06-30' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.HOD_EmployeeID=".$_REQUEST['value']." AND p.Appraiser_EmployeeID!=0 order by HR_CurrGradeId DESC, ECode ASC", $con);}
	elseif($_REQUEST['act']=='de' AND $_REQUEST['gg']==1){$sql=mysql_query("select ".$qry." where e.CompanyId=".$CompanyId." AND e.EmpStatus='A' AND g.DateJoining<='".$YYear."-06-30' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.HOD_EmployeeID=".$_REQUEST['value']." AND p.Appraiser_EmployeeID!=0 order by DesigName ASC, HR_CurrGradeId ASC, ECode ASC", $con);}
	elseif($_REQUEST['act']=='de' AND $_REQUEST['gg']==2){$sql=mysql_query("select ".$qry." where e.CompanyId=".$CompanyId." AND e.EmpStatus='A' AND g.DateJoining<='".$YYear."-06-30' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.HOD_EmployeeID=".$_REQUEST['value']." AND p.Appraiser_EmployeeID!=0 order by DesigName DESC, HR_CurrGradeId ASC, ECode ASC", $con);}
	elseif($_REQUEST['act']=='dept' AND $_REQUEST['gg']==1){$sql=mysql_query("select ".$qry." where e.CompanyId=".$CompanyId." AND e.EmpStatus='A' AND g.DateJoining<='".$YYear."-06-30' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.HOD_EmployeeID=".$_REQUEST['value']." AND p.Appraiser_EmployeeID!=0 order by DepartmentCode ASC, HR_CurrGradeId ASC, ECode ASC", $con);}
	elseif($_REQUEST['act']=='dept' AND $_REQUEST['gg']==2){$sql=mysql_query("select ".$qry." where e.CompanyId=".$CompanyId." AND e.EmpStatus='A' AND g.DateJoining<='".$YYear."-06-30' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.HOD_EmployeeID=".$_REQUEST['value']." AND p.Appraiser_EmployeeID!=0 order by DepartmentCode DESC, HR_CurrGradeId ASC, ECode ASC", $con);}
	else{$sql=mysql_query("select ".$qry." where e.CompanyId=".$CompanyId." AND e.EmpStatus='A' AND g.DateJoining<='".$YYear."-06-30' AND p.AssessmentYear=".$_REQUEST['YI']." AND p.HOD_EmployeeID=".$_REQUEST['value']." AND p.Appraiser_EmployeeID!=0 order by ECode ASC", $con);}
}
