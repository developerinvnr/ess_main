...
<tr>
 <td align="left">
  ...
  <tr bgcolor="#7a6189">
   ...
   <td align="center" class="font" style="width:50px;">Year</td>
   <td align="center" class="font" style="width:50px;">Paid Day</td>
...
<tr id="TR<?php echo $sn; ?>">
   ...
   <td align="" class="font1">&nbsp;<?php echo $res['Month']; ?></td>
   <td align="" class="font1">&nbsp;<?php echo $res['Year']; ?></td>
   <td align="" class="font1">&nbsp;<?php echo $res['PaidDay']; ?></td>
