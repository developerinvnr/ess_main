...
<div class="thead">
 ...
 <tr bgcolor="#7a6189">
	...
	<td rowspan="2" align="center" style="color:#FFFFFF;" class="All_50"><b>Grade</b></td>
...
if($_REQUEST['DpId'] AND $_REQUEST['DpId']!='') { 
      $sqlDP = mysql_query("SELECT e.EmployeeID,EmpCode,Fname,Sname,Lname,HqId,DepartmentId,DesigId,Gender,Married,GradeValue FROM hrm_employee e INNER JOIN hrm_employee_general g ON e.EmployeeID=g.EmployeeID INNER JOIN hrm_employee_personal p ON e.EmployeeID=p.EmployeeID left join hrm_grade gr on g.GradeId=gr.GradeId WHERE e.EmpStatus='A' AND e.CompanyId=".$CompanyId." AND ".$dept, $con) or die(mysql_error()); 
...
<div class="tbody">
 ...
 <tr bgcolor="#FFFFFF" id="TR<?php echo $Sno; ?>"> 
		...
		<td class="All_200"><?php echo $Name; ?></td>
		<td align="center" class="All_50"><?php echo $resDP['GradeValue']; ?></td>
