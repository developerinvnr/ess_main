...
if($_REQUEST['value']!=20) {$SqlCtc = mysql_query("SELECT EmpCode,Fname,Sname,Lname,hrm_employee.EmployeeID,DepartmentId,GradeId,DesigId,Gender,DR,Married from hrm_employee INNER JOIN hrm_employee_general ON hrm_employee.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee_personal ON hrm_employee.EmployeeID=hrm_employee_personal.EmployeeID WHERE hrm_employee.EmpStatus='A' AND hrm_employee_general.DateJoining<='".$Y."-06-30' AND hrm_employee.CompanyId=".$_REQUEST['C']." AND hrm_employee_general.DepartmentId=".$_REQUEST['value']." order by ECode ASC", $con) or die(mysql_error()); } 

elseif($_REQUEST['value']==20) {$SqlCtc = mysql_query("SELECT EmpCode,Fname,Sname,Lname,hrm_employee.EmployeeID,DepartmentId,GradeId,DesigId,Gender,DR,Married from hrm_employee INNER JOIN hrm_employee_general ON hrm_employee.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee_personal ON hrm_employee.EmployeeID=hrm_employee_personal.EmployeeID WHERE hrm_employee.EmpStatus='A' AND hrm_employee_general.DateJoining<='".$Y."-06-30' AND hrm_employee.CompanyId=".$_REQUEST['C']." AND hrm_employee.EmployeeID!=223 AND hrm_employee.EmployeeID!=224 order by ECode ASC ", $con) or die(mysql_error());} while($ResCtc = mysql_fetch_assoc($SqlCtc)) { 
