...
/*
$sql=mysql_query("SELECT * FROM hrm_employee_separation where Log_NOC='Y'",$con);
while($res=mysql_fetch_assoc($sql))
{
 $up=mysql_query("update hrm_employee_separation_nocrep set Logistic_Noc_Submit_Date=NocSubmitDate where EmpSepId=".$res['EmpSepId'],$con);
 ...
 <table border="0">
  <tr>
   ...
   <tr>
    ...
    <td class="th" style="width:50px;"><b>Signature<br>File</b></td>
