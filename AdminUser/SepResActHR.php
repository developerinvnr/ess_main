...
if($_POST['SentRes'])
{
  ...
  if($_POST['SepValue']=='Y') 
  {
   ...
   $sql2Att=mysql_query("delete from hrm_employee_attendance where AttValue='HO' AND AttDate>'".date("Y-m-d",strtotime($_POST['HRDate']))."' AND EmployeeID=".$_POST['EmpId'], $con);
