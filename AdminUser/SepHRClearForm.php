...
document.getElementById("TotEL").readOnly=false; 
 ...
 document.getElementById("Comm_Allow").readOnly=false; document.getElementById("Car_Allow").readOnly=false;
 document.getElementById("Comm_Allow").style.background='#FFFFFF'; document.getElementById("Car_Allow").style.background='#FFFFFF';
...
function funCalcyVal()
{
 ...
 var Car_Allow = parseFloat(document.getElementById("Car_Allow").value); var Comm_Allow = parseFloat(document.getElementById("Comm_Allow").value); 
 ...
 var Exgredia = parseFloat(document.getElementById("Exgredia").value);
 var NoticePay = parseFloat(document.getElementById("NoticePay").value);
 var TotEar = document.getElementById("TotEar").value=Math.round(Gross+LTA+MA+CEA+LE+Bonus+Gratuity+Mediclaim+Exgredia+NoticePay+Bonus_Adjustment+Comm_Allow+Car_Allow);
...
$sqlDept=mysql_query("select department_code as DepartmentCode from core_departments where id=".$resE['DepartmentId'], $con); $resDept=mysql_fetch_assoc($sqlDept);
...
<td class="Text" align="center"><input class="AIT" id="PP" name="PP" onChange="funCalcyVal()" onBlur="funCalcyVal()" value="<?php if($res['PP']>0){echo intval($res['PP']);}else{echo 0;} ?>" /></td>
	...
	<tr bgcolor="#FFFFFF">
	 <td class="Text">&nbsp;Communication Allowance</td>
	 <td class="Text" align="center"><input class="AIT" id="Comm_Allow_R" name="Comm_Allow_R" value="<?php echo round($ResCtc['Communication_Allowance']/12); ?>" /></td>
	 <td class="Text" align="center"><input class="AIT" id="Comm_Allow" name="Comm_Allow" value="<?php if($res['Comm_Allow']>0){echo intval($res['Comm_Allow']);}else{echo 0;} ?>" onChange="funCalcyVal()" readonly/></td>
	</tr>
	<tr bgcolor="#FFFFFF">
	 <td class="Text">&nbsp;Car Allowance</td>
	 <td class="Text" align="center"><input class="AIT" id="Car_Allow_R" name="Car_Allow_R" value="<?php echo round($ResCtc['Car_Allowance']/12); ?>" /></td>
	 <td class="Text" align="center"><input class="AIT" id="Car_Allow" name="Car_Allow" value="<?php if($res['Car_Allow']>0){echo intval($res['Car_Allow']);}else{echo 0;} ?>" onChange="funCalcyVal()" readonly/></td>
	</tr>
