...
//echo "select * from hrm_employee_pms_behavioralformb where EmpPmsId=".$_REQUEST['PmsId']." order by BehavioralFormBId ASC";

$sql3=mysql_query("select * from hrm_employee_pms_behavioralformb where EmpPmsId=".$_REQUEST['PmsId']." order by BehavioralFormBId ASC",$con); $C=1; while($res3=mysql_fetch_array($sql3)){
