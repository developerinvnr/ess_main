...
{ $sql = mysql_query("select e.EmployeeID, EmpCode, Fname, Sname, Lname, DepartmentCode, ExtraAllowKRA, UnLckKRA, Appraiser_EmployeeID, Reviewer_EmployeeID, HOD_EmployeeID from hrm_employee e inner join hrm_employee_general g on e.EmployeeID=g.EmployeeID inner join hrm_employee_pms p on e.EmployeeID=p.EmployeeID inner join hrm_department d on g.DepartmentId=d.DepartmentId where p.Appraiser_EmployeeID=".$_REQUEST['value']." AND p.AssessmentYear=".$YEarId." AND e.EmpStatus='A' AND e.EmpCode!=1001 AND e.EmpCode!=1002 AND e.EmpCode!=1003 AND e.CompanyId=".$CompanyId." order by e.EmpCode asc",$con); }
elseif($_REQUEST['action']=='REVW')
{ $sql = mysql_query("select e.EmployeeID, EmpCode, Fname, Sname, Lname, DepartmentCode, ExtraAllowKRA, UnLckKRA, Appraiser_EmployeeID, Reviewer_EmployeeID, HOD_EmployeeID from hrm_employee e inner join hrm_employee_general g on e.EmployeeID=g.EmployeeID inner join hrm_employee_pms p on e.EmployeeID=p.EmployeeID inner join hrm_department d on g.DepartmentId=d.DepartmentId where p.Reviewer_EmployeeID=".$_REQUEST['value']." AND p.AssessmentYear=".$YEarId." AND e.EmpStatus='A' AND e.EmpCode!=1001 AND e.EmpCode!=1002 AND e.EmpCode!=1003 AND e.CompanyId=".$CompanyId." order by e.EmpCode asc",$con); }
elseif($_REQUEST['action']=='HODW')
{ $sql = mysql_query("select e.EmployeeID, EmpCode, Fname, Sname, Lname, DepartmentCode, ExtraAllowKRA, UnLckKRA, Appraiser_EmployeeID, Reviewer_EmployeeID, HOD_EmployeeID from hrm_employee e inner join hrm_employee_general g on e.EmployeeID=g.EmployeeID inner join hrm_employee_pms p on e.EmployeeID=p.EmployeeID inner join hrm_department d on g.DepartmentId=d.DepartmentId where p.HOD_EmployeeID=".$_REQUEST['value']." AND p.AssessmentYear=".$YEarId." AND e.EmpStatus='A' AND e.EmpCode!=1001 AND e.EmpCode!=1002 AND e.EmpCode!=1003 AND e.CompanyId=".$CompanyId." order by e.EmpCode asc",$con); }
