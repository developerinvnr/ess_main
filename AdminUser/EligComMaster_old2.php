   ...
   <table border="0" style="width:100%;">
	...
	<tr>
	  <td align="left" style="width:100%;">
		 ...
		 <?php if($_REQUEST['t']==1 OR $_REQUEST['t']==6 OR $_REQUEST['t']==7 OR $_REQUEST['t']==8 OR $_REQUEST['t']==9){$n=3;}elseif($_REQUEST['t']==2 OR $_REQUEST['t']==5){$n=2;}elseif($_REQUEST['t']==3){$n=4;}elseif($_REQUEST['t']==4){$n=1;}?>
		 ...
		 <tr style="background-color:<?php if($sno%2==0){echo '#ECE0F5';}else{echo '#FFFFFF';}?>">
		  ...
		  <?php } if($_REQUEST['t']==2){ /******* -------- 2222222222 --------**********/ ?>
		  ...
		  <?php } if($_REQUEST['t']==3){ /******* -------- 3333333333 --------**********/ ?>
		  ...
		  <?php } if($_REQUEST['t']==4){ /******* -------- 4444444444 --------**********/ ?>
		  ...
		  <?php } if($_REQUEST['t']==5){ /******* -------- 5555555555 --------**********/ ?>
		  ...
		  <?php } if($_REQUEST['t']==6){ /******* -------- 6666666666 --------**********/ ?>
		  ...
		  <?php } if($_REQUEST['t']==7){ /******* -------- 7777777777 --------**********/ ?>
		  ...
		  <?php } if($_REQUEST['t']==8){ /******* -------- 8888888888 --------**********/ ?>
		  ...
		  <?php } if($_REQUEST['t']==9){ /******* -------- 9999999999 --------**********/ ?>
