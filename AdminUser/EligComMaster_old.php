...
function SelFun(t,d){ var x = "EligComMaster_old.php?d="+d+"&t="+t; window.location=x; }
   ...
   <table border="0" style="width:100%;">
	...
	<tr>
	  <td align="left" style="width:100%;">
		...
		<?php $sVr=mysql_query("select v.VerticalId,v.VerticalName from hrm_department_vertical v left join hrm_employee_general g on v.VerticalId=g.EmpVertical where v.ComId=".$CompanyId." AND v.DeptId=".$_REQUEST['d']." AND (g.GradeId=".$rGr['GradeId']." OR v.GradeId=".$rGr['GradeId'].") group by v.VerticalName order by v.VerticalName ASC", $con); 
