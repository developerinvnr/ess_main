...
<table border="0" style="margin-top:0px; width:100%; height:300px;">
 <tr>
  <td align="left" height="20" valign="top" colspan="3">
   <table border="0">
    <tr>
	  <td align="left" width="350" class="heading">Grade Detials:</td>
   ...
   <table border="0" width="60%">
	...
	<tr>
	  <td align="left" width="100%">
	     <table border="1" bgcolor="#FFFFFF" id="table1" cellspacing="0" style="width:30%;">
		 <div class="thead">
		 <thead>
 <tr bgcolor="#7a6189">
   <td class="thc" style="width:50;">Sn</td>
   <td class="thc" style="width:100;">Name</td>
 </tr>
</thead>
</div>
<?php $sql=mysql_query("select * from core_grades where is_active=1 and company_id=".$CompanyId." order by id", $con); $SNo=1; while($res=mysql_fetch_array($sql)) { ?>
<div class="tbody">
 <tbody>
		  <tr>
