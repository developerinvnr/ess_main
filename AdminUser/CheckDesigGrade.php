...
if($_POST['act']=='upMW' && $_POST['v']!='' && $_POST['de']!='' && $_POST['DeptId']!='')
{ 
 $SUp = mysql_query("UPDATE hrm_deptgradedesig SET MW='".$_POST['v']."' WHERE CompanyId=".$_POST['ComId']." AND DepartmentId=".$_POST['DeptId']." AND  DesigId=".$_POST['de'] ,$con); 
 if($SUp){ echo '<input type="hidden" id="Rstv" value="1" />'; }else{ echo '<input type="hidden" id="Rstv" value="0"/>'; }
}
?>
