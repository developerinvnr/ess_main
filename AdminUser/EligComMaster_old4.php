   ...
   <table border="0" style="width:100%;">
	...
	<tr>
	  <td align="left" style="width:100%;">
		 ...
		 <?php if($_REQUEST['t']==1 OR $_REQUEST['t']==5 OR $_REQUEST['t']==6 OR $_REQUEST['t']==7 OR $_REQUEST['t']==8 OR $_REQUEST['t']==9){$n=3;}elseif($_REQUEST['t']==4){$n=2;}elseif($_REQUEST['t']==2 OR $_REQUEST['t']==3){$n=4;}elseif($_REQUEST['t']==10 OR $_REQUEST['t']==11){$n=1;}?>
		 ...
		 <tr style="background-color:<?php if($sno%2==0){echo '#ECE0F5';}else{echo '#FFFFFF';}?>">
		  <?php if($i==1){?><td class="tdc" rowspan="<?php if($_REQUEST['t']==1 OR $_REQUEST['t']==5 OR $_REQUEST['t']==6 OR $_REQUEST['t']==7 OR $_REQUEST['t']==8 OR $_REQUEST['t']==9){echo '3';}elseif($_REQUEST['t']==4){echo '2';}elseif($_REQUEST['t']==2 OR $_REQUEST['t']==3){echo '4'; }elseif($_REQUEST['t']==10 OR $_REQUEST['t']==11){echo '1'; }?>"><b><?=$resG['GradeValue']?></b></td><?php } ?>
