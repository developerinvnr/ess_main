 ...
 <tr>
   <td valign="top" style="width:100%;"> 
    <table style="width:100%;" border="0" cellspacing="1">
	 <tr>
	  <td class="th" style="width:60%;font-size:14px;">Records</td>
	  <td class="th" style="width:40%;font-size:14px;">Geo Location</td>
	 </tr>
	 <tr>
	  <td style="vertical-align:top;">
	   ...
	   <table id="table1" border="1" style="width:100%;" cellspacing="1">
		...
		<tr>
	     ...
	     <td class="th" style="width:40%;">Starting Point</td>
	     <td class="th" style="width:40%;">End Point</td>
		 <td class="th" style="width:50%;">Distance<br>KM</td>
		</tr>
		</thead>
		</div>
<?php
		...
		<tr style="background-color:#FFFFFF;">
		 ...
		 <td class="tdl">
		   <?php 
		    ...
		    $url="https://maps.googleapis.com/maps/api/geocode/json?latlng=".$res['eLat'].",".$res['eLong']."&sensor=false&key=".$key;
            ...
            echo '('.$res['eLat'].'/'.$res['eLong'].')';
            
		   ?>
		</td>
		
		
		 <td class="tdl"><?php if($res['eLat']!='' AND $res['eLong']!=''){ echo $Tot=GetDistance($res['sLat'], $res['sLong'], $res['eLat'], $res['eLong'], 'kilometers'); }else{ $Tot=0; } ?></td>
