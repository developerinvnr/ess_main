...
if($_REQUEST['value']=='All') {$result=mysql_query("select hrm_employee.*,DepartmentId,DesigId,GradeId,hrm_employee_eligibility.* from hrm_employee_general INNER JOIN hrm_employee ON hrm_employee_general.EmployeeID=hrm_employee.EmployeeID INNER JOIN hrm_employee_eligibility ON hrm_employee_general.EmployeeID=hrm_employee_eligibility.EmployeeID where hrm_employee.CompanyId=".$_REQUEST['C']." AND hrm_employee.EmpStatus='A' AND hrm_employee_eligibility.Status='A' order by ECode ASC", $con); }
else {$result=mysql_query("select hrm_employee.*,DepartmentId,DesigId,GradeId,hrm_employee_eligibility.* from hrm_employee_general INNER JOIN hrm_employee ON hrm_employee_general.EmployeeID=hrm_employee.EmployeeID INNER JOIN hrm_employee_eligibility ON hrm_employee_general.EmployeeID=hrm_employee_eligibility.EmployeeID where hrm_employee_general.DepartmentId=".$_REQUEST['value']." AND hrm_employee.CompanyId=".$_REQUEST['C']." AND hrm_employee.EmpStatus='A' AND hrm_employee_eligibility.Status='A' order by ECode ASC", $con); } 
