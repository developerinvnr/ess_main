...
<tr>
  ...
  <?php
   if(file_exists('../Employee/CovidCert/'.$resG['Covid_Vaccin_file']))
   { $file1='../Employee/CovidCert/'.$resG['Covid_Vaccin_file']; }
   else{$file1='https://vnress.in/Employee/CovidCert/'.$resG['Covid_Vaccin_file']; }
  ?>
  <td align="center" id="Td_SBtn_1" style="vertical-align:middle;font-family:Times New Roman;"><?php if($resG['Covid_Vaccin_file']!=''){echo '<a href='.$file1.' target="_blank">Uploaded</a>';  ?> 
...
<?php 
  ...
  <?php
   if(file_exists('../Employee/CovidCert/'.$resG['Covid_Vaccin2_file']))
   { $file2='../Employee/CovidCert/'.$resG['Covid_Vaccin2_file']; }
   else{$file2='https://vnress.in/Employee/CovidCert/'.$resG['Covid_Vaccin2_file']; }
  ?>
  <td align="center" id="Td_S2Btn_1" style="vertical-align:middle;font-family:Times New Roman;"><?php if($resG['Covid_Vaccin2_file']!=''){echo '<a href='.$file2.' target="_blank">Uploaded</a>';  ?> 
...
<?php 
  ...
  <?php
   if(file_exists('../Employee/CovidCert/'.$resG['Covid_Vaccin3_file']))
   { $file3='../Employee/CovidCert/'.$resG['Covid_Vaccin3_file']; }
   else{$file3='https://vnress.in/Employee/CovidCert/'.$resG['Covid_Vaccin3_file']; }
  ?>
  <td align="center" id="Td_S2Btn_1" style="vertical-align:middle;font-family:Times New Roman;"><?php if($resG['Covid_Vaccin3_file']!=''){echo '<a href='.$file3.' target="_blank">Uploaded</a>';  ?> 
