...
if($rowMP>0){ $UpSal=mysql_query("update ".$PayTable." set Hra=".$_POST['Hra'].", Special=".$_POST['Special'].", Bonus=".$_POST['Bonus'].", DA=".$_POST['Da'].", Arreares=".$_POST['Arrear'].", LeaveEncash=".$_POST['LeaveEnCash'].", Incentive=".$_POST['Incentive'].", VariableAdjustment=".$_POST['VarAdjust'].", PerformancePay=".$_POST['PerformPay'].", NoticePay=".$_POST['NoticePay'].", PP_Inc='".$_POST['PP_Inc']."', Bonus_Adjustment=".$_POST['Bonus_Adjustment'].", CCA=".$_POST['CCA'].", RA=".$_POST['RA'].", RA_Recover=".$_POST['RA_Recover'].", Car_Allowance=".$_POST['Car_Allowance'].", VarRemburmnt=".$_POST['VarRemburmnt'].", TA=".$_POST['TA'].", NPS=".$_POST['NPS'].", RecSplAllow=".$_POST['RecSplAllow'].", PP_year=".$_POST['PP_year'].", Deputation_Allow=".$_POST['Deputation_Allow'].", IDCard_Recovery=".$_POST['IDCard_Recovery'].", Communication_Allow=".$_POST['Communication_Allow']." where EmployeeID=".$_POST['E']." AND Month=".$_POST['M']." AND Year=".$_POST['Y']."", $con);}
else{ $UpSal=mysql_query("insert into ".$PayTable."(EmployeeID, Month, Year, Hra, Special, Bonus, DA, Arreares, LeaveEncash, Incentive, VariableAdjustment, PerformancePay, NoticePay, PP_Inc, Bonus_Adjustment, CCA, RA, RA_Recover, Car_Allowance, VarRemburmnt, TA, NPS, RecSplAllow, PP_year, Deputation_Allow, IDCard_Recovery, Communication_Allow) values(".$_POST['E'].", ".$_POST['M'].", ".$_POST['Y'].", ".$_POST['Hra'].", ".$_POST['Special'].", ".$_POST['Bonus'].", ".$_POST['Da'].", ".$_POST['Arrear'].", ".$_POST['LeaveEnCash'].", ".$_POST['Incentive'].", ".$_POST['VarAdjust'].", ".$_POST['PerformPay'].", ".$_POST['NoticePay'].", '".$_POST['PP_Inc']."', ".$_POST['Bonus_Adjustment'].", ".$_POST['CCA'].", ".$_POST['RA'].", ".$_POST['RA_Recover'].", ".$_POST['Car_Allowance'].", ".$_POST['VarRemburmnt'].", ".$_POST['TA'].", ".$_POST['NPS'].", ".$_POST['RecSplAllow'].", ".$_POST['PP_year'].", ".$_POST['Deputation_Allow'].", ".$_POST['IDCard_Recovery'].", '".$_POST['Communication_Allow']."')", $con);}
...
//document.getElementById("Special").readOnly=false;
  ...
  document.getElementById("PP_Inc").style.background='#EAEAEA'; document.getElementById("NoticePay").style.background='#EAEAEA'; document.getElementById("NPS").style.background='#EAEAEA'; document.getElementById("RecSplAllow").style.background='#EAEAEA'; document.getElementById("PP_year").style.background='#EAEAEA'; document.getElementById("Deputation_Allow").style.background='#EAEAEA'; document.getElementById("IDCard_Recovery").style.background='#EAEAEA';
  document.getElementById("Communication_Allow").readOnly=false;
  document.getElementById("Communication_Allow").style.background='#EAEAEA';
...
&nbsp;<font color="#800000">EC:</font>&nbsp;<?php echo $EC.'&nbsp;&nbsp;&nbsp;<font color="#800000">Name:</font>&nbsp;'.$Ename; ?>
 ...
 <tr>                                                     
  <td class="Des" style="background-color:#FFFFFF;">&nbsp;NOTICE PAY</td>
  <td align="center" class="Amt" style="background-color:#FFFFFF;"><input style="text-align:right;font-family:Times New Roman;font-size:12px;width:98px;border-style:hidden;" id="NoticePay" name="NoticePay" value="<?php echo intval($res['NoticePay']); ?>" maxlength="10" readonly /></td>
 </tr>
 <tr>
 ...
 <tr>
  <td class="Des" style="background-color:#FFFFFF;">&nbsp;NATIONAL PENSION SCHEME</td>
  <td align="center" class="Amt" style="background-color:#FFFFFF;"><input style="text-align:right;font-family:Times New Roman;font-size:12px;width:98px;border-style:hidden;" id="NPS" name="NPS" value="<?php echo intval($res['NPS']); ?>" maxlength="10" readonly /></td>
 </tr>
 <tr>
  <td class="Des" style="background-color:#FFFFFF;">&nbsp;RECOVERY FOR SPECIAL ALLOW</td>
  <td align="center" class="Amt" style="background-color:#FFFFFF;"><input style="text-align:right;font-family:Times New Roman;font-size:12px;width:98px;border-style:hidden;" id="RecSplAllow" name="RecSplAllow" value="<?php echo intval($res['RecSplAllow']); ?>" maxlength="10" readonly /></td>
 </tr>
 <tr>
  <td class="Des" style="background-color:#FFFFFF;">&nbsp;DEPUTATION ALLOW</td>
  <td align="center" class="Amt" style="background-color:#FFFFFF;"><input style="text-align:right;font-family:Times New Roman;font-size:12px;width:98px;border-style:hidden;" id="Deputation_Allow" name="Deputation_Allow" value="<?php echo intval($res['Deputation_Allow']); ?>" maxlength="10" readonly /></td>
 </tr>
 <tr>
  <td class="Des" style="background-color:#FFFFFF;">&nbsp;ID CARD RECOVERY</td>
  <td align="center" class="Amt" style="background-color:#FFFFFF;"><input style="text-align:right;font-family:Times New Roman;font-size:12px;width:98px;border-style:hidden;" id="IDCard_Recovery" name="IDCard_Recovery" value="<?php echo intval($res['IDCard_Recovery']); ?>" maxlength="10" readonly /></td>
 </tr>
 <tr>
  <td class="Des" style="background-color:#FFFFFF;">&nbsp;PERFORMANCE PAY YEARLY</td>
  <td align="center" class="Amt" style="background-color:#FFFFFF;"><input style="text-align:right;font-family:Times New Roman;font-size:12px;width:98px;border-style:hidden;" id="PP_year" name="PP_year" value="<?php echo intval($res['PP_year']); ?>" maxlength="10" readonly /></td>
 </tr>
 <tr>
  <td class="Des" style="background-color:#FFFFFF;">&nbsp;COMMUNICATION ALLOWANCE</td>
  <td align="center" class="Amt" style="background-color:#FFFFFF;"><input style="text-align:right;font-family:Times New Roman;font-size:12px;width:98px;border-style:hidden;" id="Communication_Allow" name="Communication_Allow" value="<?php echo intval($res['Communication_Allow']); ?>" maxlength="10" readonly /></td>
 </tr>
 <tr bgcolor="#7a6189">
