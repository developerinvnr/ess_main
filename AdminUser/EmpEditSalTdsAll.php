...
//document.getElementById("Special").readOnly=false;
  ...
  document.getElementById("RecSplAllow").readOnly=false;
  ...
  document.getElementById("PP_Inc").style.background='#EAEAEA'; document.getElementById("NoticePay").style.background='#EAEAEA'; document.getElementById("NPS").style.background='#EAEAEA'; document.getElementById("RecSplAllow").style.background='#EAEAEA';
