    ...
    if ($row > 0) {
	    ...
	    // print_r($NextEmpID);die;
            ...
            if ($InsE) {
                ...
                $sqLe=mysql_query("select CL,SL from hrm_leavedistributed where LeaveDisMonth=".date("m", strtotime($res['JoinOnDt']))." AND CompanyId=".$com,$con);  $reLe=mysql_fetch_assoc($sqLe);
