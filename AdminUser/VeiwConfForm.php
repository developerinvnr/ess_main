  ...
  <tr><td align="center" style="font-family:Times New Roman;font-size:15px;width:1000px;">
      <table border="0">
	   ...
	   <tr>
		...
		<td class="font1" id="TdC1" style="width:445px;" valign="top"><?php if($resLL['Communi']=='C'){ echo '<img src="images/checkbox_UnCheck.png"/>'; }else{echo '<img src="images/checkbox.png"/>';}?>&nbsp;Has the desire to share information but lacks the skills to do so.</td>
		<td class="font" style="width:30px;" align="center" valign="top">D</td>
		<td class="font1" id="TdD1" style="width:445px;" valign="top"><?php if($resLL['Communi']=='D'){ echo '<img src="images/checkbox_UnCheck.png"/>'; }else{echo '<img src="images/checkbox.png"/>';}?>&nbsp;Keep things to himself. Lacks the desire and skills to share information.</td>
	   </tr>
	   <tr><td></td></tr>
	   ...
	   <tr>
	    <td class="font" style="width:30px;" align="center" valign="top">A</td>
		<td class="font1" id="TdA2" style="width:445px;" valign="top"><?php if($resLL['JobKnowl']=='A'){ echo '<img src="images/checkbox_UnCheck.png"/>'; }else{echo '<img src="images/checkbox.png"/>';}?>&nbsp;Has thorough knowledge of primary and related jobs; quick in assimilation of varied information, concepts and issues.</td>
		<td class="font" style="width:30px;" align="center" valign="top">B</td>
		<td class="font1" id="TdB2" style="width:445px;" valign="top"><?php if($resLL['JobKnowl']=='B'){ echo '<img src="images/checkbox_UnCheck.png"/>'; }else{echo '<img src="images/checkbox.png"/>';}?>&nbsp;Has knowledge of various aspects of the jobs, good in assimilation of concepts, issues.</td>
	   </tr>
	   <tr>
	    <td class="font" style="width:30px;" align="center" valign="top">C</td>
		...
		<td class="font" style="width:30px;" align="center" valign="top">D</td>
		<td class="font1" id="TdD2" style="width:445px;" valign="top"><?php if($resLL['JobKnowl']=='D'){ echo '<img src="images/checkbox_UnCheck.png"/>'; }else{echo '<img src="images/checkbox.png"/>';}?>&nbsp;Needs frequent instructions; poor ability to grasp concepts and issues.</td>
	   </tr>
	   <tr><td></td></tr>
	   ...
	   <tr>
		...
		<td class="font" style="width:30px;" align="center" valign="top">B</td>
		<td class="font1" id="TdB3" style="width:445px;" valign="top"><?php if($resLL['OutPut']=='B'){ echo '<img src="images/checkbox_UnCheck.png"/>'; }else{echo '<img src="images/checkbox.png"/>';}?>&nbsp;Always gives good high output. Consistently result oriented.</td>
	   </tr>
	   <tr>
	    <td class="font" style="width:30px;" align="center" valign="top">C</td>
	   ...
	   <tr>
	    <td class="font" style="width:30px;" align="center" valign="top">C</td>
		<td class="font1" id="TdC6" style="width:445px;" valign="top"><?php if($resLL['ProblemSolve']=='C'){ echo '<img src="images/checkbox_UnCheck.png"/>'; }else{echo '<img src="images/checkbox.png"/>';}?>&nbsp;Has the ability to solve problems of a routine nature. Requires assistance in solving problem.</td>
		<td class="font" style="width:30px;" align="center" valign="top">D</td>
		<td class="font1" id="TdD6" style="width:445px;" valign="top"><?php if($resLL['ProblemSolve']=='D'){ echo '<img src="images/checkbox_UnCheck.png"/>'; }else{echo '<img src="images/checkbox.png"/>';}?>&nbsp;Requires help to diagnose even problems of a routine nature.</td>
	   </tr>
	   <tr><td></td></tr>
	   ...
	   <tr>
		...
		<td class="font" style="width:30px;" align="center" valign="top">B</td>
		<td class="font1" id="TdB8" style="width:445px;" valign="top"><?php if($resLL['Attendance']=='B'){ echo '<img src="images/checkbox_UnCheck.png"/>'; }else{echo '<img src="images/checkbox.png"/>';}?>&nbsp;Mostly regular in attendance. Reports on time and conscientious of assignments.  </td>
	   </tr>
	   <tr>
	    <td class="font" style="width:30px;" align="center" valign="top">C</td>
