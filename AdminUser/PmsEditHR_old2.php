...
?>
     <tr>
      ...
      <table border="1" id="table1" cellspacing="0" style="width:100%;">
       ...
       <thead>
       <tr>
        <td colspan="10" class="td1l" style="background-color:#0069D2;height:25px;"><?php if($_REQUEST['value']!=''){ ?>&nbsp;PMS Status <?php echo $sts; ?> Wise :&nbsp;&nbsp;(&nbsp;<?php echo $sts; ?> - <?php if($_REQUEST['value']!='All') {echo $name; }else echo 'All';?>&nbsp;)<?php } ?>
