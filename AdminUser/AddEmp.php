...
$sql = mysql_query("SELECT EmpCode FROM hrm_employee where CompanyId=".$CompanyId, $con); $resRow = mysql_num_rows($sql); 
  if($resRow==0) 
    { $NextEmpCode=$CompanyId.'1';}
	  ...
	  { $sql2 = mysql_query("SELECT MAX(EmpCode) as EmpCode FROM hrm_employee where CompanyId=".$CompanyId." AND EmpCode!=1001 AND EmpCode!=1002 AND EmpCode!=1003 AND EmpCode!=11001 AND EmployeeID<=100000", $con); $res2 = mysql_fetch_assoc($sql2);
...
<tr>
  <td class="All_100">First Name&nbsp;<font color="#FF0000">*</font> :</td><td class="All_125"><input name="Fname" id="Fname" value="<?php echo $ResEmp['Fname']; ?>" onBlur="PWD(this.form.thelength.value);" class="All_120" maxlength="20"></td>
  <td class="All_100">Middle Name :</td><td class="All_140"><input name="Sname" id="Sname" maxlength="20" value="<?php echo $ResEmp['Sname']; ?>" class="All_120"></td>
  <td class="All_100">Last Name&nbsp;<font color="#FF0000">*</font> :</td><td class="All_125"><input name="Lname" id="Lname" maxlength="20" value="<?php echo $ResEmp['Lname']; ?>" class="All_120"></td><!--style="text-transform:uppercase;"-->
</tr>
<tr>
