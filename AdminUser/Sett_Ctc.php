 ...
 */
 ...
 /*
 var OldPrvEmpPF = parseFloat(document.getElementById("OldPrvEmpPF").value);
 var VMaxPf = Math.round(((VPf_MaxSalPf*12)/100)*100)/100; 
 if(OldPrvEmpPF>VMaxPf)
 { var Cal_EmpProviFund = document.getElementById("EmpProviFund").value=Math.round((((Cal_EmpBasic*12)/100)*100)/100,0); }
 else if(Cal_EmpBasic<=VPf_MaxSalPf)
 { var Cal_EmpProviFund = document.getElementById("EmpProviFund").value=Math.round((((Cal_EmpBasic*12)/100)*100)/100,0); }
 else if(Cal_EmpBasic>VPf_MaxSalPf)
 ...
 */
 ...
 //alert(document.getElementById("ActComPFCheck").value);
...
{ 
  ...
  { 
   ...
   //|| (document.getElementById("ActComPFCheck").value=='Y' && document.getElementById("ActPFCheck").value=='N')
   
   //var pf = parseFloat(pf); var Ac_Pf = parseFloat(Ac_Pf);
   //(Ac_Pf>pf)
   
   var vDjj=document.getElementById("V_DJJ").value;
   
   if((document.getElementById("ActComPFCheck").value=='Y' && document.getElementById("ActPFCheck").value=='Y') || vDjj==1 || document.getElementById("V_Pfo").value>1800)
   { 
...
{  
 ...
 //Employer ESIC
 if(CtcGAS<=275304.01 && BonusM==2566){ var ComESIC=Math.round((CtcGAS*2.974893101)/100);}
 else if(CtcGAS<=275429.87 && BonusM==2410){ var ComESIC=Math.round((CtcGAS*2.973533698)/100);}
 else if(CtcGAS<=275555.73 && BonusM==2254){ var ComESIC=Math.round((CtcGAS*2.972175538)/100);}
 else if(CtcGAS<=275660.61 && BonusM==2124){ var ComESIC=Math.round((CtcGAS*2.971044721)/100);}
 else { var ComESIC=0; } 
 var CtcComESCI = document.getElementById("CtcAnnualESCI").value=ComESIC;
 
 //Mediclaim
 if((CtcGAS<=275304.01 && BonusM==2566) || (CtcGAS<=275429.87 && BonusM==2410) || (CtcGAS<=275555.73 && BonusM==2254) || (CtcGAS<=275660.61 && BonusM==2124))
 { //var CtcMediclaim=0; 
   var CtcMediclaim=document.getElementById("CtcEmpMediPoliPremium").value = parseFloat(document.getElementById("Emp_MPP_ESIC").value);     
...
{ 
 ...
 {  
   ...
   *
   ...
   var Cal_Emp_MPP = document.getElementById("CtcEmpMediPoliPremium").value = document.getElementById("Emp_MPP_ESIC").value;
 ...
 */
 ...
 <!------ ----------------- --------------- Random Check Open ---------------- ----------------->
  ...
  var NGross = parseFloat(document.getElementById("CtcEmpGrossMonSalary").value);
  ...
  if(DiffCtc>500000 && DiffCtc<=1000000){ var Plus10OldGross = Math.round((PlusOldGross+10000)*100)/100; }
  ...
  //if(OCtc<parseFloat(Min10_NCtc) || OCtc>NCtc)
  //if(OCtc<parseFloat(Min10_NCtc) || OCtc>NCtc)
  
  //alert(Plus10OldGross+"-"+OCtc+"-"+Min10_NCtc+"-"+DiffCtc);
...
function EditCtc()
{
 ...
 document.getElementById("CheckPF").disabled = false;
...
{ 
 ...
 var VEmp_MPP_ESIC = parseFloat(document.getElementById("Emp_MPP_ESIC").value);
 ...
 else
 {
  ...
  var Cal_Emp_MPP = document.getElementById("EmpMediPoliPremium").value=Math.round((VEmp_MPP_ESIC)*100)/100;
...
function FunCheckPF()
 {  
    if(document.getElementById("CheckPF").checked==true)
    {
      document.getElementById("EmpProviFund").readOnly=false;
    }
    else
    {
      document.getElementById("EmpProviFund").readOnly=true;    
    }
 }
...
<?php $sCtcE2 = mysql_query("SELECT PF_Employee_Contri_Value FROM hrm_employee_ctc WHERE Status='A' AND EmployeeID=".$EmpId, $con);  
      $ResCtc2 = mysql_fetch_assoc($sCtcE2); ?>	

<input type="hidden" name="V_Pfo" id="V_Pfo" value="<?php echo $ResCtc2['PF_Employee_Contri_Value']; ?>"/>
<?php if($ResEmp['DateJoining']>='2018-04-01'){ $DJJ=1; }else{ $DJJ=0; } ?>
<input type="hidden" name="V_DJJ" id="V_DJJ" value="<?php echo $DJJ; ?>"/>
...
<table border="1" width="100%" id="TEmp" cellpadding="1" cellspacing="1">
 ...
 <tr>
  <td class="td3" colspan="2" style="width:40%;">&nbsp;</td>
 ...
 <tr>
  ...
  <td class="td3" style="text-align:center;"><input type="hidden" class="td3" style="width:95%;text-align:right;" name="CtcEmpBasic" id="CtcEmpBasic" readonly value="<?php if($ResCtc['BAS']=='Y' AND $ResCtc['STIPEND']=='N') { echo $ResCtc['BAS_Value']; } if($ResCtc['BAS']=='N' AND $ResCtc['STIPEND']=='Y') { echo $ResCtc['STIPEND_Value']; }?>" onChange="ChangeBasic()" onKeyUp="ChangeBasic()" onKeyPress="return isNumberKey(event)" required></td>
 </tr>
 ...
 <tr>
  ...
  <td class="td3" id="hraB" style="text-align:center;"><input type="hidden" class="td3" style="width:95%;text-align:right;" name="CtcEmpHRA" id="CtcEmpHRA" value="<?php echo $ResCtc['HRA_Value']; ?>" onChange="FunCompaire()" onkeyup="FunCompaire()" onKeyPress="return isNumberKey(event)" required/></td>
 </tr>
 ...
 <tr>
  ...
  <td class="td3" id="caB" style="text-align:center;"><input class="td3" style="width:95%;text-align:right;background-color:#92D1BD;" value="<?php echo $ResCtc['CONV_Value']; ?>" disabled/></td>
  ...
  <td class="td3" id="caB" style="text-align:center;"><input type="hidden" class="td3" style="width:95%;text-align:right;" name="CtcEmpConAllow" value="<?php echo $ResCtc['CONV_Value']; ?>" id="CtcEmpConAllow" onChange="FunCompaire()" onkeyup="FunCompaire()" onKeyPress="return isNumberKey(event)" required/></td>
 </tr>
 <?php }else{ echo '<input type="hidden" name="EmpConAllow" value="0" id="EmpConAllow" readonly/><input type="hidden" name="CtcEmpConAllow" value="0" id="CtcEmpConAllow" readonly/><input type="hidden" name="Ctc2EmpConAllow" value="0" id="Ctc2EmpConAllow" readonly/>'; } ?>
 ...
 <tr>
  ...
  <td class="td3" id="caB" style="text-align:center;"><input type="hidden" class="td3" style="width:95%;text-align:right;" name="CtcTA" id="CtcTA" value="<?php echo $ResCtc['TA_Value']; ?>" onChange="ChangeTA()" onKeyDown="ChangeTA()" onKeyUp="ChangeTA()" class="All_100"  readonly onKeyPress="return isNumberKey(event)" required/></td>
 </tr>
 ...
 <tr>
  ...
  <td class="td3" id="caB" style="text-align:center;"><input type="hidden" class="td3" style="width:95%;text-align:right;" name="CtcCAR_ALL_Value" value="<?php echo $ResCtc['CAR_ALL_Value']; ?>" id="CtcCAR_ALL_Value" onChange="FunCompaire()" onkeyup="FunCompaire()" onKeyPress="return isNumberKey(event)" required/></td>
 </tr>
 <?php }else{ echo '<input type="hidden" name="CheckCarAllow" id="CheckCarAllow" readonly/><input type="hidden" name="CAR_ALL_Value" value="0" id="CAR_ALL_Value" readonly/><input type="hidden" name="CtcCAR_ALL_Value" value="0" id="CtcCAR_ALL_Value" readonly/><input type="hidden" name="Ctc2CAR_ALL_Value" value="0" id="Ctc2CAR_ALL_Value" readonly/>';  } ?>
 ...
 <tr>
  ...
  <td class="td3" id="caB" style="text-align:center;"><input class="td3" style="width:95%;text-align:right;" id="Bonus_Month" name="Bonus_Month" value="<?php echo $ResCtc['Bonus_Month']; ?>" onChange="ChangeBonusM()" readonly onKeyPress="return isNumberKey(event)"/></td>
  <td class="td3" id="caB" style="text-align:center;"><input type="hidden" class="td3" style="width:95%;text-align:right;" name="CtcBonus_Month" value="<?php echo $ResCtc['Bonus_Month']; ?>" id="CtcBonus_Month" onChange="FunCompaire()" onkeyup="FunCompaire()" onKeyPress="return isNumberKey(event)" required/></td>
 </tr>
 ...
 <tr>
  ...
  <td class="td3" id="saB" style="text-align:center;"><input type="hidden" name="CtcEmpSpeAllow" class="td3" style="width:95%;text-align:right;" value="<?php echo $ResCtc['SPECIAL_ALL_Value']; ?>" id="CtcEmpSpeAllow" onChange="FunCompaire()" onkeyup="FunCompaire()" onKeyPress="return isNumberKey(event)" required/></td>
 </tr>
 <tr>
  <td class="td3">&nbsp;</td><td class="td3">&nbsp;Gross Monthly Salary :</td>
  
  
  <td class="td3" style="text-align:center;"><input value="<?php echo $ResCtc['Tot_GrossMonth']; ?>" class="td3" style="width:95%;text-align:right;background-color:#92D1BD;" disabled/>
  <input type="hidden" id="OldGross" value="<?php echo $ResCtc['Tot_GrossMonth']; ?>" class="td3" style="width:95%;text-align:right;background-color:#92D1BD;"/>
  <input type="hidden" id="PlusOldGross" value="<?=$ResCtc['Tot_GrossMonth']?>" class="td3" style="width:95%;text-align:right;background-color:#92D1BD;"/>
  </td>
  ...
  <td class="td3" style="text-align:center;"><input type="hidden" name="CtcEmpGrossMonSalary" value="<?php echo $ResCtc['Tot_GrossMonth']; ?>" id="CtcEmpGrossMonSalary" class="td3" style="width:95%;text-align:right;" onChange="FunCompaire()" onkeyup="FunCompaire()" onKeyPress="return isNumberKey(event)" required/></td>
 </tr>
 <tr>
  ...
  <td class="td3" style="text-align:center;"><input type="hidden" name="CtcGMS_PAC" value="<?php if($ResCtc['GrossSalary_PostAnualComponent_Value']>0) { echo $ResCtc['GrossSalary_PostAnualComponent_Value']; } else { echo $ResCtc['Tot_GrossMonth']; } ?>" id="CtcGMS_PAC" class="td3" style="width:95%;text-align:right;" onChange="FunCompaire()" onkeyup="FunCompaire()" onKeyPress="return isNumberKey(event)" required/></td>
 </tr>

 <tr>
  <td class="td2"><input type="checkbox" name="CheckPF" id="CheckPF" checked onClick="FunCheckPF()" disabled/></td>
  <td class="td3" id="pfA">&nbsp;Provident Fund :</td>
  <td class="td3" id="pfB" style="text-align:center;"><input value="<?php echo $ResCtc['PF_Employee_Contri_Value']; ?>" class="td3" style="width:95%;text-align:right;background-color:#92D1BD;" disabled/><input type="hidden" id="OldPrvEmpPF" value="<?php echo $ResCtc['PF_Employee_Contri_Value']; ?>" readonly/></td>
  ...
  <td class="td3" id="pfB" style="text-align:center;"><input name="EmpProviFund" value="<?php echo $ResCtc['PF_Employee_Contri_Value']; ?>" id="EmpProviFund" class="td3" style="width:95%;text-align:right;" readonly onKeyPress="return isNumberKey(event)" onChange="FunEPF(this.value)"/>
  
  <input type="hidden" name="Extra_MrLtaCea" value="0" id="Extra_MrLtaCea" readonly/></td>
  <td class="td3" id="pfB" style="text-align:center;"><input type="hidden" name="CtcEmpProviFund" value="<?php echo $ResCtc['PF_Employee_Contri_Value']; ?>" id="CtcEmpProviFund" class="td3" style="width:95%;text-align:right;" onChange="FunCompaire()" onkeyup="FunCompaire()" onKeyPress="return isNumberKey(event)" required/></td>
 </tr>
 ...
 <tr>
  ...
  <td class="td3" id="pfB" style="text-align:center;"><input type="hidden" name="CtcEmpESCI" value="<?php echo $ResCtc['ESCI']; ?>" id="CtcEmpESCI" class="td3" style="width:95%;text-align:right;" onChange="FunCompaire()" onkeyup="FunCompaire()" onKeyPress="return isNumberKey(event)" required/></td>
...
<?php /********* NPS NPS NPS **********/ ?>
 <tr>
  ...
  <td class="td3" id="pfB" style="text-align:center;"><input type="hidden" name="CtcNPS_Value" value="<?php echo $ResCtc['NPS_Value']; ?>" id="CtcNPS_Value" class="td3" style="width:95%;text-align:right;" onChange="FunCompaire()" onkeyup="FunCompaire()" onKeyPress="return isNumberKey(event)" required/></td>
 </tr>
<?php /********* NPS NOPS NPS **********/?>	 
 ...
 <tr>
  ...
  <td class="td3" style="text-align:center;"><input type="hidden" value="<?php echo $ResCtc['NetMonthSalary_Value']; ?>" name="CtcEmpNetMonSalary" id="CtcEmpNetMonSalary" class="td3" style="width:95%;text-align:right;background-color:#DCEEF1;font-weight:bold;" onChange="FunCompaire()" onkeyup="FunCompaire()" onKeyPress="return isNumberKey(event)" required/></td>
 </tr>
...
{ 
 ...
 <tr>
  ...
  <td class="td3" id="ltaB" style="text-align:center;"><input type="hidden" name="CtcEmpLeaveTraAllow" value="<?php echo $ResCtc['LTA_Value']; ?>" id="CtcEmpLeaveTraAllow" class="td3" style="width:95%;text-align:right;" onChange="FunCompaire()" onkeyup="FunCompaire()" onKeyPress="return isNumberKey(event)" required/></td>
 ...
 <tr>
  ...
  <td class="td3" id="ceaB" style="text-align:center;"><input type="hidden" name="CtcEmpChildEduAllow" value="<?php echo $ResCtc['CHILD_EDU_ALL_Value']; ?>" id="CtcEmpChildEduAllow" onChange="FunCompaire()" onkeyup="FunCompaire()" class="td3" style="width:95%;text-align:right;" onKeyPress="return isNumberKey(event)" required/></td>
 </tr>
 <tr>
  ...
  <td class="td3" style="text-align:center;"><input type="hidden" value="<?php echo $ResCtc['Tot_Gross_Annual']; ?>" name="CtcEmpAnnGrossSalary" id="CtcEmpAnnGrossSalary" class="td3" style="width:95%;text-align:right;background-color:#DCEEF1;font-weight:bold;" onChange="FunCompaire()" onkeyup="FunCompaire()" onKeyPress="return isNumberKey(event)" required/></td>
 </tr>
 ...
 <tr>
  ...
  <td class="td3" id="gratuityB" style="text-align:center;"><input type="hidden" name="CtcEmpEstiGratuity" value="<?php echo $ResCtc['GRATUITY_Value']; ?>" id="CtcEmpEstiGratuity" class="td3" style="width:95%;text-align:right;" onChange="FunCompaire()" onkeyup="FunCompaire()" onKeyPress="return isNumberKey(event)" required/></td>
 </tr>
 <tr>
  ...
  <td class="td3" id="pfcontriB" style="text-align:center;"><input type="hidden" name="CtcEmpEmployerPFContri" value="<?php echo $ResCtc['PF_Employer_Contri_Annul']; ?>" id="CtcEmpEmployerPFContri" class="td3" style="width:95%;text-align:right;" onChange="FunCompaire()" onkeyup="FunCompaire()" onKeyPress="return isNumberKey(event)" required/></td>
 </tr>
 <tr>
  <td class="td3">&nbsp;</td>
  ...
  <td class="td3" id="mppB" style="text-align:center;"><input type="hidden" name="CtcAnnualESCI" value="<?php echo $ResCtc['AnnualESCI']; ?>" id="CtcAnnualESCI" class="td3" style="width:95%;text-align:right;" onChange="FunCompaire()" onkeyup="FunCompaire()" onKeyPress="return isNumberKey(event)" required/></td>
 </tr>
 <tr>
  <td class="td2"><input type="checkbox" name="CheckMPP" id="CheckMPP" onClick="FunMPP()" disabled Checked/></td>
  <td class="td3" id="mppA">&nbsp;Insurance Policy Premiums :</td>
  ...
  <td class="td3" id="mppB" style="text-align:center;"><input type="hidden" name="CtcEmpMediPoliPremium" id="CtcEmpMediPoliPremium" onChange="ChangeMPP()" onKeyUp="ChangeMPP()" value="<?php echo $ResCtc['Mediclaim_Policy']; ?>" class="td3" style="width:95%;text-align:right;" onChange="FunCompaire()" onkeyup="FunCompaire()" onKeyPress="return isNumberKey(event)" required/></td>
 </tr>
 <tr>
  <td class="td3">&nbsp;</td><td class="td3">&nbsp;Total Cost to Company :</td>
  <td class="td3" style="text-align:center;"><input value="<?php echo $ResCtc['Tot_CTC']; ?>" class="td3" style="width:95%;text-align:right;background-color:#92D1BD;font-weight:bold;" disabled/><input type="hidden" id="PrvOldCTC" value="<?php echo $ResCtc['Tot_CTC']; ?>" class="td3" style="width:95%;text-align:right;background-color:#92D1BD;font-weight:bold;" disabled/></td>
 ...
 <tr>
  ...
  <td class="td3" id="micA">&nbsp;Insurance Policy (Coverage for Employee, Spouse 2 children) :
  ...
  <td class="td3" id="micB" style="text-align:center;"><input type="hidden" name="CtcEmpAddBenifit_MediInsu" id="CtcEmpAddBenifit_MediInsu" value="<?php echo $ResCtc['EmpAddBenifit_MediInsu_value']; ?>" class="td3" style="width:95%;text-align:right;" required/></td>
 </tr>
 <tr>
  ...
  <td class="td3" id="micB" style="text-align:center;"><input type="hidden" name="CtcCar_Entitlement" id="CtcCar_Entitlement" value="<?php echo $ResCtc['Car_Entitlement']; ?>" class="td3" style="width:95%;text-align:right;" required/></td>
 </tr>
 
 <tr>
  <td class="td2"><input type="checkbox" name="CheckCarEnt" id="CheckCarEnt" onClick="FunCarEnt()" disabled/></td>
  <td class="td3" id="micA">&nbsp;Remark :</td>
  <td class="td3" id="micB" colspan="5" style="text-align:center;"><input Name="Rmkk" id="Rmkk" style="width:99%;font-family:Times New Roman;font-size:12px;" value="<?php echo 'PMS Activity'; ?>"/></td>
