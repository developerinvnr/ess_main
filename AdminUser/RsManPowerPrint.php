...
<?php $today=date("Y-m-d"); $timestamp = strtotime($today); 
 ...
 $sql=mysql_query(" select * from core_departments where is_active=1 order by department_name",$con); 
...
<tr id="TR<?php echo $SNo; ?>">
   ...
   <td align="" class="font1">&nbsp;<?php echo $res['department_name']; ?></td>
<?php $sql1=mysql_query("select GeneralId from hrm_employee_general INNER JOIN hrm_employee ON hrm_employee_general.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee.CompanyId=".$CompanyId." AND hrm_employee_general.DepartmentId=".$res['id']." AND hrm_employee_general.DOB>='".$y20."' AND hrm_employee_general.DOB<'".$y18."' ",$con); $row1=mysql_num_rows($sql1); ?><td align="center" class="font1"><?php if($row1>0){echo $row1;} ?></td>
<?php $sql2=mysql_query("select GeneralId from hrm_employee_general INNER JOIN hrm_employee ON hrm_employee_general.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee.CompanyId=".$CompanyId." AND hrm_employee_general.DepartmentId=".$res['id']." AND hrm_employee_general.DOB>='".$y25."' AND hrm_employee_general.DOB<'".$y20."' ",$con); $row2=mysql_num_rows($sql2); ?><td align="center" class="font1"><?php if($row2>0){echo $row2;} ?></td>
<?php $sql3=mysql_query("select GeneralId from hrm_employee_general INNER JOIN hrm_employee ON hrm_employee_general.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee.CompanyId=".$CompanyId." AND hrm_employee_general.DepartmentId=".$res['id']." AND hrm_employee_general.DOB>='".$y30."' AND hrm_employee_general.DOB<'".$y25."' ",$con); $row3=mysql_num_rows($sql3); ?><td align="center" class="font1"><?php if($row3>0){echo $row3;} ?></td>
<?php $sql4=mysql_query("select GeneralId from hrm_employee_general INNER JOIN hrm_employee ON hrm_employee_general.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee.CompanyId=".$CompanyId." AND hrm_employee_general.DepartmentId=".$res['id']." AND hrm_employee_general.DOB>='".$y35."' AND hrm_employee_general.DOB<'".$y30."' ",$con); $row4=mysql_num_rows($sql4); ?><td align="center" class="font1"><?php if($row4>0){echo $row4;} ?></td>
<?php $sql5=mysql_query("select GeneralId from hrm_employee_general INNER JOIN hrm_employee ON hrm_employee_general.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee.CompanyId=".$CompanyId." AND hrm_employee_general.DepartmentId=".$res['id']." AND hrm_employee_general.DOB>='".$y40."' AND hrm_employee_general.DOB<'".$y35."' ",$con); $row5=mysql_num_rows($sql5); ?><td align="center" class="font1"><?php if($row5>0){echo $row5;} ?></td>
<?php $sql6=mysql_query("select GeneralId from hrm_employee_general INNER JOIN hrm_employee ON hrm_employee_general.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee.CompanyId=".$CompanyId." AND hrm_employee_general.DepartmentId=".$res['id']." AND hrm_employee_general.DOB>='".$y45."' AND hrm_employee_general.DOB<'".$y40."' ",$con); $row6=mysql_num_rows($sql6); ?><td align="center" class="font1"><?php if($row6>0){echo $row6;} ?></td>
<?php $sql7=mysql_query("select GeneralId from hrm_employee_general INNER JOIN hrm_employee ON hrm_employee_general.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee.CompanyId=".$CompanyId." AND hrm_employee_general.DepartmentId=".$res['id']." AND hrm_employee_general.DOB>='".$y50."' AND hrm_employee_general.DOB<'".$y45."' ",$con); $row7=mysql_num_rows($sql7); ?><td align="center" class="font1"><?php if($row7>0){echo $row7;} ?></td>
<?php $sql8=mysql_query("select GeneralId from hrm_employee_general INNER JOIN hrm_employee ON hrm_employee_general.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee.CompanyId=".$CompanyId." AND hrm_employee_general.DepartmentId=".$res['id']." AND hrm_employee_general.DOB>='".$y55."' AND hrm_employee_general.DOB<'".$y50."' ",$con); $row8=mysql_num_rows($sql8); ?><td align="center" class="font1"><?php if($row8>0){echo $row8;} ?></td>
<?php $sql9=mysql_query("select GeneralId from hrm_employee_general INNER JOIN hrm_employee ON hrm_employee_general.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee.CompanyId=".$CompanyId." AND hrm_employee_general.DepartmentId=".$res['id']." AND hrm_employee_general.DOB>='".$y60."' AND hrm_employee_general.DOB<'".$y55."'",$con); $row9=mysql_num_rows($sql9); ?><td align="center" class="font1"><?php if($row9>0){echo $row9;} ?></td>
<?php $sql10=mysql_query("select GeneralId from hrm_employee_general INNER JOIN hrm_employee ON hrm_employee_general.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee.CompanyId=".$CompanyId." AND hrm_employee_general.DepartmentId=".$res['id']." AND hrm_employee_general.DOB<'".$y60."'",$con); $row10=mysql_num_rows($sql10); ?> <td align="center" class="font1"><?php if($row10>0){echo $row10;} ?></td>
<?php $sql11=mysql_query("select GeneralId from hrm_employee_general INNER JOIN hrm_employee ON hrm_employee_general.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee.CompanyId=".$CompanyId." AND hrm_employee_general.DepartmentId=".$res['id'],$con); $row11=mysql_num_rows($sql11); ?> 
