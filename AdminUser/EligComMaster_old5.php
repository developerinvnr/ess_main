   ...
   <table border="0" style="width:100%;">
	...
	<tr>
	  <td align="left" style="width:100%;">
		 ...
		 <?php if($_REQUEST['t']==1 OR $_REQUEST['t']==5 OR $_REQUEST['t']==6 OR $_REQUEST['t']==7 OR $_REQUEST['t']==8 OR $_REQUEST['t']==9){$n=3;}elseif($_REQUEST['t']==4 OR $_REQUEST['t']==12){$n=2;}elseif($_REQUEST['t']==2){$n=4;}elseif($_REQUEST['t']==10 OR $_REQUEST['t']==11){$n=1;}elseif($_REQUEST['t']==3){$n=7;}?>
