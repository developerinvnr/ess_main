...
<?php if($_REQUEST['D']!='All'){ $SqlEmp=mysql_query("select hrm_employee.*,hrm_employee_general.* from hrm_employee INNER JOIN hrm_employee_general ON hrm_employee.EmployeeID=hrm_employee_general.EmployeeID where hrm_employee.EmpStatus!='De' AND hrm_employee_general.DepartmentId=".$_REQUEST['D']." AND (hrm_employee.DateOfSepration='0000-00-00' OR hrm_employee.DateOfSepration='1970-01-01' OR hrm_employee.DateOfSepration>='".date($_REQUEST['Y']."-".$_REQUEST['m']."-01")."') AND hrm_employee_general.DateJoining<='".date($_REQUEST['Y']."-".$_REQUEST['m']."-31")."' AND hrm_employee.EmpCode<=11000 order by ECode ASC", $con); }
      if($_REQUEST['D']=='All'){ $SqlEmp=mysql_query("select hrm_employee.*,hrm_employee_general.* from hrm_employee INNER JOIN hrm_employee_general ON hrm_employee.EmployeeID=hrm_employee_general.EmployeeID where hrm_employee.EmpStatus!='De' AND hrm_employee.CompanyId=".$_REQUEST['C']." AND ".$EmpMgmtId." AND hrm_employee_general.DepartmentId!=0 AND (hrm_employee.DateOfSepration='0000-00-00' OR hrm_employee.DateOfSepration='1970-01-01' OR hrm_employee.DateOfSepration>='".date($_REQUEST['Y']."-".$_REQUEST['m']."-01")."') AND hrm_employee_general.DateJoining<='".date($_REQUEST['Y']."-".$_REQUEST['m']."-31")."' AND hrm_employee.EmpCode<=11000 order by ECode ASC", $con); }
