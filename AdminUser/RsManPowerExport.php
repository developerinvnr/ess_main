...
$sql1=mysql_query("select GeneralId from hrm_employee_general INNER JOIN hrm_employee ON hrm_employee_general.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee.CompanyId=".$_REQUEST['c']." AND hrm_employee_general.DepartmentId=".$res['id']." AND hrm_employee_general.DOB>='".$y20."' AND hrm_employee_general.DOB<'".$y18."' ",$con); $row1=mysql_num_rows($sql1); 
$csv_output .= '"'.str_replace('"', '""', $row1).'",';
$sql2=mysql_query("select GeneralId from hrm_employee_general INNER JOIN hrm_employee ON hrm_employee_general.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee.CompanyId=".$_REQUEST['c']." AND hrm_employee_general.DepartmentId=".$res['id']." AND hrm_employee_general.DOB>='".$y25."' AND hrm_employee_general.DOB<'".$y20."' ",$con); $row2=mysql_num_rows($sql2); 
$csv_output .= '"'.str_replace('"', '""', $row2).'",';
$sql3=mysql_query("select GeneralId from hrm_employee_general INNER JOIN hrm_employee ON hrm_employee_general.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee.CompanyId=".$_REQUEST['c']." AND hrm_employee_general.DepartmentId=".$res['id']." AND hrm_employee_general.DOB>='".$y30."' AND hrm_employee_general.DOB<'".$y25."' ",$con); $row3=mysql_num_rows($sql3); 
$csv_output .= '"'.str_replace('"', '""', $row3).'",';
$sql4=mysql_query("select GeneralId from hrm_employee_general INNER JOIN hrm_employee ON hrm_employee_general.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee.CompanyId=".$_REQUEST['c']." AND hrm_employee_general.DepartmentId=".$res['id']." AND hrm_employee_general.DOB>='".$y35."' AND hrm_employee_general.DOB<'".$y30."' ",$con); $row4=mysql_num_rows($sql4);
$csv_output .= '"'.str_replace('"', '""', $row4).'",'; 
$sql5=mysql_query("select GeneralId from hrm_employee_general INNER JOIN hrm_employee ON hrm_employee_general.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee.CompanyId=".$_REQUEST['c']." AND hrm_employee_general.DepartmentId=".$res['id']." AND hrm_employee_general.DOB>='".$y40."' AND hrm_employee_general.DOB<'".$y35."' ",$con); $row5=mysql_num_rows($sql5); 
$csv_output .= '"'.str_replace('"', '""', $row5).'",';
$sql6=mysql_query("select GeneralId from hrm_employee_general INNER JOIN hrm_employee ON hrm_employee_general.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee.CompanyId=".$_REQUEST['c']." AND hrm_employee_general.DepartmentId=".$res['id']." AND hrm_employee_general.DOB>='".$y45."' AND hrm_employee_general.DOB<'".$y40."' ",$con); $row6=mysql_num_rows($sql6); 
$csv_output .= '"'.str_replace('"', '""', $row6).'",';
$sql7=mysql_query("select GeneralId from hrm_employee_general INNER JOIN hrm_employee ON hrm_employee_general.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee.CompanyId=".$_REQUEST['c']." AND hrm_employee_general.DepartmentId=".$res['id']." AND hrm_employee_general.DOB>='".$y50."' AND hrm_employee_general.DOB<'".$y45."' ",$con); $row7=mysql_num_rows($sql7); 
$csv_output .= '"'.str_replace('"', '""', $row7).'",';
$sql8=mysql_query("select GeneralId from hrm_employee_general INNER JOIN hrm_employee ON hrm_employee_general.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee.CompanyId=".$_REQUEST['c']." AND hrm_employee_general.DepartmentId=".$res['id']." AND hrm_employee_general.DOB>='".$y55."' AND hrm_employee_general.DOB<'".$y50."' ",$con); $row8=mysql_num_rows($sql8); 
$csv_output .= '"'.str_replace('"', '""', $row8).'",';
$sql9=mysql_query("select GeneralId from hrm_employee_general INNER JOIN hrm_employee ON hrm_employee_general.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee.CompanyId=".$_REQUEST['c']." AND hrm_employee_general.DepartmentId=".$res['id']." AND hrm_employee_general.DOB>='".$y60."' AND hrm_employee_general.DOB<'".$y55."'",$con); $row9=mysql_num_rows($sql9); 
$csv_output .= '"'.str_replace('"', '""', $row9).'",';
$sql10=mysql_query("select GeneralId from hrm_employee_general INNER JOIN hrm_employee ON hrm_employee_general.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee.CompanyId=".$_REQUEST['c']." AND hrm_employee_general.DepartmentId=".$res['id']." AND hrm_employee_general.DOB<'".$y60."'",$con); 
$row10=mysql_num_rows($sql10); 
$csv_output .= '"'.str_replace('"', '""', $row10).'",';
$sql11=mysql_query("select GeneralId from hrm_employee_general INNER JOIN hrm_employee ON hrm_employee_general.EmployeeID=hrm_employee.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee.CompanyId=".$_REQUEST['c']." AND hrm_employee_general.DepartmentId=".$res['id'],$con); $row11=mysql_num_rows($sql11); 
