...
if($_REQUEST['ls']==10)
{ 
 if($_REQUEST['mlm']=='All'){ $sql_statement = mysql_query("SELECT al.*,EmpCode,Fname,Sname,Lname,designation_name,department_name,Gender,DR,Married FROM ".$AppLeaveTable." al INNER JOIN hrm_employee e ON al.EmployeeID=e.EmployeeID INNER JOIN hrm_employee_general g ON al.EmployeeID=g.EmployeeID INNER JOIN hrm_employee_personal p ON al.EmployeeID=p.EmployeeID left join core_departments dept on g.DepartmentId=dept.id left join core_designation desig on g.DesigId=desig.id where (al.LeaveStatus=0 OR al.LeaveStatus=1) AND al.Apply_FromDate>='".date($_REQUEST['yly']."-01-01")."' AND al.Apply_FromDate<='".date($_REQUEST['yly']."-12-31")."' AND e.CompanyId=".$CompanyId." ORDER BY al.Apply_Date DESC", $con); }else{ $sql_statement = mysql_query("SELECT al.*,EmpCode,Fname,Sname,Lname,designation_name,department_name,Gender,DR,Married FROM ".$AppLeaveTable." al INNER JOIN hrm_employee e ON al.EmployeeID=e.EmployeeID INNER JOIN hrm_employee_general g ON al.EmployeeID=g.EmployeeID INNER JOIN hrm_employee_personal p ON al.EmployeeID=p.EmployeeID left join core_departments dept on g.DepartmentId=dept.id left join core_designation desig on g.DesigId=desig.id where (al.LeaveStatus=0 OR al.LeaveStatus=1) AND al.Apply_FromDate>='".date($_REQUEST['yly']."-".$_REQUEST['mlm']."-01")."' AND al.Apply_FromDate<='".date($_REQUEST['yly']."-".$_REQUEST['mlm']."-31")."' AND e.CompanyId=".$CompanyId." ORDER BY al.Apply_Date DESC", $con); } 
}
elseif($_REQUEST['ls']==4)
{ 
 if($_REQUEST['mlm']=='All'){ $sql_statement = mysql_query("SELECT al.*,EmpCode,Fname,Sname,Lname,designation_name,department_name,Gender,DR,Married FROM ".$AppLeaveTable." al INNER JOIN hrm_employee e ON al.EmployeeID=e.EmployeeID INNER JOIN hrm_employee_general g ON al.EmployeeID=g.EmployeeID INNER JOIN hrm_employee_personal p ON al.EmployeeID=p.EmployeeID left join core_departments dept on g.DepartmentId=dept.id left join core_designation desig on g.DesigId=desig.id where al.LeaveEmpCancelStatus='Y' AND al.Apply_FromDate>='".date($_REQUEST['yly']."-01-01")."' AND al.Apply_FromDate<='".date($_REQUEST['yly']."-12-31")."' AND e.CompanyId=".$CompanyId." ORDER BY al.Apply_FromDate DESC", $con); }else{ $sql_statement = mysql_query("SELECT al.*,EmpCode,Fname,Sname,Lname,designation_name,department_name,Gender,DR,Married FROM ".$AppLeaveTable." al INNER JOIN hrm_employee e ON al.EmployeeID=e.EmployeeID INNER JOIN hrm_employee_general g ON al.EmployeeID=g.EmployeeID INNER JOIN hrm_employee_personal p ON al.EmployeeID=p.EmployeeID left join core_departments dept on g.DepartmentId=dept.id left join core_designation desig on g.DesigId=desig.id where al.LeaveEmpCancelStatus='Y' AND al.Apply_FromDate>='".date($_REQUEST['yly']."-".$_REQUEST['mlm']."-01")."' AND al.Apply_FromDate<='".date($_REQUEST['yly']."-".$_REQUEST['mlm']."-31")."' AND e.CompanyId=".$CompanyId." ORDER BY al.Apply_FromDate DESC", $con); } 
}
else 
{ 
 if($_REQUEST['mlm']=='All'){ $sql_statement = mysql_query("SELECT al.*,EmpCode,Fname,Sname,Lname,designation_name,department_name,Gender,DR,Married FROM ".$AppLeaveTable." al INNER JOIN hrm_employee e ON al.EmployeeID=e.EmployeeID INNER JOIN hrm_employee_general g ON al.EmployeeID=g.EmployeeID INNER JOIN hrm_employee_personal p ON al.EmployeeID=p.EmployeeID left join core_departments dept on g.DepartmentId=dept.id left join core_designation desig on g.DesigId=desig.id where al.LeaveStatus=".$_REQUEST['ls']." AND al.Apply_FromDate>='".date($_REQUEST['yly']."-01-01")."' AND al.Apply_FromDate<='".date($_REQUEST['yly']."-12-31")."' AND e.CompanyId=".$CompanyId." ORDER BY al.Apply_FromDate DESC", $con); }else{ $sql_statement = mysql_query("SELECT al.*,EmpCode,Fname,Sname,Lname,designation_name,department_name,Gender,DR,Married FROM ".$AppLeaveTable." al INNER JOIN hrm_employee e ON al.EmployeeID=e.EmployeeID INNER JOIN hrm_employee_general g ON al.EmployeeID=g.EmployeeID INNER JOIN hrm_employee_personal p ON al.EmployeeID=p.EmployeeID left join core_departments dept on g.DepartmentId=dept.id left join core_designation desig on g.DesigId=desig.id where al.LeaveStatus=".$_REQUEST['ls']." AND al.Apply_FromDate>='".date($_REQUEST['yly']."-".$_REQUEST['mlm']."-01")."' AND al.Apply_FromDate<='".date($_REQUEST['yly']."-".$_REQUEST['mlm']."-31")."' AND e.CompanyId=".$CompanyId." ORDER BY al.Apply_FromDate DESC", $con); } 
}
...
<td class="hd2" align="left">&nbsp;<?php echo $resL['department_name']; ?></td>
