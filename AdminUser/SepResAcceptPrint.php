   ...
   <table border="0" width="790">
	 ...
	 <tr>
	  <td style="font-family:Times New Roman;color:#000000; width:785;" align="center">
		...
		<tr><td style="width:50px;">&nbsp;</td><td colspan="2" style="width:600px;font-size:15px;font-weight:bold;" align="center"><u>Registered AD/ Speed Post / Email 
</u></td></tr>
 <tr><td style="width:100px;">&nbsp;</td>
		  <td></td><td style="width:155px;font-size:18px;"><b>Date :&nbsp;<?php if($resSE['ResigAcceptDate']!='0000-00-00' AND $resSE['ResigAcceptDate']!='1970-01-01'){echo date("d-M-Y",strtotime($resSE['ResigAcceptDate']));} ?></b></td></tr>
