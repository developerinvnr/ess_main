...
<?php $sql=mysql_query("select * from core_departments where (id=4 OR id=7) order by department_code ASC", $con); $SNo=1; while($res=mysql_fetch_array($sql)){ ?>
<tr>
 <td align="center" style="font:Georgia;font-size:12px;" valign="top"><?php echo $SNo; ?></td>
 <td class="font" valign="top"><input name="DeptName" class="EditInput" value="<?php echo $res['department_name']; ?>" style="width:195px;"/></td>
 <td class="font" valign="top" align="center"><select name="DeptEmp" class="EditInput" style="width:200px;height:22px;" onChange="ChangeAccessEmp(this.value,<?php echo $res['id']; ?>)">
<?php $sqlch=mysql_query("select hrm_employee.EmployeeID,Fname,Sname,Lname from hrm_employee INNER JOIN hrm_asset_dept_access ON hrm_employee.EmployeeID=hrm_asset_dept_access.EmployeeID where hrm_asset_dept_access.DepartmentId=".$res['id']." AND hrm_employee.CompanyId=".$CompanyId, $con); 
...
<?php $sqlEmp=mysql_query("select hrm_employee.EmployeeID,Fname,Sname,Lname from hrm_employee INNER JOIN hrm_employee_general ON hrm_employee.EmployeeID=hrm_employee_general.EmployeeID where hrm_employee_general.DepartmentId=".$res['id']." AND hrm_employee.EmpStatus='A' AND hrm_employee.CompanyId=".$CompanyId." order by Fname ASC", $con); 
while($resEmp=mysql_fetch_array($sqlEmp)){ ?><option value="<?php echo $resEmp['EmployeeID']; ?>"><?php echo $resEmp['Fname'].' '.$resEmp['Sname'].' '.$resEmp['Lname']; ?></option><?php } ?><option value="0">Blank</option></select>
  ...
  <td class="font" valign="top" align="center"><select name="DeptEmp2" class="EditInput" style="width:200px;height:22px;" onChange="ChangeAccessEmp22(this.value,<?php echo $res['id']; ?>)">
<?php $sqlch2=mysql_query("select hrm_employee.EmployeeID,Fname,Sname,Lname from hrm_employee INNER JOIN hrm_asset_dept_access ON hrm_employee.EmployeeID=hrm_asset_dept_access.EmployeeID2 where hrm_asset_dept_access.DepartmentId=".$res['id']." AND hrm_employee.CompanyId=".$CompanyId." order by Fname ASC", $con); 
...
while($resEmp2=mysql_fetch_array($sqlEmp2)){ ?><option value="<?php echo $resEmp2['EmployeeID']; ?>"><?php echo $resEmp2['Fname'].' '.$resEmp2['Sname'].' '.$resEmp2['Lname']; ?></option><?php } ?><option value="0">Blank</option></select>
 ...
 <td class="font" valign="top" align="center"><select name="DeptEmp3" class="EditInput" style="width:150px;height:22px;" onChange="ChangeAccessEmp33(this.value,<?php echo $res['id']; ?>)">
<?php $sqlch2=mysql_query("select hrm_employee.EmployeeID,Fname,Sname,Lname from hrm_employee INNER JOIN hrm_asset_dept_access ON hrm_employee.EmployeeID=hrm_asset_dept_access.EmployeeID3 where hrm_asset_dept_access.DepartmentId=".$res['id']." AND hrm_employee.CompanyId=".$CompanyId." order by Fname ASC", $con); 
$rowch2=mysql_num_rows($sqlch2); if($rowch2>0){ $resch2=mysql_fetch_assoc($sqlch2);  ?><option value="<?php echo $resch2['EmployeeID2']; ?>"><?php echo $resch2['Fname'].' '.$resch2['Sname'].' '.$resch2['Lname']; ?></option><?php } else { ?><option value="0" selected>Select</option><?php } ?>
<?php $sqlEmp2=mysql_query("select hrm_employee.EmployeeID,Fname,Sname,Lname from hrm_employee INNER JOIN hrm_employee_general ON hrm_employee.EmployeeID=hrm_employee_general.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee.CompanyId=".$CompanyId." order by Fname ASC", $con); 
while($resEmp2=mysql_fetch_array($sqlEmp2)){ ?><option value="<?php echo $resEmp2['EmployeeID']; ?>"><?php echo $resEmp2['Fname'].' '.$resEmp2['Sname'].' '.$resEmp2['Lname']; ?></option><?php } ?><option value="0">Blank</option></select>
 </td>
 <td class="font" valign="top" align="center"><select name="DeptEmp4" class="EditInput" style="width:150px;height:22px;" onChange="ChangeAccessEmp44(this.value,<?php echo $res['id']; ?>)">
<?php $sqlch2=mysql_query("select hrm_employee.EmployeeID,Fname,Sname,Lname from hrm_employee INNER JOIN hrm_asset_dept_access ON hrm_employee.EmployeeID=hrm_asset_dept_access.EmployeeID4 where hrm_asset_dept_access.DepartmentId=".$res['id']." AND hrm_employee.CompanyId=".$CompanyId." order by Fname ASC", $con); 
$rowch2=mysql_num_rows($sqlch2); if($rowch2>0){ $resch2=mysql_fetch_assoc($sqlch2);  ?><option value="<?php echo $resch2['EmployeeID2']; ?>"><?php echo $resch2['Fname'].' '.$resch2['Sname'].' '.$resch2['Lname']; ?></option><?php } else { ?><option value="0" selected>Select</option><?php } ?>
<?php $sqlEmp2=mysql_query("select hrm_employee.EmployeeID,Fname,Sname,Lname from hrm_employee INNER JOIN hrm_employee_general ON hrm_employee.EmployeeID=hrm_employee_general.EmployeeID where hrm_employee.EmpStatus='A' AND hrm_employee.CompanyId=".$CompanyId." order by Fname ASC", $con); 
while($resEmp2=mysql_fetch_array($sqlEmp2)){ ?><option value="<?php echo $resEmp2['EmployeeID']; ?>"><?php echo $resEmp2['Fname'].' '.$resEmp2['Sname'].' '.$resEmp2['Lname']; ?></option><?php } ?><option value="0">Blank</option></select>
 </td>
