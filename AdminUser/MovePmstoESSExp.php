...
elseif($_REQUEST['v']==2) //Elig
{
 ...
 while($res=mysql_fetch_array($sql))
 {
  ...
  $schema_insert .= $res2['Mobile_Exp_Rem_Rmk'].$sep; 
  $schema_insert .= $res['Mobile_Exp_RemPost_Rs'].$sep;
  $schema_insert .= $res2['Mobile_Exp_RemPost_Rs'].$sep; 
  $schema_insert .= $res['PrdPost'].$sep;
  $schema_insert .= $res2['PrdPost'].$sep; 
  $schema_insert .= $res['Mobile_Exp_RemPost_Rmk'].$sep;
  $schema_insert .= $res2['Mobile_Exp_RemPost_Rmk'].$sep;  
    
  $schema_insert .= $res['Mobile_Hand_Elig_Rs'].$sep;
  $schema_insert .= $res2['Mobile_Hand_Elig_Rs'].$sep;
  $schema_insert .= $res['Mobile_Hand_Elig_Rs'].$sep;
  $schema_insert .= $res2['Mobile_Hand_Elig_Rs'].$sep; 
  $schema_insert .= $res['Mobile_Hand_Elig_Rmk'].$sep;
  $schema_insert .= $res2['Mobile_Hand_Elig_Rmk'].$sep;  
  $schema_insert .= $res['Health_Insurance'].$sep;
  $schema_insert .= $res2['Health_Insurance'].$sep; 
  $schema_insert .= $res['Term_Insurance'].$sep;
  $schema_insert .= $res2['Term_Insurance'].$sep;
  $schema_insert .= $res['HelthCheck_Amt'].$sep;
  $schema_insert .= $res2['HelthCheck_Amt'].$sep; 
  $schema_insert .= $res['HelthCheck_Rmk'].$sep;
  $schema_insert .= $res2['HelthCheck_Rmk'].$sep;
  $schema_insert .= $res['Status'].$sep;
  $schema_insert .= $res2['Status'].$sep; 
