...
/************************************************************* $_POST['AppProGSPM'] ***************************************************/
elseif(isset($_POST['AppProGSPM']) && $_POST['AppProGSPM']!="")
{ 
...
/******************************** $_POST['BasicStipend'] ****************************************/
elseif(isset($_POST['BasicStipend']) && $_POST['BasicStipend']!="")
{  
...
elseif(isset($_POST['LodgingCatA']) && $_POST['LodgingCatA']!="")
{ 
 ...
 if($_POST['Mobile_Remb']!='' && $_POST['Mobile_Remb_Period']!=''){ $Mobile_Remb='Y'; }else{ $Mobile_Remb='N'; }
 if($_POST['MobileHandRs']!=''){ $MobileHandRs='Y'; }else{ $MobileHandRs='N'; }
 ...
 if($rowElig>0)
 { $SqlInsElig = mysql_query("UPDATE hrm_employee_eligibility_pms SET PmsYearId=".$_POST['Y'].", EC='".$resCode['EmpCode']."', Lodging_CategoryA='".$_POST['LodgingCatA']."', Lodging_CategoryB='".$_POST['LodgingCatB']."', Lodging_CategoryC='".$_POST['LodgingCatC']."', DA_Outside_Hq='".$_POST['DaOutSide_HQRs']."', DA_Outside_Hq_Rmk='".$_POST['DaOutSide_HQRs_Rmk']."', DA_Inside_Hq='".$_POST['DaInSide_HQRs']."', DA_Inside_Hq_Rmk='".$_POST['DaInSide_HQRs_Rmk']."', ExHQ='".$_POST['ExHQ']."', ExHQ_Rmk='".$_POST['ExHQ_Rmk']."', Travel_TwoWeeKM='".$_POST['TwoWheelerKM']."', Travel_TwoWeeKM_Rmk='".$_POST['TwoWheelerKM_Rmk']."', Travel_FourWeeKM='".$_POST['FourWheelerKM']."', Travel_FourWeeKM_Rmk='".$_POST['FourWheelerKM_Rmk']."', VehiclePolicy='".$_POST['VehiclePolicy']."', Flight_Allow='".$_POST['Flight_YN']."', Flight_Class='".$_POST['Flight_Class']."', Flight_Rmk='".$_POST['Flight_Class_Rmk']."', Train_Allow='".$_POST['Train_YN']."', Train_Class='".$_POST['Train_Class']."', Train_Rmk='".$_POST['Train_Class_Rmk']."', Mobile_Exp_Rem='".$Mobile_Remb."', Mobile_Exp_Rem_Rs='".$_POST['Mobile_Remb']."', Prd='".$_POST['Mobile_Remb_Period']."', Mobile_Exp_Rem_Rmk='".$_POST['Mobile_Remb_Period_Rmk']."', Mobile_Exp_RemPost_Rs='".$_POST['Mobile_RembPost']."', PrdPost='".$_POST['Mobile_RembPost_Period']."', Mobile_Exp_RemPost_Rmk='".$_POST['Mobile_RembPost_Period_Rmk']."', Mobile_Hand_Elig='".$MobileHandRs."', Mobile_Hand_Elig_Rs='".$_POST['MobileHandRs']."', Mobile_Hand_Elig_Rmk='".$_POST['MobileHandRs_Rmk']."', GPSSet='".$_POST['GPSSet']."', Health_Insurance='".$_POST['HealthInsu']."', Term_Insurance='".$_POST['Term_Insurance']."', HelthCheck='".$_POST['HelthChekUp']."', HelthCheck_Amt='".$_POST['HelthChekUp_Amt']."', HelthCheck_Rmk='".$_POST['HelthChekUp_Rmk']."', FourWElig='".$_POST['Car2Policy']."', CostOfVehicle='".$_POST['VehicleCost']."', WithDriver='".$_POST['With2Driver']."', AdvanceCom='".$_POST['Advance2Com']."', DateOfEntryPolicy='".date("Y-m-d",strtotime($DateOfEPolicy))."', EligCreatedBy=".$_POST['U'].", EligCreatedDate='".date("Y-m-d",strtotime($_POST['CHDate']))."', EligYearId=".$_POST['Y'].", LessKm='".$_POST['LessKm']."', Plan='".$_POST['Plan']."', Bonus='As per Law', Gratuity='As per Law', Remark='".$_POST['Rmkk']."',  SysDate='".date("Y-m-d")."' WHERE PmsId=".$_POST['P']." AND EmployeeID=".$_POST['E']." AND EligCreatedDate='".date("Y-m-d",strtotime($_POST['CHDate']))."' AND Status='A'", $con);

 }
 if($rowElig==0)
 { 
   //$sqlU= mysql_query("UPDATE hrm_employee_eligibility_pms SET Status='D' where EmployeeID=".$_POST['E']." AND Status='A'", $con);
   $SqlInsElig = mysql_query("insert into hrm_employee_eligibility_pms(EmployeeID, PmsId, PmsYearId, EC, Lodging_CategoryA, Lodging_CategoryB, Lodging_CategoryC, DA_Outside_Hq, DA_Outside_Hq_Rmk, DA_Inside_Hq, DA_Inside_Hq_Rmk, ExHQ, ExHQ_Rmk, Travel_TwoWeeKM, Travel_TwoWeeKM_Rmk, Travel_FourWeeKM, Travel_FourWeeKM_Rmk, VehiclePolicy, Flight_Allow, Flight_Class, Flight_Rmk, Train_Allow, Train_Class, Train_Rmk, Mobile_Exp_Rem, Mobile_Exp_Rem_Rs, Prd, Mobile_Exp_Rem_Rmk, Mobile_Exp_RemPost_Rs, PrdPost, Mobile_Exp_RemPost_Rmk, Mobile_Hand_Elig, Mobile_Hand_Elig_Rs, Mobile_Hand_Elig_Rmk, GPSSet, Health_Insurance, Term_Insurance, HelthCheck, HelthCheck_Amt, HelthCheck_Rmk, FourWElig, CostOfVehicle, WithDriver, AdvanceCom, DateOfEntryPolicy, LessKm, Plan, Bonus, Gratuity, Remark, Status, EligCreatedBy, EligCreatedDate, SysDate, EligYearId) values(".$_POST['E'].", ".$_POST['P'].", ".$_POST['Y'].", '".$resCode['EmpCode']."', '".$_POST['LodgingCatA']."', '".$_POST['LodgingCatB']."', '".$_POST['LodgingCatC']."', '".$_POST['DaOutSide_HQRs']."', '".$_POST['DaOutSide_HQRs_Rmk']."', '".$_POST['DaInSide_HQRs']."', '".$_POST['DaInSide_HQRs_Rmk']."', '".$_POST['ExHQ']."', '".$_POST['ExHQ_Rmk']."', '".$_POST['TwoWheelerKM']."', '".$_POST['TwoWheelerKM_Rmk']."', '".$_POST['FourWheelerKM']."', '".$_POST['FourWheelerKM_Rmk']."', '".$_POST['VehiclePolicy']."', '".$_POST['Flight_YN']."', '".$_POST['Flight_Class']."', '".$_POST['Flight_Class_Rmk']."', '".$_POST['Train_YN']."', '".$_POST['Train_Class']."', '".$_POST['Train_Class_Rmk']."', '".$Mobile_Remb."', '".$_POST['Mobile_Remb']."', '".$_POST['Mobile_Remb_Period']."', '".$_POST['Mobile_Remb_Period_Rmk']."', '".$_POST['Mobile_RembPost']."', '".$_POST['Mobile_RembPost_Period']."', '".$_POST['Mobile_RembPost_Period_Rmk']."', '".$MobileHandRs."', '".$_POST['MobileHandRs']."', '".$_POST['MobileHandRs_Rmk']."', '".$_POST['GPSSet']."', '".$_POST['HealthInsu']."', '".$_POST['Term_Insurance']."', '".$_POST['HelthChekUp']."', '".$_POST['HelthChekUp_Amt']."', '".$_POST['HelthChekUp_Rmk']."', '".$_POST['Car2Policy']."', '".$_POST['VehicleCost']."', '".$_POST['With2Driver']."', '".$_POST['Advance2Com']."', '".date("Y-m-d",strtotime($DateOfEPolicy))."', '".$_POST['LessKm']."', '".$_POST['Plan']."', 'As per Law', 'As per Law', '".$_POST['Rmkk']."', 'A', ".$_POST['U'].", '".date("Y-m-d",strtotime($_POST['CHDate']))."', '".date("Y-m-d")."', ".$_POST['Y'].")", $con);

 }
  if($SqlInsElig) 
  {
    echo "Employee Eligibility updated Successfully.....";  
    echo '<input type="hidden" id="ActLogA" name="ActLogA" value="1" />';
  }
  else{ echo '<input type="hidden" id="ActLogA" name="ActLogA" value="0" />'; }
...
elseif(isset($_POST['LodginggCCatA22']) && $_POST['LodginggCCatA22']!="")
{ 
 $sqlCode=mysql_query("select EmpCode from hrm_employee where EmployeeID=".$_POST['E'], $con); 
 $resCode=mysql_fetch_assoc($sqlCode);
 ...
 { 
   ...
   $SqlInsElig = mysql_query("UPDATE hrm_employee_eligibility SET EC='".$resCode['EmpCode']."', Lodging_CategoryA='".$_POST['LodginggCCatA22']."', Lodging_CategoryB='".$_POST['LodgingCatB']."', Lodging_CategoryC='".$_POST['LodgingCatC']."', DA_Outside_Hq='".$_POST['DaOutSide_HQRs']."', DA_Outside_Hq_Rmk='".$_POST['DaOutSide_HQRs_Rmk']."', DA_Inside_Hq='".$_POST['DaInSide_HQRs']."', DA_Inside_Hq_Rmk='".$_POST['DaInSide_HQRs_Rmk']."', ExHQ='".$_POST['ExHQ']."', ExHQ_Rmk='".$_POST['ExHQ_Rmk']."', Travel_TwoWeeKM='".$_POST['TwoWheelerKM']."', Travel_TwoWeeKM_Rmk='".$_POST['TwoWheelerKM_Rmk']."', Travel_FourWeeKM='".$_POST['FourWheelerKM']."', Travel_FourWeeKM_Rmk='".$_POST['FourWheelerKM_Rmk']."', VehiclePolicy='".$_POST['VehiclePolicy']."', Flight_Allow='".$_POST['Flight_YN']."', Flight_Class='".$_POST['Flight_Class']."', Flight_Rmk='".$_POST['Flight_Class_Rmk']."', Train_Allow='".$_POST['Train_YN']."', Train_Class='".$_POST['Train_Class']."', Train_Rmk='".$_POST['Train_Class_Rmk']."', Mobile_Exp_Rem='".$Mobile_Remb."', Mobile_Exp_Rem_Rs='".$_POST['Mobile_Remb']."', Prd='".$_POST['Mobile_Remb_Period']."', Mobile_Exp_Rem_Rmk='".$_POST['Mobile_Remb_Period_Rmk']."', Mobile_Exp_RemPost_Rs='".$_POST['Mobile_RembPost']."', PrdPost='".$_POST['Mobile_RembPost_Period']."', Mobile_Exp_RemPost_Rmk='".$_POST['Mobile_RembPost_Period_Rmk']."', Mobile_Hand_Elig='".$MobileHandRs."', Mobile_Hand_Elig_Rs='".$_POST['MobileHandRs']."', Mobile_Hand_Elig_Rmk='".$_POST['MobileHandRs_Rmk']."', GPSSet='".$_POST['GPSSet']."', Health_Insurance='".$_POST['HealthInsu']."', Term_Insurance='".$_POST['Term_Insurance']."', HelthCheck='".$_POST['HelthChekUp']."', HelthCheck_Amt='".$_POST['HelthChekUp_Amt']."', HelthCheck_Rmk='".$_POST['HelthChekUp_Rmk']."', FourWElig='".$_POST['Car2Policy']."', CostOfVehicle='".$_POST['VehicleCost']."', WithDriver='".$_POST['With2Driver']."', AdvanceCom='".$_POST['Advance2Com']."', DateOfEntryPolicy='".date("Y-m-d",strtotime($DateOfEPolicy))."', EligCreatedBy=".$_POST['U'].", EligCreatedDate='".date("Y-m-d",strtotime($_POST['CHDate']))."', EligYearId=".$_POST['Y'].", LessKm='".$_POST['LessKm']."', Plan='".$_POST['Plan']."', Bonus='As per Law', Gratuity='As per Law', Remark='".$_POST['Rmkk']."',  SysDate='".date("Y-m-d")."' WHERE EmployeeId=".$_POST['E']." AND EligCreatedDate='".date("Y-m-d",strtotime($_POST['CHDate']))."' AND Status='A'", $con);
   
 }
 if($rowElig==0)
 { 
   $sqlU= mysql_query("UPDATE hrm_employee_eligibility SET Status='D' where EmployeeID=".$_POST['E']." AND Status='A'",$con);
   $SqlInsElig = mysql_query("insert into hrm_employee_eligibility(EmployeeId, EC, Lodging_CategoryA, Lodging_CategoryB, Lodging_CategoryC, DA_Outside_Hq, DA_Outside_Hq_Rmk, DA_Inside_Hq, DA_Inside_Hq_Rmk, ExHQ, ExHQ_Rmk, Travel_TwoWeeKM, Travel_TwoWeeKM_Rmk, Travel_FourWeeKM, Travel_FourWeeKM_Rmk, VehiclePolicy, Flight_Allow, Flight_Class, Flight_Rmk, Train_Allow, Train_Class, Train_Rmk, Mobile_Exp_Rem, Mobile_Exp_Rem_Rs, Prd, Mobile_Exp_Rem_Rmk, Mobile_Exp_RemPost_Rs, PrdPost, Mobile_Exp_RemPost_Rmk, Mobile_Hand_Elig, Mobile_Hand_Elig_Rs, Mobile_Hand_Elig_Rmk, GPSSet, Health_Insurance, Term_Insurance, HelthCheck, HelthCheck_Amt, HelthCheck_Rmk, FourWElig, CostOfVehicle, WithDriver, AdvanceCom, DateOfEntryPolicy, LessKm, Plan, Bonus, Gratuity, Remark, Status, EligCreatedBy, EligCreatedDate, SysDate, EligYearId) values(".$_POST['E'].", '".$resCode['EmpCode']."', '".$_POST['LodginggCCatA22']."', '".$_POST['LodgingCatB']."', '".$_POST['LodgingCatC']."', '".$_POST['DaOutSide_HQRs']."', '".$_POST['DaOutSide_HQRs_Rmk']."', '".$_POST['DaInSide_HQRs']."', '".$_POST['DaInSide_HQRs_Rmk']."', '".$_POST['ExHQ']."', '".$_POST['ExHQ_Rmk']."', '".$_POST['TwoWheelerKM']."', '".$_POST['TwoWheelerKM_Rmk']."', '".$_POST['FourWheelerKM']."', '".$_POST['FourWheelerKM_Rmk']."', '".$_POST['VehiclePolicy']."', '".$_POST['Flight_YN']."', '".$_POST['Flight_Class']."', '".$_POST['Flight_Class_Rmk']."', '".$_POST['Train_YN']."', '".$_POST['Train_Class']."', '".$_POST['Train_Class_Rmk']."', '".$Mobile_Remb."', '".$_POST['Mobile_Remb']."', '".$_POST['Mobile_Remb_Period']."', '".$_POST['Mobile_Remb_Period_Rmk']."', '".$_POST['Mobile_RembPost']."', '".$_POST['Mobile_RembPost_Period']."', '".$_POST['Mobile_RembPost_Period_Rmk']."', '".$MobileHandRs."', '".$_POST['MobileHandRs']."', '".$_POST['MobileHandRs_Rmk']."', '".$_POST['GPSSet']."', '".$_POST['HealthInsu']."', '".$_POST['Term_Insurance']."', '".$_POST['HelthChekUp']."', '".$_POST['HelthChekUp_Amt']."', '".$_POST['HelthChekUp_Rmk']."', '".$_POST['Car2Policy']."', '".$_POST['VehicleCost']."', '".$_POST['With2Driver']."', '".$_POST['Advance2Com']."', '".date("Y-m-d",strtotime($DateOfEPolicy))."', '".$_POST['LessKm']."', '".$_POST['Plan']."', 'As per Law', 'As per Law', '".$_POST['Rmkk']."', 'A', ".$_POST['U'].", '".date("Y-m-d",strtotime($_POST['CHDate']))."', '".date("Y-m-d")."', ".$_POST['Y'].")", $con);
