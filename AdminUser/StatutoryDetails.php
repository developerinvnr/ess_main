   ...
   <table border="0">
	...
	<tr>
	  ...
	  <td align="left"><table border="0">
		...
		<tr><td class="td1" style="font-size:11px;"> Mediclaim Policy Premium(With ESIC): </td>

			<td style="font-size:11px; width:150px;"><input name="MPP_ESIC" id="MPP_ESIC" style="font-size:11px; width:90px; height:18px;" value="<?php echo $ResultTaxSaving['MedicalPolicyPremium_ESIC']; ?>" disabled/>
