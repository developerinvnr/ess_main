...
while($rE=mysql_fetch_assoc($sE))
{
 ...
 $sQ1=mysql_query("select VariablePay,CtcCreatedDate from hrm_employee_ctc where EmployeeID=".$rE['EmployeeID']." AND CtcCreatedDate<='2023-12-31' order by CtcCreatedDate DESC limit 0,1",$con); $rQ1=mysql_fetch_assoc($sQ1);
...
if($_REQUEST['d']>0)
{
 ...
 //echo "select ".$Selstar." from ".$PayTable1." mp INNER JOIN hrm_employee e ON mp.EmployeeID=e.EmployeeID INNER JOIN hrm_employee_general g ON mp.EmployeeID=g.EmployeeID where g.DepartmentId=".$_REQUEST['d']." AND e.CompanyId=".$CompanyId." AND ".$con4." AND Month=4 AND Year=".$FD;
     
 $sql4=mysql_query("select ".$Selstar." from ".$PayTable1." mp INNER JOIN hrm_employee e ON mp.EmployeeID=e.EmployeeID INNER JOIN hrm_employee_general g ON mp.EmployeeID=g.EmployeeID where g.DepartmentId=".$_REQUEST['d']." AND e.CompanyId=".$CompanyId." AND ".$con4." AND Month=4 AND Year=".$FD, $con); 
 $sql5=mysql_query("select ".$Selstar." from ".$PayTable1." mp INNER JOIN hrm_employee e ON mp.EmployeeID=e.EmployeeID INNER JOIN hrm_employee_general g ON mp.EmployeeID=g.EmployeeID where g.DepartmentId=".$_REQUEST['d']." AND e.CompanyId=".$CompanyId." AND ".$con5." AND Month=5 AND Year=".$FD, $con); 
 $sql6=mysql_query("select ".$Selstar." from ".$PayTable1." mp INNER JOIN hrm_employee e ON mp.EmployeeID=e.EmployeeID INNER JOIN hrm_employee_general g ON mp.EmployeeID=g.EmployeeID where g.DepartmentId=".$_REQUEST['d']." AND e.CompanyId=".$CompanyId." AND ".$con6." AND Month=6 AND Year=".$FD, $con); 
 $sql7=mysql_query("select ".$Selstar." from ".$PayTable1." mp INNER JOIN hrm_employee e ON mp.EmployeeID=e.EmployeeID INNER JOIN hrm_employee_general g ON mp.EmployeeID=g.EmployeeID where g.DepartmentId=".$_REQUEST['d']." AND e.CompanyId=".$CompanyId." AND ".$con7." AND Month=7 AND Year=".$FD, $con); 
 $sql8=mysql_query("select ".$Selstar." from ".$PayTable1." mp INNER JOIN hrm_employee e ON mp.EmployeeID=e.EmployeeID INNER JOIN hrm_employee_general g ON mp.EmployeeID=g.EmployeeID where g.DepartmentId=".$_REQUEST['d']." AND e.CompanyId=".$CompanyId." AND ".$con8." AND Month=8 AND Year=".$FD, $con); 
 $sql9=mysql_query("select ".$Selstar." from ".$PayTable1." mp INNER JOIN hrm_employee e ON mp.EmployeeID=e.EmployeeID INNER JOIN hrm_employee_general g ON mp.EmployeeID=g.EmployeeID where g.DepartmentId=".$_REQUEST['d']." AND e.CompanyId=".$CompanyId." AND ".$con9." AND Month=9 AND Year=".$FD, $con); 
 $sql10=mysql_query("select ".$Selstar." from ".$PayTable1." mp INNER JOIN hrm_employee e ON mp.EmployeeID=e.EmployeeID INNER JOIN hrm_employee_general g ON mp.EmployeeID=g.EmployeeID where g.DepartmentId=".$_REQUEST['d']." AND e.CompanyId=".$CompanyId." AND ".$con10." AND Month=10 AND Year=".$FD, $con); 
 $sql11=mysql_query("select ".$Selstar." from ".$PayTable1." mp INNER JOIN hrm_employee e ON mp.EmployeeID=e.EmployeeID INNER JOIN hrm_employee_general g ON mp.EmployeeID=g.EmployeeID where g.DepartmentId=".$_REQUEST['d']." AND e.CompanyId=".$CompanyId." AND ".$con11." AND Month=11 AND Year=".$FD, $con); 
 $sql12=mysql_query("select ".$Selstar." from ".$PayTable1." mp INNER JOIN hrm_employee e ON mp.EmployeeID=e.EmployeeID INNER JOIN hrm_employee_general g ON mp.EmployeeID=g.EmployeeID where g.DepartmentId=".$_REQUEST['d']." AND e.CompanyId=".$CompanyId." AND ".$con12." AND Month=12 AND Year=".$FD, $con); 
 $sql1=mysql_query("select ".$Selstar." from ".$PayTable2." mp INNER JOIN hrm_employee e ON mp.EmployeeID=e.EmployeeID INNER JOIN hrm_employee_general g ON mp.EmployeeID=g.EmployeeID where g.DepartmentId=".$_REQUEST['d']." AND e.CompanyId=".$CompanyId." AND ".$con1." AND Month=1 AND Year=".$TD, $con); 
 $sql2=mysql_query("select ".$Selstar." from ".$PayTable2." mp INNER JOIN hrm_employee e ON mp.EmployeeID=e.EmployeeID INNER JOIN hrm_employee_general g ON mp.EmployeeID=g.EmployeeID where g.DepartmentId=".$_REQUEST['d']." AND e.CompanyId=".$CompanyId." AND ".$con2." AND Month=2 AND Year=".$TD, $con); 
 $sql3=mysql_query("select ".$Selstar." from ".$PayTable2." mp INNER JOIN hrm_employee e ON mp.EmployeeID=e.EmployeeID INNER JOIN hrm_employee_general g ON mp.EmployeeID=g.EmployeeID where g.DepartmentId=".$_REQUEST['d']." AND e.CompanyId=".$CompanyId." AND ".$con3." AND Month=3 AND Year=".$TD, $con); 
} 
elseif($_REQUEST['d']==0)
{
 $sql4=mysql_query("select ".$Selstar." from ".$PayTable1." mp INNER JOIN hrm_employee e ON mp.EmployeeID=e.EmployeeID where e.CompanyId=".$CompanyId." AND ".$con4." AND Month=4 AND Year=".$FD, $con); 
 $sql5=mysql_query("select ".$Selstar." from ".$PayTable1." mp INNER JOIN hrm_employee e ON mp.EmployeeID=e.EmployeeID where e.CompanyId=".$CompanyId." AND ".$con5." AND Month=5 AND Year=".$FD, $con); 
 $sql6=mysql_query("select ".$Selstar." from ".$PayTable1." mp INNER JOIN hrm_employee e ON mp.EmployeeID=e.EmployeeID where e.CompanyId=".$CompanyId." AND ".$con6." AND Month=6 AND Year=".$FD, $con); 
 $sql7=mysql_query("select ".$Selstar." from ".$PayTable1." mp INNER JOIN hrm_employee e ON mp.EmployeeID=e.EmployeeID where e.CompanyId=".$CompanyId." AND ".$con7." AND Month=7 AND Year=".$FD, $con); 
 $sql8=mysql_query("select ".$Selstar." from ".$PayTable1." mp INNER JOIN hrm_employee e ON mp.EmployeeID=e.EmployeeID where e.CompanyId=".$CompanyId." AND ".$con8." AND Month=8 AND Year=".$FD, $con); 
 $sql9=mysql_query("select ".$Selstar." from ".$PayTable1." mp INNER JOIN hrm_employee e ON mp.EmployeeID=e.EmployeeID where e.CompanyId=".$CompanyId." AND ".$con9." AND Month=9 AND Year=".$FD, $con); 
 $sql10=mysql_query("select ".$Selstar." from ".$PayTable1." mp INNER JOIN hrm_employee e ON mp.EmployeeID=e.EmployeeID where e.CompanyId=".$CompanyId." AND ".$con10." AND Month=10 AND Year=".$FD, $con); 
 $sql11=mysql_query("select ".$Selstar." from ".$PayTable1." mp INNER JOIN hrm_employee e ON mp.EmployeeID=e.EmployeeID where e.CompanyId=".$CompanyId." AND ".$con11." AND Month=11 AND Year=".$FD, $con); 
 $sql12=mysql_query("select ".$Selstar." from ".$PayTable1." mp INNER JOIN hrm_employee e ON mp.EmployeeID=e.EmployeeID where e.CompanyId=".$CompanyId." AND ".$con12." AND Month=12 AND Year=".$FD, $con); 
 $sql1=mysql_query("select ".$Selstar." from ".$PayTable2." mp INNER JOIN hrm_employee e ON mp.EmployeeID=e.EmployeeID where e.CompanyId=".$CompanyId." AND ".$con1." AND Month=1 AND Year=".$TD, $con); 
 $sql2=mysql_query("select ".$Selstar." from ".$PayTable2." mp INNER JOIN hrm_employee e ON mp.EmployeeID=e.EmployeeID where e.CompanyId=".$CompanyId." AND ".$con2." AND Month=2 AND Year=".$TD, $con); 
 $sql3=mysql_query("select ".$Selstar." from ".$PayTable2." mp INNER JOIN hrm_employee e ON mp.EmployeeID=e.EmployeeID where e.CompanyId=".$CompanyId." AND ".$con3." AND Month=3 AND Year=".$TD, $con); 
}
...
<?php /**** PP Yearly ****/ ?>
<tr id="TR<?php echo '40'; ?>">
   <td align="center" style="width:50px;"><input type="checkbox" id="Chk<?php echo '40'; ?>" onClick="FucChk(<?php echo '40'; ?>)" /></td> 
   <td align="center" style="width:50px;" class="font1">&nbsp;<?php echo '10'; ?>&nbsp;</td>
   <td class="font1">&nbsp;<?php echo 'PP - Yearly'; ?></td>
   <td class="font1r"><?php echo number_format(floatval($res4['PPy'])); ?>&nbsp;</td>
   <td class="font1r"><?php echo number_format(floatval($res5['PPy'])); ?>&nbsp;</td>
   <td class="font1r"><?php echo number_format(floatval($res6['PPy'])); ?>&nbsp;</td>
   <td class="font1r"><?php echo number_format(floatval($res7['PPy'])); ?>&nbsp;</td>
   <td class="font1r"><?php echo number_format(floatval($res8['PPy'])); ?>&nbsp;</td>
   <td class="font1r"><?php echo number_format(floatval($res9['PPy'])); ?>&nbsp;</td>
   <td class="font1r"><?php echo number_format(floatval($res10['PPy'])); ?>&nbsp;</td>
   <td class="font1r"><?php echo number_format(floatval($res11['PPy'])); ?>&nbsp;</td>
   <td class="font1r"><?php echo number_format(floatval($res12['PPy'])); ?>&nbsp;</td>
   <td class="font1r"><?php echo number_format(floatval($res1['PPy'])); ?>&nbsp;</td>
   <td class="font1r"><?php echo number_format(floatval($res2['PPy'])); ?>&nbsp;</td>
   <td class="font1r"><?php echo number_format(floatval($res3['PPy'])); ?>&nbsp;</td>
<?php $TotPPy=$res4['PPy']+$res5['PPy']+$res6['PPy']+$res7['PPy']+$res8['PPy']+$res9['PPy']+$res10['PPy']+$res11['PPy']+$res12['PPy']+$res1['PPy']+$res2['PPy']+$res3['PPy']; ?>  
   <td align="right" class="font1" bgcolor="#97CBFF" style="font-size:12px;font-weight:bold;"><?php echo number_format($TotPPy); ?>&nbsp;</td> 
</tr>
...
<?php /**** National Pension Scheme , SUM(NPS) as NPS****/ ?>
<tr id="TR<?php echo '36'; ?>">
   <td align="center" style="width:50px;"><input type="checkbox" id="Chk<?php echo '36'; ?>" onClick="FucChk(<?php echo '36'; ?>)" /></td> 
   <td align="center" style="width:50px;" class="font1">&nbsp;<?php echo '36'; ?>&nbsp;</td>
   <td class="font1">&nbsp;<?php echo 'NATIONAL PENSION SCHEME'; ?></td>
   <td class="font1r"><?php echo number_format(floatval($res4['NPS'])); ?>&nbsp;</td>
   <td class="font1r"><?php echo number_format(floatval($res5['NPS'])); ?>&nbsp;</td>
   <td class="font1r"><?php echo number_format(floatval($res6['NPS'])); ?>&nbsp;</td>
   <td class="font1r"><?php echo number_format(floatval($res7['NPS'])); ?>&nbsp;</td>
   <td class="font1r"><?php echo number_format(floatval($res8['NPS'])); ?>&nbsp;</td>
   <td class="font1r"><?php echo number_format(floatval($res9['NPS'])); ?>&nbsp;</td>
   <td class="font1r"><?php echo number_format(floatval($res10['NPS'])); ?>&nbsp;</td>
   <td class="font1r"><?php echo number_format(floatval($res11['NPS'])); ?>&nbsp;</td>
   <td class="font1r"><?php echo number_format(floatval($res12['NPS'])); ?>&nbsp;</td>
   <td class="font1r"><?php echo number_format(floatval($res1['NPS'])); ?>&nbsp;</td>
   <td class="font1r"><?php echo number_format(floatval($res2['NPS'])); ?>&nbsp;</td>
   <td class="font1r"><?php echo number_format(floatval($res3['NPS'])); ?>&nbsp;</td>
<?php $TotNPSS=$res4['NPS']+$res5['NPS']+$res6['NPS']+$res7['NPS']+$res8['NPS']+$res9['NPS']+$res10['NPS']+$res11['NPS']+$res12['NPS']+$res1['NPS']+$res2['NPS']+$res3['NPS']; ?>  
   <td align="right" class="font1" bgcolor="#97CBFF" style="font-size:12px;font-weight:bold;"><?php echo number_format($TotNPSS); ?>&nbsp;</td> </tr>
...
<?php /**** Recovery For Special Allow****/ ?>
<tr id="TR<?php echo '38'; ?>">
   ...
   <td align="center" style="width:50px;" class="font1">&nbsp;<?php echo '36'; ?>&nbsp;</td>
   <td class="font1">&nbsp;<?php echo 'RECOVERY FOR SPECIAL ALLOW'; ?></td>
   <td class="font1r"><?php echo number_format(floatval($res4['RecSplAllow'])); ?>&nbsp;</td>
   <td class="font1r"><?php echo number_format(floatval($res5['RecSplAllow'])); ?>&nbsp;</td>
   <td class="font1r"><?php echo number_format(floatval($res6['RecSplAllow'])); ?>&nbsp;</td>
   <td class="font1r"><?php echo number_format(floatval($res7['RecSplAllow'])); ?>&nbsp;</td>
   <td class="font1r"><?php echo number_format(floatval($res8['RecSplAllow'])); ?>&nbsp;</td>
   <td class="font1r"><?php echo number_format(floatval($res9['RecSplAllow'])); ?>&nbsp;</td>
   <td class="font1r"><?php echo number_format(floatval($res10['RecSplAllow'])); ?>&nbsp;</td>
   <td class="font1r"><?php echo number_format(floatval($res11['RecSplAllow'])); ?>&nbsp;</td>
   <td class="font1r"><?php echo number_format(floatval($res12['RecSplAllow'])); ?>&nbsp;</td>
   <td class="font1r"><?php echo number_format(floatval($res1['RecSplAllow'])); ?>&nbsp;</td>
   <td class="font1r"><?php echo number_format(floatval($res2['RecSplAllow'])); ?>&nbsp;</td>
   <td class="font1r"><?php echo number_format(floatval($res3['RecSplAllow'])); ?>&nbsp;</td>
