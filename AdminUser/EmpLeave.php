...
$SqlLWP=mysql_query("select count(DISTINCT AttDate)as LWP from ".$tab1." where AttValue='LWP' AND ".$Cond1, $con); $ResLWP=mysql_fetch_array($SqlLWP); $TotalLWP = $ResLWP['LWP'];
...
$SqlLWP=mysql_query("select count(DISTINCT AttDate)as LWP from ".$tab1." where AttValue='LWP' AND ".$Cond1, $con); $ResLWP=mysql_fetch_array($SqlLWP); 
...
$Sql2LWP=mysql_query("select count(DISTINCT AttDate)as LWP from ".$tab2." where AttValue='LWP' AND ".$Cond2, $con); $Res2LWP=mysql_fetch_array($Sql2LWP); $TotalLWP = $ResLWP['LWP']+$Res2LWP['LWP'];
...
/*$SqlCL=mysql_query("select count(DISTINCT AttDate)as CL from ".$AttTable." where AttValue='CL' AND EmployeeID=".$EMPID." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-".$day)."')", $con); $SqlCH=mysql_query("select count(DISTINCT AttDate)as CH from ".$AttTable." where AttValue='CH' AND EmployeeID=".$EMPID." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-".$day)."')", $con); $SqlSL=mysql_query("select count(DISTINCT AttDate)as SL from ".$AttTable." where AttValue='SL' AND EmployeeID=".$EMPID." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-".$day)."')", $con); $SqlSH=mysql_query("select count(DISTINCT AttDate)as SH from ".$AttTable." where AttValue='SH' AND EmployeeID=".$EMPID." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-".$day)."')", $con); $SqlPL=mysql_query("select count(DISTINCT AttDate)as PL from ".$AttTable." where AttValue='PL' AND EmployeeID=".$EMPID." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-".$day)."')", $con); $SqlPH=mysql_query("select count(DISTINCT AttDate)as PH from ".$AttTable." where AttValue='PH' AND EmployeeID=".$EMPID." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-".$day)."')", $con); $SqlEL=mysql_query("select count(DISTINCT AttDate)as EL from ".$AttTable." where AttValue='EL' AND EmployeeID=".$EMPID." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-".$day)."')", $con); $SqlML=mysql_query("select count(DISTINCT AttDate)as ML from ".$AttTable." where AttValue='ML' AND EmployeeID=".$EMPID." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-".$day)."')", $con); $SqlFL=mysql_query("select count(DISTINCT AttDate)as FL from ".$AttTable." where AttValue='FL' AND EmployeeID=".$EMPID." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-".$day)."')", $con); $SqlTL=mysql_query("select count(DISTINCT AttDate)as TL from ".$AttTable." where AttValue='TL' AND EmployeeID=".$EMPID." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-".$day)."')", $con); $SqlHf=mysql_query("select count(DISTINCT AttDate)as Hf from ".$AttTable." where AttValue='HF' AND EmployeeID=".$EMPID." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-".$day)."')", $con); $SqlPresent=mysql_query("select count(DISTINCT AttDate)as Present from ".$AttTable." where (AttValue='P' OR AttValue='WFH') AND EmployeeID=".$EMPID." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-".$day)."')", $con); $SqlAbsent=mysql_query("select count(DISTINCT AttDate)as Absent from ".$AttTable." where AttValue='A' AND EmployeeID=".$EMPID." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-".$day)."')", $con); $SqlOnDuties=mysql_query("select count(DISTINCT AttDate)as OnDuties from ".$AttTable." where AttValue='OD' AND EmployeeID=".$EMPID." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-".$day)."')", $con); $SqlHoliday=mysql_query("select count(DISTINCT AttDate)as Holiday from ".$AttTable." where AttValue='HO' AND EmployeeID=".$EMPID." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-".$day)."')", $con); $SqlELSun=mysql_query("select count(CheckSunday)as SUN from ".$AttTable." where CheckSunday='Y' AND EmployeeID=".$EMPID." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-".$day)."')", $con); 
   ...
   $TotalWorkingDay=26;*/
    ...
    /******************** hrm_employee_monthlyleave_balance open**************************/
	  ...
	  $sUpL=mysql_query("UPDATE hrm_employee_monthlyleave_balance set AvailedCL='".$TotalCL."', AvailedSL='".$TotalSL."', AvailedPL='".$TotalPL."', AvailedEL='".$TotalEL."', AvailedML='".$TotalML."', AvailedOL='".$TotalFL."', AvailedTL='".$TotalTL."', BalanceCL='".$TotBalCL."', BalanceSL='".$TotBalSL."', BalancePL='".$TotBalPL."', BalanceEL='".$TotBalEL."', BalanceML='".$TotBalML."', BalanceOL='".$TotBalFL."', MonthAtt_TotLeave='".$TotalLeaveCount."', MonthAtt_TotOD='".$TotalOnDuties."', MonthAtt_TotHO='".$TotalHoliday."', MonthAtt_TotPR='".$TotalPR."', MonthAtt_TotAP='".$TotalAbsent."', MonthAtt_TotLWP='".$TotalLWP."', MonthAtt_TotWorkDay='".$TotalWorkingDay."', MonthAtt_TotPaidDay='".$TotalPaidDay."' where EmployeeID=".$EMPID." AND Month='".$m."' AND Year='".$_REQUEST['y']."'", $con); }
   ...
   {  
	  ...
	  */
	  ...
	  $SqlLumSum=mysql_query("select hrm_company_statutory_lumpsum.*,hrm_company_statutory_taxsaving.*,hrm_company_statutory_pf.* from hrm_company_statutory_lumpsum INNER JOIN hrm_company_statutory_taxsaving ON hrm_company_statutory_lumpsum.CompanyId=hrm_company_statutory_taxsaving.CompanyId INNER JOIN hrm_company_statutory_pf ON hrm_company_statutory_lumpsum.CompanyId=hrm_company_statutory_pf.CompanyId where hrm_company_statutory_lumpsum.CompanyId=".$CompanyId, $con); $ResLumSum=mysql_fetch_assoc($SqlLumSum);
	   ...
	   $Absent=$resME['MonthAtt_TotAP']+$resME['MonthAtt_TotLWP'];
	   ...
	   if($resCTC['NPS_Value']>0) {$OneDay_nps=$resCTC['NPS_Value']/$WorkDay; $NPS=round($OneDay_nps*$PaidDay);} else {$NPS=0;}
...
{ 
 ...
 $fd=date("Y",strtotime($_SESSION['fromdate'])); $td=date("Y",strtotime($_SESSION['todate'])); $PRD=$fd.'-'.$td;   
 for($i=1; $i<=31; $i++)
 { $sAtt=mysql_query("select AttValue from hrm_employee_attendance_2024 where EmployeeID=".$id." AND AttDate='".date($Y.'-'.$m.'-'.$i)."'", $con); $rowAtt=mysql_num_rows($sAtt); 
  if($rowAtt>0)
  { 
 ...
 /***************************************/
 /***************************************/
 $SqlCL=mysql_query("select count(DISTINCT AttDate)as CL from hrm_employee_attendance_2024 where AttValue='CL' AND EmployeeID=".$id." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-31")."')", $con); 
 $SqlCH=mysql_query("select count(DISTINCT AttDate)as CH from hrm_employee_attendance_2024 where AttValue='CH' AND EmployeeID=".$id." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-31")."')", $con); 
 $SqlSL=mysql_query("select count(DISTINCT AttDate)as SL from hrm_employee_attendance_2024 where AttValue='SL' AND EmployeeID=".$id." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-31")."')", $con); 
 $SqlSH=mysql_query("select count(DISTINCT AttDate)as SH from hrm_employee_attendance_2024 where AttValue='SH' AND EmployeeID=".$id." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-31")."')", $con); 
 $SqlPH=mysql_query("select count(DISTINCT AttDate)as PH from hrm_employee_attendance_2024 where AttValue='PH' AND EmployeeID=".$id." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-31")."')", $con); 
 $SqlPL=mysql_query("select count(DISTINCT AttDate)as PL from hrm_employee_attendance_2024 where AttValue='PL' AND EmployeeID=".$id." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-31")."')", $con); 
 $SqlEL=mysql_query("select count(DISTINCT AttDate)as EL from hrm_employee_attendance_2024 where AttValue='EL' AND EmployeeID=".$id." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-31")."')", $con); 
 $SqlHf=mysql_query("select count(DISTINCT AttDate)as Hf from hrm_employee_attendance_2024 where AttValue='HF' AND EmployeeID=".$id." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-31")."')", $con); 
 
 $SqlAch=mysql_query("select count(DISTINCT AttDate)as ACH from hrm_employee_attendance_2024 where AttValue='ACH' AND EmployeeID=".$id." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-31")."')", $con);
 $SqlAsh=mysql_query("select count(DISTINCT AttDate)as ASH from hrm_employee_attendance_2024 where AttValue='ASH' AND EmployeeID=".$id." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-31")."')", $con);
 $SqlAph=mysql_query("select count(DISTINCT AttDate)as APH from hrm_employee_attendance_2024 where AttValue='APH' AND EmployeeID=".$id." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-31")."')", $con);
 
 $SqlPresent=mysql_query("select count(DISTINCT AttDate)as Present from hrm_employee_attendance_2024 where (AttValue='P' OR AttValue='WFH') AND EmployeeID=".$id." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-31")."')", $con); 
 $SqlAbsent=mysql_query("select count(DISTINCT AttDate)as Absent from hrm_employee_attendance_2024 where AttValue='A' AND EmployeeID=".$id." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-31")."')", $con); 
 $SqlOnDuties=mysql_query("select count(DISTINCT AttDate)as OnDuties from hrm_employee_attendance_2024 where AttValue='OD' AND EmployeeID=".$id." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-31")."')", $con); 
 $SqlHoliday=mysql_query("select count(DISTINCT AttDate)as Holiday from hrm_employee_attendance_2024 where AttValue='HO' AND EmployeeID=".$id." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-31")."')", $con); 
 $SqlELSun=mysql_query("select count(CheckSunday)as SUN from hrm_employee_attendance_2024 where CheckSunday='Y' AND EmployeeID=".$id." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-31")."')", $con); 
 $SqlFL=mysql_query("select count(DISTINCT AttDate)as FL from hrm_employee_attendance_2024 where AttValue='FL' AND EmployeeID=".$id." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-31")."')", $con); 
 $SqlTL=mysql_query("select count(DISTINCT AttDate)as TL from hrm_employee_attendance_2024 where AttValue='TL' AND EmployeeID=".$id." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-31")."')", $con); 
 $SqlML=mysql_query("select count(DISTINCT AttDate)as ML from hrm_employee_attendance_2024 where AttValue='ML' AND EmployeeID=".$id." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-31")."')", $con);
 
 $SqlLWP=mysql_query("select count(DISTINCT AttDate)as LWP from hrm_employee_attendance_2024 where AttValue='LWP' AND AND EmployeeID=".$id." AND (AttDate between '".date($Y."-".$m."-1")."' AND '".date($Y."-".$m."-31")."')", $con); $ResLWP=mysql_fetch_array($SqlLWP); 
 $TotalLWP = $ResLWP['LWP'];
...
/********************************************** Open 1 ***********/
   ...
   $sUpL=mysql_query("UPDATE hrm_employee_monthlyleave_balance set AvailedCL='".$TotalCL."', AvailedSL='".$TotalSL."', AvailedPL='".$TotalPL."', AvailedEL='".$TotalEL."', AvailedML='".$TotalML."', AvailedOL='".$TotalFL."', AvailedTL='".$TotalTL."', BalanceCL='".$TotBalCL."', BalanceSL='".$TotBalSL."', BalancePL='".$TotBalPL."', BalanceEL='".$TotBalEL."', BalanceML='".$TotBalML."', BalanceOL='".$TotBalFL."', MonthAtt_TotLeave='".$TotalLeaveCount."', MonthAtt_TotOD='".$TotalOnDuties."', MonthAtt_TotHO='".$TotalHoliday."', MonthAtt_TotPR='".$TotalPR."', MonthAtt_TotAP='".$TotalAbsent."', MonthAtt_TotWorkDay='".$TotalWorkingDay."', MonthAtt_TotLWP='".$TotalLWP."', MonthAtt_TotPaidDay='".$TotalPaidDay."' where EmployeeID=".$id." AND Month='".$m."' AND Year='".$Y."'", $con); 
   }
 /***************************************/
 /***************************************/
...
<?php for($i=1; $i<=$day; $i++) { ?> 
    ...
    <td class="cellOpe" align="center" width="48" style="background-color:#7a6189;">LWP</td>
...
<input type="hidden" id="Tot_LWP<?php echo $EMPID; ?>" value="<?php echo $TotalLWP; ?>">
  ...
  <td class="cellOpe2" align="center" style="background-color:#FAD6CF;" width="48" valign="top"><?php echo $TotalLWP; ?></td>
...
<?php } ?>
		 ...
		 <td><table><tr>
			...
			<td bgcolor="#FAD6CF" width="10">&nbsp;</td><td>:</td><td class="cell">Absent/ LWP</td><td width="50">&nbsp;</td>
