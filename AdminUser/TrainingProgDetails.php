...
<?php $sqlP=mysql_query("select EmpCode,Fname,Sname,Lname,department_name as DepartmentCode,DR,Married,Gender from hrm_company_training_participant INNER JOIN hrm_employee_general ON hrm_company_training_participant.EmployeeID=hrm_employee_general.EmployeeID INNER JOIN hrm_employee_personal ON hrm_company_training_participant.EmployeeID=hrm_employee_personal.EmployeeID INNER JOIN hrm_employee ON hrm_company_training_participant.EmployeeID=hrm_employee.EmployeeID LEFT JOIN core_departments ON hrm_employee_general.DepartmentId=core_departments.id where hrm_company_training_participant.TrainingId=".$_REQUEST['id'], $con); 
