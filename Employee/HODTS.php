...
<input type="hidden" id="EmpKraRow" name="EmpKraRow" value="<?php echo $KRowNo; ?>" />
 ...
 <input id="ReviewerFormAScore" class="h" style="background-color:#9BCDFF;width:60px;" value="<?php echo $resApp['ReviewerFormAScore']; ?>" <?php if($resApp['Reviewer_PmsStatus']==2) { echo 'readonly'; } ?> onKeyUp="RevEnterFormA()" onChange="RevEnterFormA()" maxlength="5"/></td>
 </tr> 
 </table>
 </td>
 </tr> 
...
<?php $SnoB++;} $FormBRowNo=$SnoB-1;?>
  ...
  <td align="center" class="h"><input id="ReviewerFormBScore" class="h" style="background-color:#9BCDFF;width:80px;" value="<?php echo $resApp['ReviewerFormBScore']; ?>" <?php if($resApp['Reviewer_PmsStatus']==2) { echo 'readonly'; } ?> onKeyUp="RevEnterFormB()" onChange="RevEnterFormB()" maxlength="5"/>
</td>
</tr>
