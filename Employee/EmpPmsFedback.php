   ...
   <table border="0">
	...
	<tr bgcolor="#FFFFFF">
	 <td colspan="2" class="font1" align="left" style="width:100%; height:20px;" valign="top">
	  <input name="EnvReplyF<?php echo $SnoFY; ?>" id="EnvReplyF<?php echo $SnoFY; ?>" class="Input" readonly style="width:1050px;" maxlength="2000" value="<?php echo $resFY['Answer']; ?>" <?php  if($resY['Emp_FeedBackSave']=='Y' AND $resY['Emp_PmsStatus']==2) { echo 'readonly'; } ?>/></td>
	</tr>
   </table>
  </td>
 </tr>	  
...
<?php } if($resY['Emp_FeedBackSave']=='N'){ $sqlF=mysql_query("select * from hrm_pms_workenvironment where WorkEnStatus='A' AND companyid=".$CompanyId); $SnoF=1; while($resF=mysql_fetch_array($sqlF)) {?> 
 <tr>   
  ...
  <table border="0">
   ...
   <tr bgcolor="#FFFFFF">
	<td colspan="2" class="font" align="left" style="width:100%;" valign="top"><input name="EnvReplyF<?php echo $SnoF; ?>" id="EnvReplyF<?php echo $SnoF; ?>" class="Input" style="width:100%;" maxlength="2000" value=""/></td>
   </tr>
  </table>
  </td>
 </tr>
