...
<td valign="top" style="width:105px;color:#FFFFFF;background-color:#7a6189;"><?php if($resE['EsicNo']!=''){echo 'ESIC No';}?></td>
<td valign="top" style="width:240px;color:#000;"><?php if($resE['EsicNo']!=''){ echo $resE['EsicNo']; } ?></td>
</tr>
...
<?php
   if(file_exists('CovidCert/'.$resG['Covid_Vaccin_file']))
   { $file1='CovidCert/'.$resG['Covid_Vaccin_file']; }
   else{$file1='https://vnress.in/Employee/CovidCert/'.$resG['Covid_Vaccin_file']; }
  ?>    
<td align="center" id="Td_SBtn_1" style="vertical-align:middle;"><?php if($resG['Covid_Vaccin_file']!=''){echo '<a href='.$file1.' target="_blank">Uploaded</a>'; ?> 
...
<?php
   if(file_exists('CovidCert/'.$resG['Covid_Vaccin2_file']))
   { $file2='CovidCert/'.$resG['Covid_Vaccin2_file']; }
   else{$file2='https://vnress.in/Employee/CovidCert/'.$resG['Covid_Vaccin2_file']; }
  ?>
<td align="center" id="Td_S2Btn_1" style="vertical-align:middle;"><?php if($resG['Covid_Vaccin2_file']!=''){echo '<a href='.$file2.' target="_blank">Uploaded</a>'; ?> 
...
<?php
   if(file_exists('CovidCert/'.$resG['Covid_Vaccin3_file']))
   { $file3='CovidCert/'.$resG['Covid_Vaccin3_file']; }
   else{$file3='https://vnress.in/Employee/CovidCert/'.$resG['Covid_Vaccin3_file']; }
  ?>
<td align="center" id="Td_S2Btn_1" style="vertical-align:middle;"><?php if($resG['Covid_Vaccin3_file']!=''){echo '<a href='.$file3.' target="_blank">Uploaded</a>'; ?> 
