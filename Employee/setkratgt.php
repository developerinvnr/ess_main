...
{ //$Mnt_cal=12; $Qtr_cal=4; $Hlf_cal=2;
  ...
  elseif($DojM==07 OR $DojM==7){$Mnt_cal=6; $Qtr_cal=2; $Hlf_cal=2;}
  elseif($DojM==08 OR $DojM==8){$Mnt_cal=5; $Qtr_cal=2; $Hlf_cal=2;}
  elseif($DojM==09 OR $DojM==9){$Mnt_cal=4; $Qtr_cal=2; $Hlf_cal=2;}
...
{$LDate=date("Y-09-30");}
	 ...
	 ?>
	 <?php  
	 if($LDate=='2024-02-28'){ $Nxt10Day='2024-03-07'; }
	 else{  $Nxt10Day=date("Y-m-d",strtotime('+7 day', strtotime(date($LDate))));  }
