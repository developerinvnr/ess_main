...
<tr>
 ...
 <tr>
  <td style="width:75%;font-size:16px;">&nbsp;DA@HQ : <?=$ResEligEmp['DA_Inside_Hq_Rmk']?></td>
  <td style="width:25%;" align="center">&nbsp;<?=$ResEligEmp['DA_Inside_Hq']?></td>
 </tr>
 <?php } 
 if($ResEligEmp['DA_Outside_Hq']!='' AND $ResEligEmp['DA_Outside_Hq']!='NA' AND $ResEligEmp['DA_Outside_Hq']!=' '){ ?>
 <tr>
  <td style="width:75%;font-size:16px;">&nbsp;<?php if($ResE['DepartmentId']==2){echo 'Fooding Expense (For outside HQ travel with night halt)'; }else{ echo 'DA Outside@HQ '.$ResEligEmp['DA_Outside_Hq_Rmk']; } ?> : </td>
  <td style="width:25%;" align="center">&nbsp;<?=$ResEligEmp['DA_Outside_Hq']?></td>
 </tr>
 <?php } ?>
 </table>
 </td>
...
<tr>
 ...
 <?php if($ResEligEmp['Travel_FourWeeKM']!='' AND $ResEligEmp['Travel_FourWeeKM']!='NA' AND $ResEligEmp['Travel_FourWeeKM']!=' '){?>
  ...
  <td style="width:60%;" align="center">&nbsp;<?php if($ResEligEmp['VehiclePolicy']>0){ echo $ResEligEmp['Travel_FourWeeKM_Rmk']; }else{ echo 'Rs. '.$ResEligEmp['Travel_FourWeeKM'].'/Km '.$ResEligEmp['Travel_FourWeeKM_Rmk']; }?></td>
 </tr>
 <?php } ?>
...
<?php //Insurance Insurance Insurance Insurance Insurance Insurance Insurance Insurance ?>
<?php $sEG=mysql_query("select HR_GradeId,HR_CurrGradeId,CompanyId from hrm_employee_pms where EmpPmsId=".$PmsId,$con); $rEG=mysql_fetch_assoc($sEG); ?>
<?php if($ResCtc['ESCI']==0 OR $ResCtc['ESCI']=='' OR $_REQUEST['C']==1 OR $ResEligEmp['HelthCheck']=='Y'){ ?>
<tr>
...
<tr>
 ...
 if($_REQUEST['C']==1 AND $ResEligEmp['Term_Insurance']!=''){ ?>
 <tr>
...
<?php //Note Note Note Note Note Note Note Note Note Note Note Note ?>
 ...
 <tr><td colspan="2" style="width:680px;font-size:12px;height:16px;" align="left"><b>Note:</b></td></tr>
 <tr>
  <td colspan="2" style="width:680px;font-size:12px;height:16px;">
  <table>
  ...
  <tr>
   ...
   <td style="width:630px;font-size:12px;height:16px;" align="left">Four wheeler entitlements are applicable for personal vehicle or equivalent allowed amount (Rs. 22000/month) can be claimed for hired vehicle. Overall travel by four wheeler & two wheeler should not exceed by more than 3000 km/month.</td>
  </tr>
  ...
  <?php } ?>
  <tr>
   <td style="width:30px;font-size:12px;height:16px;" align="center" valign="top">[b]</td>
   <td style="width:630px;font-size:12px;height:16px;" align="left">The changed entitlements will be effective from the policy release date.<?php //echo '1st April '.date("Y");//$SeteD; ?>.</td>
  </tr>
  <tr>
   <td style="width:30px;font-size:12px;height:16px;" align="center" valign="top">[c]</td>
   <td style="width:630px;font-size:12px;height:16px;" align="left">The expense claims on 2 wheeler/4 wheeler is subject to the employee having a valid driving license. The photocopy should be provided to HR.</td>
  </tr>
  <?php } else { ?>
  <tr>
   <td style="width:30px;font-size:12px;height:16px;" align="center" valign="top">[a]</td>
  ...
  <tr>
   <td style="width:30px;font-size:12px;height:16px;" align="center" valign="top">[b]</td>
   <td style="width:630px;font-size:12px;height:16px;" align="left">The expenses claim on 2 wheeler/4 wheeler is subject to the employee having a valid driving license. The photocopy of which shall be provided to HR.</td>
  </tr>
  <?php } ?>  
  ...
  <tr>
   <td style="width:30px;font-size:12px;height:16px;" align="center" valign="top">[c]</td>
   <td style="width:630px;font-size:12px;height:16px;" align="left">The change in insurance coverage slab shall be effective from the next insurance policy renewal date.</td>
  </tr>	
  <tr>
   <td style="width:30px;font-size:12px;height:16px;" align="center" valign="top">[d]</td>
   <td style="width:630px;font-size:12px;height:16px;" align="left">For Further details on Policy, refer HR Manual in ESS.</td>
  </tr>	  
