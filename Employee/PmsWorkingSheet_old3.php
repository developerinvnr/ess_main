...
elseif($Dp=='All')
{
 if($Dp=='All' && $Gr>0){ $qry='p.HR_CurrGradeId='.$Gr; }
...
<tr id="TR<?=$sno?>" style="background-color:<?php if($Eactual==0){echo '#E5E5E5';}else{echo '#FFFFFF';}?>">
 ...
 <td class="tdc"><input class="tdcci" id="Per_Actual<?=$sno?>" value="<?=$Eactual?>" maxlength="12" onKeyPress="return isNumberKey(event)" onChange="EmpCalRw(this.value,<?=$sno.','.floatval($res['Hod_TotalFinalRating'].','.$prorata.','.$lgc.','.$yy.','.$mm.','.$dd.','.intval($res['EmpCurrCtc']))?>)" style="font-size:12px;"/>
 </td>
