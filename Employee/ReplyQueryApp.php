...
/*************************************************/
    if($_POST['EmpMail']=='')
    {
	 $email_subjectT = "Query Reply";   
     $email_messageT .= "Dear User <br><br>\n\n\n";
	 $email_messageT .="<html><head></head><body>";
     $email_messageT .= "Replied answer, as per your query on Subject :<b>".$_POST['QuerySubject']."</b>, go to <b>ESS-QUERY</b> for more details <a href='https://www.vnrseeds.co.in'>www.vnrseeds.co.in</a>.<br>"; 
	 $email_messageT .= "From <br><b>ADMIN ESS</b><br>";
	 $email_messageT .="</body></html>";	
     $subject=$email_subjectT;
     $body=$email_messageT;
     $email_to=$_POST['EmpMail'];
     require 'vendor/mail_admin.php';
   } 
/*************************************************/
     
     echo '<script>alert("Message updated successfully, please close the query."); window.close(); </script>';
   }
