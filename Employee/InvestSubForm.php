...
if(CorNPS>=0){if(CorNPS2==0){document.getElementById("CorNPS2").value=CorNPS;}document.getElementById("CorNPS2").readOnly=false;document.getElementById("CorNPS2").style.backgroundColor='#F0F8FF';}					   																		 
