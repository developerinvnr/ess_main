...
?> 			
	<tr style="background-color:<?php if($rowch>0){echo '#FFFF6C';}else{echo '#FFFFFF';}?>;">
     ...
     <td class="tdl">&nbsp;<?php echo strtoupper($ResHod['DesigName']); ?>
     
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     <?php if($EmployeeId==1413 && $DepartmentId==9){
     echo '<a href="../AdminUser/EmpIncHis_Emp.php?action=Inc&V='.$ResHod["EmpCode"].'&C='.$CompanyId.'" target="_blank" style="color:#000000;text-decoration:none;">..</a>';
     } ?>
     </td>
