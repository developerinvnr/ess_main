...
<?php $sql=mysql_query("select Fname,Sname,Lname,DepartmentCode,f.* from hrm_feedback f inner join hrm_employee e on f.SubBy=e.EmployeeID inner join hrm_employee_general g on f.SubBy=g.EmployeeID inner join hrm_department d on g.DepartmentId=d.DepartmentId where f.EmployeeID=".$resAc['EmployeeID']." order by f.SubDate DESC",$con); 
 ...
 <tr>
  ...
  <table width="95%;"> 
   ...
   <tr bgcolor="#FFFFFF">
    <td style="font-family:Times New Roman;font-size:14px;width:1100px;"><?php if($_SESSION['eAppform']=='Y'){ echo $resAc['Appraiser_Remark']; }elseif($_SESSION['eMidform']=='Y'){echo $resAc['Mid_Appraiser_Remark']; } ?>
<?php /*<input id="AppRemarks" name="AppRemarks" value="<?php if($_SESSION['eAppform']=='Y'){ echo $resAc['Appraiser_Remark']; }elseif($_SESSION['eMidform']=='Y'){echo $resAc['Mid_Appraiser_Remark']; } ?>" class="bl" style="width:100%;border:hidden;" maxlength="450" <?php if($resAc['Appraiser_PmsStatus']==2){ echo 'readonly'; } ?> />*/ ?>
 ...
 <tr>
  ...
  <table width="95%;"> 
   ...
   <tr bgcolor="#FFFFFF">
    <td style="font-family:Times New Roman; font-size:14px;width:1100px;">
    <?php echo $resAc['Reviewer_Remark']; ?>    
        
<?php /*<input id="AppRemarks" name="AppRemarks" value="<?php echo $resAc['Reviewer_Remark']; ?>" class="bl" style="width:100%;border:hidden;" maxlength="450" readonly />*/ ?>
    </td>
   </tr>
  </table>
  </td>
