   ...
   <tr>
    ...
    <table border="1" style="width:100%;" cellspacing="0">
     <tr bgcolor="#FFFF6C">	   
	  ...
	  <td bgcolor="#FFFF6C" class="h" style="width:10&;">KRA/Goals</td>
	  <td bgcolor="#FFFF6C" class="h" style="width:15%;">Description</td>  
   ...
   <div id="Div<?php echo $Sno; ?>" style="display:<?php if($rowSubK>0){echo 'block';}else{echo 'none';} ?>;">
    <table style="width:97%;background-color:#71FF71;" border="1" cellpadding="0" cellspacing="0"> 
     <tr style="background-color:#71FF71;">	 
	  ...
	  <td bgcolor="#71FF71" class="h" style="width:10&;">Sub KRA/Goals</td>
	  <td bgcolor="#71FF71" class="h" style="width:15%;">Sub Description</td>  
   ...
   <tr>
    ...
    <table border="1" cellspacing="0">
     <tr bgcolor="#FFFF6C">	   
	  ...
	  <td bgcolor="#FFFF6C" class="h" style="width:20%;">Description</td>  
	  ...
	  <td bgcolor="#FFFF6C" class="h" style="width:25%;">Emp Remark</td>
  ...
  <table width="95%;"> 
   ...
   <tr>
    <td style="font-family:Times New Roman; color:#FFFFFF; font-size:12px;width:1100px;">
        <textarea id="AppRemarks" name="AppRemarks" cols="160" rows="4"><?php echo $resAc['Appraiser_Remark']; ?></textarea>
        
<?php /*<input id="AppRemarks" name="AppRemarks" value="<?php if($_SESSION['eAppform']=='Y'){ echo $resAc['Appraiser_Remark']; }elseif($_SESSION['eMidform']=='Y'){echo $resAc['Mid_Appraiser_Remark']; } ?>" class="bl" style="width:100%;border:hidden;" maxlength="450" <?php if($resAc['Appraiser_PmsStatus']==2){ echo 'readonly'; } ?> />*/ ?>
    </td>
   </tr>
  </table>
  </td>
