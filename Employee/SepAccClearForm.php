...
{ 
  ...
  $AccRecy_R=str_replace($search, "", $_POST['AccRecy_Remark']);
...
{ 
  ...
  { $sqlIns=mysql_query("insert into hrm_employee_separation_nocacc(EmpSepId, NocSubmAccDate, AccECP, AccECP_Amt, AccECP_Amt2, AccECP_Remark, AccIPS, AccIPS_Amt, AccIPS_Amt2, AccIPS_Remark, AccAMS, AccAMS_Amt, AccAMS_Amt2, AccAMS_Remark, AccSAR, AccSAR_Amt, AccSAR_Amt2, AccSAR_Remark, AccWGR, AccWGR_Amt, AccWGR_Amt2, AccWGR_Remark, AccSB, AccSB_Amt, AccSB_Amt2, AccSB_Remark, AccTDSA, AccTDSA_Amt, AccTDSA_Amt2, AccTDSA_Remark, AccRecy, AccRecy_Amt, AccRecy_Amt2, AccRecy_Remark, AccAO8, AccAO_Txt8, AccAO_Amt8, AccAO2_Amt8, AccAO_Remark8, AccAO9, AccAO_Txt9, AccAO_Amt9, AccAO2_Amt9, AccAO_Remark9, AccAO10, AccAO_Txt10, AccAO_Amt10, AccAO2_Amt10, AccAO_Remark10, AccAO11, AccAO_Txt11, AccAO_Amt11, AccAO2_Amt11, AccAO_Remark11, AccAO12, AccAO_Txt12, AccAO_Amt12, AccAO2_Amt12, AccAO_Remark12, AccAO13, AccAO_Txt13, AccAO_Amt13, AccAO2_Amt13, AccAO_Remark13, AccAO14, AccAO_Txt14, AccAO_Amt14, AccAO2_Amt14, AccAO_Remark14, AccAO15, AccAO_Txt15, AccAO_Amt15, AccAO2_Amt15, AccAO_Remark15, TotAmt, TotAmt2, TotAccAmt, AccId, AccOth_Remark) values(".$_POST['si'].", '".date("Y-m-d")."', '".$_POST['AccECP_YN']."', '".$_POST['AccECP_Amt']."', '".$_POST['AccECP_Amt2']."', '".$AccECP_R."', '".$_POST['AccIPS_YN']."', '".$_POST['AccIPS_Amt']."', '".$_POST['AccIPS_Amt2']."', '".$AccIPS_R."', '".$_POST['AccAMS_YN']."', '".$_POST['AccAMS_Amt']."', '".$_POST['AccAMS_Amt2']."', '".$AccAMS_R."', '".$_POST['AccSAR_YN']."', '".$_POST['AccSAR_Amt']."', '".$_POST['AccSAR_Amt2']."', '".$AccSAR_R."', '".$_POST['AccWGR_YN']."', '".$_POST['AccWGR_Amt']."', '".$_POST['AccWGR_Amt2']."', '".$AccWGR_R."', '".$_POST['AccSB_YN']."', '".$_POST['AccSB_Amt']."', '".$_POST['AccSB_Amt2']."', '".$AccSB_R."', '".$_POST['AccTDSA_YN']."', '".$_POST['AccTDSA_Amt']."', '".$_POST['AccTDSA_Amt2']."', '".$AccTDSA_R."', '".$_POST['AccRecy_YN']."', '".$_POST['AccRecy_Amt']."', '".$_POST['AccRecy_Amt2']."', '".$_POST['AccAO_YN8']."', '".$AOTxt8."', '".$_POST['AccAO_Amt8']."', '".$_POST['AccAO2_Amt8']."', '".$AOR8."', '".$_POST['AccAO_YN9']."', '".$AOTxt9."', '".$_POST['AccAO_Amt9']."', '".$_POST['AccAO2_Amt9']."', '".$AOR9."', '".$_POST['AccAO_YN10']."', '".$AOTxt10."', '".$_POST['AccAO_Amt10']."', '".$_POST['AccAO2_Amt10']."', '".$AOR10."', '".$_POST['AccAO_YN11']."', '".$AOTxt11."', '".$_POST['AccAO_Amt11']."', '".$_POST['AccAO2_Amt11']."', '".$AOR11."', '".$_POST['AccAO_YN12']."', '".$AOTxt12."', '".$_POST['AccAO_Amt12']."', '".$_POST['AccAO2_Amt12']."', '".$AOR12."', '".$_POST['AccAO_YN13']."', '".$AOTxt13."', '".$_POST['AccAO_Amt13']."', '".$_POST['AccAO2_Amt13']."', '".$AOR13."', '".$_POST['AccAO_YN14']."', '".$AOTxt14."', '".$_POST['AccAO_Amt14']."', '".$_POST['AccAO2_Amt14']."', '".$AOR14."', '".$_POST['AccAO_YN15']."', '".$AOTxt15."', '".$_POST['AccAO_Amt15']."', '".$_POST['AccAO2_Amt15']."', '".$AOR15."', '".$_POST['TotAmt']."', '".$_POST['TotAmt2']."', '".$_POST['TotAccAmt']."', ".$_POST['ei'].", '".$AccROth."')", $con); }
...
function FunRecy(v)
{ if(v=='Y'){document.getElementById("AccRecy_Y").checked = true;document.getElementById("AccRecy_N").checked=false;document.getElementById("AccRecy_YN").value='Y';
  document.getElementById("AccRecy_Amt").readOnly=false; document.getElementById("AccRecy_Amt").style.background='#FFFFFF'; document.getElementById("AccRecy_A").checked=false;
  document.getElementById("AccRecy_Amt2").readOnly=false; document.getElementById("AccRecy_Amt2").style.background='#FFFFFF';
  document.getElementById("AccRecy_Amt").value=0;}
  else if(v=='N'){document.getElementById("AccRecy_Y").checked=false; document.getElementById("AccRecy_N").checked = true;document.getElementById("AccRecy_YN").value='N';
  document.getElementById("AccRecy_Amt").readOnly=true; document.getElementById("AccRecy_Amt").style.background='#EAEAEA'; document.getElementById("AccRecy_A").checked=false;
  document.getElementById("AccRecy_Amt2").readOnly=true; document.getElementById("AccRecy_Amt2").style.background='#EAEAEA';}
  else if(v=='A'){document.getElementById("AccRecy_Y").checked=false; document.getElementById("AccRecy_N").checked = false; document.getElementById("AccRecy_YN").value='A';
  document.getElementById("AccRecy_Amt").readOnly=true; document.getElementById("AccRecy_Amt").style.background='#EAEAEA'; document.getElementById("AccRecy_A").checked=true;
  document.getElementById("AccRecy_Amt2").readOnly=true; document.getElementById("AccRecy_Amt2").style.background='#EAEAEA';}
}
...
{ 
 ...
 var AccRecy_t = parseFloat(document.getElementById("AccRecy_Amt").value);
 ...
 var AccRecy_t2 = parseFloat(document.getElementById("AccRecy_Amt2").value);
 ...
 var TotAmt = document.getElementById("TotAmt").value=Math.round((AccECP_t+AccIPS_t+AccAMS_t+AccSAR_t+AccWGR_t+AccSB_t+AccTDSA_t+AccRecy_t+AccAO_8t+AccAO_9t+AccAO_10t+AccAO_11t+AccAO_12t+AccAO_13t+AccAO_14t+AccAO_15t)*100)/100; 
 
 var TotAmt2 = document.getElementById("TotAmt2").value=Math.round((AccECP_t2+AccIPS_t2+AccAMS_t2+AccSAR_t2+AccWGR_t2+AccSB_t2+AccTDSA_t2+AccRecy_t2+AccAO2_8t+AccAO2_9t+AccAO2_10t+AccAO2_11t+AccAO2_12t+AccAO2_13t+AccAO2_14t+AccAO2_15t)*100)/100; 
  ...
  <td style="width:650px;">
	...
	<tr bgcolor="#FFFFFF">
	 ...
	 <tr bgcolor="#FFFFFF"> 
	   ...
	   <td class="Text" style="width:150px;" align="center" valign="top">
	   NA<input type="checkbox" id="AccRecy_A" onClick="FunRecy('A')" <?php if($acc['AccRecy']=='A'){echo 'Checked';} ?>/>
	   Yes<input type="checkbox" id="AccRecy_Y" onClick="FunRecy('Y')" <?php if($acc['AccRecy']=='Y'){echo 'Checked';} ?>/>
	   No<input type="checkbox" id="AccRecy_N" onClick="FunRecy('N')" <?php if($acc['AccRecy']=='N'){echo 'Checked';} ?>/>
	   <input type="hidden" id="AccRecy_YN" name="AccRecy_YN" value="<?php echo $acc['AccRecy']; ?>" /></td>
	   <td class="Text" style="width:70px;" align="center" valign="top">
	   ...
	   <td class="Text" style="width:110px;" align="center" valign="top">
	    <input id="AccRecy_Remark" name="AccRecy_Remark" style="width:100px;" value="<?php echo $acc['AccRecy_Remark'] ?>" />
	   </td>
     </tr> 
