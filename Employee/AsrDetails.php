...
<?php } if($Res_4['PP_year']>0 OR $Res_5['PP_year']>0 OR $Res_6['PP_year']>0 OR $Res_7['PP_year']>0 OR $Res_8['PP_year']>0 OR $Res_9['PP_year']>0 OR $Res_10['PP_year']>0 OR $Res_11['PP_year']>0 OR $Res_12['PP_year']>0 OR $Res_1['PP_year']>0 OR $Res_2['PP_year']>0 OR $Res_3['PP_year']>0){ ?>
<tr bgcolor="#FFFFFF">
<td class="All_200">&nbsp;PP - Year</td>
<td class="All_80"><?php echo intval($Res_4['PP_year']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_5['PP_year']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_6['PP_year']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_7['PP_year']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_8['PP_year']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_9['PP_year']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_10['PP_year']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_11['PP_year']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_12['PP_year']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_1['PP_year']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_2['PP_year']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_3['PP_year']); ?>&nbsp;</td><td class="All_80" bgcolor="#55AAFF"><b><?php echo intval($Res_4['PP_year']+$Res_5['PP_year']+$Res_6['PP_year']+$Res_7['PP_year']+$Res_8['PP_year']+$Res_9['PP_year']+$Res_10['PP_year']+$Res_11['PP_year']+$Res_12['PP_year']+$Res_1['PP_year']+$Res_2['PP_year']+$Res_3['PP_year']); ?></b>&nbsp;</td>
</tr>


<?php } if($Res_4['NPS']>0 OR $Res_5['NPS']>0 OR $Res_6['NPS']>0 OR $Res_7['NPS']>0 OR $Res_8['NPS']>0 OR $Res_9['NPS']>0 OR $Res_10['NPS']>0 OR $Res_11['NPS']>0 OR $Res_12['NPS']>0 OR $Res_1['NPS']>0 OR $Res_2['NPS']>0 OR $Res_3['NPS']>0){ ?>
<tr bgcolor="#FFFFFF">
<td class="All_200">&nbsp;National pension scheme</td>
<td class="All_80"><?php echo intval($Res_4['NPS']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_5['NPS']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_6['NPS']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_7['NPS']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_8['NPS']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_9['NPS']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_10['NPS']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_11['NPS']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_12['NPS']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_1['NPS']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_2['NPS']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_3['NPS']); ?>&nbsp;</td><td class="All_80" bgcolor="#55AAFF"><b><?php echo intval($Res_4['NPS']+$Res_5['NPS']+$Res_6['NPS']+$Res_7['NPS']+$Res_8['NPS']+$Res_9['NPS']+$Res_10['NPS']+$Res_11['NPS']+$Res_12['NPS']+$Res_1['NPS']+$Res_2['NPS']+$Res_3['NPS']); ?></b>&nbsp;</td>
</tr>
...
<?php } if($Res_4['RecSplAllow']>0 OR $Res_5['RecSplAllow']>0 OR $Res_6['RecSplAllow']>0 OR $Res_7['RecSplAllow']>0 OR $Res_8['RecSplAllow']>0 OR $Res_9['RecSplAllow']>0 OR $Res_10['RecSplAllow']>0 OR $Res_11['RecSplAllow']>0 OR $Res_12['RecSplAllow']>0 OR $Res_1['RecSplAllow']>0 OR $Res_2['RecSplAllow']>0 OR $Res_3['RecSplAllow']>0){ ?>
<tr bgcolor="#FFFFFF">
<td class="All_200">&nbsp;Recovery Spl. Allow</td>
<td class="All_80"><?php echo intval($Res_4['RecSplAllow']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_5['RecSplAllow']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_6['RecSplAllow']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_7['RecSplAllow']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_8['RecSplAllow']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_9['RecSplAllow']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_10['RecSplAllow']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_11['RecSplAllow']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_12['RecSplAllow']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_1['RecSplAllow']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_2['RecSplAllow']); ?>&nbsp;</td><td class="All_80"><?php echo intval($Res_3['RecSplAllow']); ?>&nbsp;</td><td class="All_80" bgcolor="#55AAFF"><b><?php echo intval($Res_4['RecSplAllow']+$Res_5['RecSplAllow']+$Res_6['RecSplAllow']+$Res_7['RecSplAllow']+$Res_8['RecSplAllow']+$Res_9['RecSplAllow']+$Res_10['RecSplAllow']+$Res_11['RecSplAllow']+$Res_12['RecSplAllow']+$Res_1['RecSplAllow']+$Res_2['RecSplAllow']+$Res_3['RecSplAllow']); ?></b>&nbsp;</td>
</tr>
<?php } ?>
<?php $TotD4=$Res_4['Tot_Deduct']+$Res_4['TDS']+$Res_4['Arr_Pf']+$Res_4['Arr_Esic']+$Res_4['VolContrib']+$Res_4['DeductAdjmt']+$Res_4['RecSplAllow'];
$TotD5=$Res_5['Tot_Deduct']+$Res_5['TDS']+$Res_5['Arr_Pf']+$Res_5['Arr_Esic']+$Res_5['VolContrib']+$Res_5['DeductAdjmt']+$Res_5['RecSplAllow'];
$TotD6=$Res_6['Tot_Deduct']+$Res_6['TDS']+$Res_6['Arr_Pf']+$Res_6['Arr_Esic']+$Res_6['VolContrib']+$Res_6['DeductAdjmt']+$Res_6['RecSplAllow'];
$TotD7=$Res_7['Tot_Deduct']+$Res_7['TDS']+$Res_7['Arr_Pf']+$Res_7['Arr_Esic']+$Res_7['VolContrib']+$Res_7['DeductAdjmt'];
$TotD8=$Res_8['Tot_Deduct']+$Res_8['TDS']+$Res_8['Arr_Pf']+$Res_8['Arr_Esic']+$Res_8['VolContrib']+$Res_8['DeductAdjmt']+$Res_8['RecSplAllow'];
$TotD9=$Res_9['Tot_Deduct']+$Res_9['TDS']+$Res_9['Arr_Pf']+$Res_9['Arr_Esic']+$Res_9['VolContrib']+$Res_9['DeductAdjmt']+$Res_9['RecSplAllow'];
$TotD10=$Res_10['Tot_Deduct']+$Res_10['TDS']+$Res_10['Arr_Pf']+$Res_10['Arr_Esic']+$Res_10['VolContrib']+$Res_10['DeductAdjmt']+$Res_10['RecSplAllow'];
$TotD11=$Res_11['Tot_Deduct']+$Res_11['TDS']+$Res_11['Arr_Pf']+$Res_11['Arr_Esic']+$Res_11['VolContrib']+$Res_11['DeductAdjmt']+$Res_11['RecSplAllow'];
$TotD12=$Res_12['Tot_Deduct']+$Res_12['TDS']+$Res_12['Arr_Pf']+$Res_12['Arr_Esic']+$Res_12['VolContrib']+$Res_12['DeductAdjmt']+$Res_12['RecSplAllow'];
$TotD1=$Res_1['Tot_Deduct']+$Res_1['TDS']+$Res_1['Arr_Pf']+$Res_1['Arr_Esic']+$Res_1['VolContrib']+$Res_1['DeductAdjmt']+$Res_1['RecSplAllow'];
$TotD2=$Res_2['Tot_Deduct']+$Res_2['TDS']+$Res_2['Arr_Pf']+$Res_2['Arr_Esic']+$Res_2['VolContrib']+$Res_2['DeductAdjmt']+$Res_2['RecSplAllow'];
$TotD3=$Res_3['Tot_Deduct']+$Res_3['TDS']+$Res_3['Arr_Pf']+$Res_3['Arr_Esic']+$Res_3['VolContrib']+$Res_3['DeductAdjmt']+$Res_3['RecSplAllow'];
?>
