...
$LTA=$resHRA['BAS_Value']*1; $HRA=$resHRA['HRA_Value']*12;?> 
...
<td align="left" valign="top" style="width:550px;font-size:15px;">&nbsp;I will provide the tickets/ Travels bills in original as per(one basic annually) the LTA policy or else the company can consider amount as taxable.</td>
...
<input type="button" name="EditInvstDec" id="EditInvstDec" style="width:90px;" value="edit" onClick="Edit()" <?php if($resInvSb['OpenYN']=='N' OR $resIvst2['FormSubmit']=='YY'){echo 'disabled';} //if($resInvSb['OpenYN']=='N'){echo 'disabled';}?>>
<?php } ?>
	  </td>
