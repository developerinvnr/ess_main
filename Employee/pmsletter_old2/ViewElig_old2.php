<style>
.tdd1{width:550px;font-size:16px;height:14px;text-align:left;}
...
<td style="width:5px;" align="center"></td>
 ...
 $sqPt=mysql_query("select Fn6 from hrm_master_eligibility_policy_tbl".$ResEligEmp['VehiclePolicy']." where GradeId=".$rEg['GradeId'],$con);
...
<?php if($ResCtc['ESCI']>0){ echo ''; } else {?>
 <tr>
  <td class="tdd1"><b>*</b>&nbsp;&nbsp;Health Insurance (Sum Insured)  </td>
...
?>
 <tr>
  <td class="tdd1"><b>*</b>&nbsp;&nbsp;Group Term Life Insurance (Sum Insured)  </td>
