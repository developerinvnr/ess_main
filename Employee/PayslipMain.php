  ...
  <tr>
   <td class="td14ce" style='width:350px;vertical-align:top;'>
    <table border="1"  style="width:100%;"  cellspacing="0">
     ...
     <?php } if($ResPay['NPS']>0){ ?>
	 <tr style="height:23px;">
	  <td class="td13">&nbsp;NATIONAL PENSION SCHEME</td>
      <td class="td14r"><?php echo intval($ResPay['NPS']); ?>&nbsp;</td>
     </tr>
     <?php } if($ResPay['NoticePay']>0){ ?>
	 <tr style="height:23px;">
   ...
   <td class="td14ce" style='width:350px;vertical-align:top;'>
    ...
    <?php } if($ResPay['RecSplAllow']>0) { ?>  
    <tr style="height:23px;">
     <td class="td13">&nbsp;<?php if($ResPay['RecSplAllow']>0){ ?>RECOVERY SPECIAL ALLOWANCE<?php } ?></td>
     <td class="td14r">&nbsp;<?php if($ResPay['RecSplAllow']>0){ echo intval($ResPay['RecSplAllow']); } ?></td>
    </tr>
    <?php } ?>        
	</table>
   </td>
