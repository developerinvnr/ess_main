...
{ 
 ...
 $sql=mysql_query("select EmpPmsId from hrm_employee_pms where AssessmentYear=".$YI." AND HOD_EmployeeID=".$Emp." AND Hod_IncNetCTC>0 AND HodSubmit_IncStatus=1", $con); 
