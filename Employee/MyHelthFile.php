...
{     
 ...
 if(file_exists('HealthIDCard/'.$_REQUEST['c'].'/'.$EC3.'/'.$EC3.'_A.pdf')) 
 {
  $filename= 'HealthIDCard/'.$_REQUEST['c'].'/'.$EC3.'/'.$EC3.'_A.pdf';
 ...
 if(file_exists('HealthIDCard/'.$_REQUEST['c'].'/'.$EC3.'/'.$EC3.'_B.pdf'))
 {
  $filename2= 'HealthIDCard/'.$_REQUEST['c'].'/'.$EC3.'/'.$EC3.'_B.pdf'; 
 ...
 if(file_exists('HealthIDCard/'.$_REQUEST['c'].'/'.$EC3.'/'.$EC3.'_C.pdf'))
 {
  $filename3= 'HealthIDCard/'.$_REQUEST['c'].'/'.$EC3.'/'.$EC3.'_C.pdf';
 ...
 if(file_exists('HealthIDCard/'.$_REQUEST['c'].'/'.$EC3.'/'.$EC3.'_D.pdf'))
 {
  $filename4= 'HealthIDCard/'.$_REQUEST['c'].'/'.$EC3.'/'.$EC3.'_D.pdf';
