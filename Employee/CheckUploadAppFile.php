...
<td>
 ...
 $DBFileName=substr($resCheck['FileName'],5); ?>
   <tr bgcolor="#FFFFFF" style="height:21px;">
	...
	<a href="AppUploadFile/<?=$resCheck['FileName']?>"><img src="<?php if($resCheck['Ext']=='.doc' OR $resCheck['Ext']=='.docx'){echo 'images/doc.png';} if($resCheck['Ext']=='.xls' OR $resCheck['Ext']=='.xlsx'){echo 'images/xls.png';} if($resCheck['Ext']=='.jpg' OR $resCheck['Ext']=='.jpeg'){echo 'images/jpg.png';} if($resCheck['Ext']=='.ods'){echo 'images/ods.png';} if($resCheck['Ext']=='.odt'){echo 'images/odt.png';} if($resCheck['Ext']=='.ppt'){echo 'images/ppt.png';} if($resCheck['Ext']=='.pdf'){echo 'images/pdf.png';}?>" /></a></td>
	
	<?php /*<td style="width:80px; font-family:Times New Roman; font-size:12px;" align="center">
