...
{ //alert(l+","+v);
  ...
  var r=document.getElementById('RR').value; var s=document.getElementById('SS').value;
  var hq=document.getElementById('HH').value; var t=document.getElementById('TT').value; 
  ...
  else if(l=='Z'){ var r=0; var s=0; var hq=0; StT=0; VcH=0; FcH=0; VcT=0; FcT=0; }
  else if(l=='R'){ var s=0; var hq=0; StT=0; VcH=0; FcH=0; VcT=0; FcT=0; }
  ...
  window.location="SalesDistriName.php?ern1=r114&ern2w=234&ern3y=10234&ern=4e2&d=ee&c="+c+"&r="+r+"&s="+s+"&hq="+hq+"&z="+z+"&t="+t+"&bp="+bp+"&StT="+StT+"&VcH="+VcH+"&FcH="+FcH+"&VcT="+VcT+"&FcT="+FcT; 
}
...
{ 
 ...
 { alert('Done! "'+Dnn+'" details inserted successfully.'); 
   ...
   var c=document.getElementById('CC').value; var z=document.getElementById('ZZ').value;
   var s=document.getElementById('SS').value; var hq=document.getElementById('HH').value;
   var t=document.getElementById('TT').value; var r=document.getElementById('RR').value;
   window.location="SalesDistriName.php?ern1=r114&ern2w=234&ern3y=10234&ern=4e2&d=ee&c="+c+"&r="+r+"&s="+s+"&hq="+hq+"&z="+z+"&t="+t;
 }
...
if($_REQUEST['r']>0){$qr='vq.RegionId='.$_REQUEST['r'];}else{$qr='1=1';} 
   ...
   <table border="0" style="margin-top:0px;">
     <tr>
	  ...
	  <option value="0">Zone</option><?php $sqlZ = mysql_query("SELECT * FROM hrm_sales_zone order by ZoneName ASC",$con); while($resZ=mysql_fetch_array($sqlZ)) { ?><option value="<?=$resZ['ZoneId'];?>" <?php if($_REQUEST['z']==$resZ['ZoneId']){echo 'selected';}?>><?=$resZ['ZoneName'];?></option><?php } ?></select>
	   ...
	   <td style="width:100px;"><select class="seli" name="RR" id="RR" onChange="ClickLoc('R',this.value)">
	  <option value="0">Region</option><?php $sqlR = mysql_query("SELECT * FROM hrm_sales_region where ".$qs." order by RegionName ASC",$con); while($resR=mysql_fetch_array($sqlR)) { ?><option value="<?=$resR['RegionId'];?>" <?php if($_REQUEST['r']==$resR['RegionId']){echo 'selected';}?>><?=$resR['RegionName'];?></option><?php } ?></select>
	   </td>
	  ...
	  <?php /*?> <td style="width:150px;text-align:center;" colspan="2"><select class="seli" name="StT" id="StT" onChange="ClickLoc('StT',this.value)">
	   ...
	   <td style="width:200px;" colspan="2"><select class="seli" name="TT" id="TT" onChange="ClickLoc('T',this.value)" style="width:200px;">
