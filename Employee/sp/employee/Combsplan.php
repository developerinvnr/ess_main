...
<table border="1" cellpadding="0" cellspacing="0" style="font-family:Times New Roman;font-size:12px;width:550px;vertical-align:top;">
 ...
 <?php /*?> <td align="center" style="width:150px;font-size:14px;"><b>Collection (Dealer Wise)</b></td><?php */?>
 </tr>   
  <?php  
 ...
 <tr bgcolor="#EEEEEE" style="height:22px;background-color:<?php echo '#E2F3D8'; ?>;"> 
  ...
  <?php /*?><td style="font-size:14px;" align="center"><?php //echo $rows4; ?><?php if($rows4>0){ ?><a href="#" onClick="ExportCollAll(<?php echo $_REQUEST['y'].','.$EmployeeId; ?>)"><b>Click</b></a><?php } ?></td><?php */?>
