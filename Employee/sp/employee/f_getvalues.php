...
if($e==1315)
{
$sqlhq=mysql_query("select sd.HqId,HqName FROM hrm_sales_dealer sd INNER JOIN hrm_headquater hq ON sd.HqId=hq.HqId where hq.StateId=".$_POST['sid']." AND hq.HQStatus='A' group by HqId order by HqName ASC",$con); 
}
else
{
