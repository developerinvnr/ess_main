...
if($EmployeeId==1315)
{
$result=mysql_query("select * from fa_details fd where  ".$qry." AND (FaStatus='A' OR (FaStatus='D' AND RemoveSts=3)) order by FaId ASC",$con);
}
else
{
...
if($EmployeeId==1315)
{
$sql=mysql_query("select * from fa_details fd where ".$qry." AND (FaStatus='A' OR (FaStatus='D' AND RemoveSts=3)) order by FaId ASC LIMIT ".$from.",".$offset,$con);
}
else
{
