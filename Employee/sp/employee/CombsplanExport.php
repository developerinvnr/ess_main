...
$rHv=mysql_fetch_assoc($sHv); $Hqv=$rHv['HqName']; $Znv=$rHv['ZoneName']; $Stv=$rHv['StateName']; }
else{ $Hqv=''; $Stv=''; $Znv=''; }
...
$rHf=mysql_fetch_assoc($sHf); $Hqf=$rHf['HqName']; $Znf=$rHf['ZoneName']; $Stf=$rHf['StateName']; }
else{ $Hqf='';; $Stf=''; $Znf=''; }
