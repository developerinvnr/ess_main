...
if($EmployeeId==1315)
{
$result=mysql_query("select * from fa_details where (MdChng_Reporting_AppSts=".$_REQUEST['rsts']." OR MdChng_Rev_AppSts=".$_REQUEST['rsts']." OR MdChng_Hod_AppSts=".$_REQUEST['rsts'].") AND ".$sqry." AND (FaStatus='A' OR (FaStatus='D' AND RemoveSts=3)) AND MdChngSts>=1 order by FaId ASC",$con); 
}
else
{
...
if($EmployeeId==1315)
{
   $sql=mysql_query("select * from fa_details where (MdChng_Reporting_AppSts=".$_REQUEST['rsts']." OR MdChng_Rev_AppSts=".$_REQUEST['rsts']." OR MdChng_Hod_AppSts=".$_REQUEST['rsts'].") AND ".$sqry." AND (FaStatus='A' OR (FaStatus='D' AND RemoveSts=3)) AND MdChngSts>=1 order by FaId ASC LIMIT ".$from.",".$offset,$con);
}
else
{
...
<td class="tdf2"><input class="InputType" style="width:100px;" id="Hq<?php echo $sn; ?>" value="<?php echo ucfirst(strtolower($rhq['HqName'])); ?>" readonly/></td>
	 ...
	 <select style="width:80px;" class="InputSel" onChange="FucApp(this.value,<?php echo $sn.','.$res['FaId'].', '.$_REQUEST['m'].','.$_REQUEST['y'].','.$EmployeeId.','.$res['MdChng_Reporting'].','.$res['MdChng_Rev'].','.$res['MdChng_Hod'].','.$res['MdChngReqBy'].','.$res['MdChng_lvl']; ?>)"><option value="" selected>Select</option><option value="2">Approve</option><option value="3">Reject</option></select>
	 <?php }else{?>
	 <?php if(($res['MdChng_Reporting']==$EmployeeId && ($res['MdChng_Reporting_AppSts']==0 OR $res['MdChng_Reporting_AppSts']==1)) OR ($res['MdChng_Rev']==$EmployeeId && ($res['MdChng_Rev_AppSts']==0 OR $res['MdChng_Rev_AppSts']==1)) OR ($res['MdChng_Hod']==$EmployeeId && ($res['MdChng_Hod_AppSts']==0 OR $res['MdChng_Hod_AppSts']==1))){ ?><select style="width:80px;" class="InputSel" onChange="FucApp(this.value,<?php echo $sn.','.$res['FaId'].', '.$_REQUEST['m'].','.$_REQUEST['y'].','.$EmployeeId.','.$res['MdChng_Reporting'].','.$res['MdChng_Rev'].','.$res['MdChng_Hod'].','.$res['MdChngReqBy'].','.$res['MdChng_lvl']; ?>)"><option value="" selected>Select</option><option value="2">Approve</option><option value="3">Reject</option></select><?php } ?>
	 <?php } ?>
	 </td>
