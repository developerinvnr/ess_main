...
{ 
  ...
  var Dpt = document.getElementById("DeptId").value;
  ...
  */
  ...
  {
   if(Dpt==4){ var KRAWeight=parseInt(35); 
   var Percent=((AppKRARating/KRATarget)*115)/100; 
   var MScore=document.getElementById("AppKRAScore"+n).value=Math.round((Percent*KRAWeight)*100)/100;
   }
   else
   {
    var Percent=((AppKRARating/KRATarget)*KRAWeight)/100; 
   var MScore=document.getElementById("AppKRAScore"+n).value=Math.round((Percent*115)*100)/100;
   }
   var Score=document.getElementById("KraScore"+n).value=MScore;
  }
  else if(lgc=='Logic8b')
  {
   ...
   {
    var Percent=((AppKRARating/KRATarget)*KRAWeight)/100; 
   var MScore=document.getElementById("AppKRAScore"+n).value=Math.round((Percent*100)*100)/100;
   }
   var Score=document.getElementById("KraScore"+n).value=MScore;
  }
  else if(lgc=='Logic8c')
  {
   ...
   {
    var Percent=((AppKRARating/KRATarget)*KRAWeight)/100; 
    var MScore=document.getElementById("AppKRAScore"+n).value=Math.round((Percent*90)*100)/100;
   }
   var Score=document.getElementById("KraScore"+n).value=MScore;
  }
  else if(lgc=='Logic8d')
  {
   ...
   {
    var Percent=((AppKRARating/KRATarget)*KRAWeight)/100; 
    var MScore=document.getElementById("AppKRAScore"+n).value=Math.round((Percent*65)*100)/100;
   }
   var Score=document.getElementById("KraScore"+n).value=MScore;
  }
  else if(lgc=='Logic8e')
 ...
 else if(lgc=='Logic15a')
 {
  ...
  var Per40=Math.round(((KRATarget*40)/100)*100)/100; var Per60=Math.round((KRATarget-Per40)*100)/100;
  var Per10=Math.round(((KRATarget*10)/100)*100)/100; var Per90=Math.round((KRATarget-Per10)*100)/100; var Per110=Math.round((KRATarget+Per10)*100)/100;  
  ...
  else if(AppKRARating>Per99){var EScore=document.getElementById("AppKRALogic"+n).value=KRATarget;} //110
  else{var EScore=document.getElementById("AppKRALogic"+n).value=0;}
  var MScore=document.getElementById("AppKRAScore"+n).value=Math.round(((EScore/KRATarget)*KRAWeight)*100)/100;
  var Score=document.getElementById("KraScore"+n).value=MScore;
 }
...
{ 
  ...
  */
  ...
  {
   //var Weight=parseInt(35);
   if(Dpt==4){ var Weight=parseInt(35); 
   var Percent=((Rating/Target)*115)/100; 
   var MScore=document.getElementById("AppKRAScore"+i+"_"+j).value=Math.round((Percent*Weight)*100)/100;
   }
   else
   {
    var Percent=((Rating/Target)*Weight)/100; 
    var MScore=document.getElementById("AppKRAScore"+i+"_"+j).value=Math.round((Percent*115)*100)/100;
   }
   var Score=document.getElementById("KraScoreSub"+i+"_"+j).value=MScore;
  }
  else if(lgc=='Logic8b')
  {
   ...
   {
    var Percent=((Rating/Target)*Weight)/100; 
    var MScore=document.getElementById("AppKRAScore"+i+"_"+j).value=Math.round((Percent*100)*100)/100;
   }
   var Score=document.getElementById("KraScoreSub"+i+"_"+j).value=MScore;
  }
  else if(lgc=='Logic8c')
  {
   ...
   {
    var Percent=((Rating/Target)*Weight)/100; 
    var MScore=document.getElementById("AppKRAScore"+i+"_"+j).value=Math.round((Percent*90)*100)/100;
   }
   var Score=document.getElementById("KraScoreSub"+i+"_"+j).value=MScore;
  }
  else if(lgc=='Logic8d')
  {
   ...
   {
    var Percent=((Rating/Target)*Weight)/100; 
    var MScore=document.getElementById("AppKRAScore"+i+"_"+j).value=Math.round((Percent*65)*100)/100;
   }
   var Score=document.getElementById("KraScoreSub"+i+"_"+j).value=MScore;
  }
  else if(lgc=='Logic8e')
 ...
 else if(lgc=='Logic15a')
 {
  ...
  var Per40=Math.round(((Target*40)/100)*100)/100; var Per60=Math.round((Target-Per40)*100)/100;
  var Per10=Math.round(((Target*10)/100)*100)/100; var Per90=Math.round((Target-Per10)*100)/100;  var Per110=Math.round((Target+Per10)*100)/100; 
  ...
  else if(Rating>Per99){var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=Target;} //110
  else{var EScore=document.getElementById("AppKRALogic"+i+"_"+j).value=0;}
  var MScore=document.getElementById("AppKRAScore"+i+"_"+j).value=Math.round(((EScore/Target)*Weight)*100)/100;
  var Score=document.getElementById("KraScoreSub"+i+"_"+j).value=MScore;
 }
...
<?php $SnoB++;} ?>
 ...
 <form name="AppraisalForm" method="post" onSubmit="return Validation(this)">
  ...
  <?php $sqD=mysql_query("select DepartmentId from hrm_employee_general where EmployeeID=".$Eid,$con);
      $rsD=mysql_fetch_assoc($sqD); ?><input type="hidden" id="DeptId" value="<?=$rsD['DepartmentId']?>" />
...
<?php if($m==1){$n='(a)';}elseif($m==2){$n='(b)';}elseif($m==3){$n='(c)';}elseif($m==4){$n='(d)';}elseif($m==5){$n='(e)';} ?>
	 ...
	 <tr style="background-color:#FFFFFF;">  
      ...
      <?php if($_SESSION['eAppform']=='Y' OR $_SESSION['eMidform']=='Y'){ ?>
      <td class="fbodyc"><?php if($_SESSION['eAppform']=='Y'){ if($restt['tELogScr']>0){echo floatval($restt['tELogScr']);}else{echo floatval($rSubK['SelfRating']);} }elseif($_SESSION['eMidform']=='Y'){echo $rSubK['Mid_SelfRating']; } ?>
      <?php if($_REQUEST['Eid']==387){?>
      <input type="text" value="<?=$rSubK['SelfKRAScore'];?>" />
      <?php } ?>
      </td>
