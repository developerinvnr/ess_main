...
{ 
  ...
  */
  else if(lgc=='Logic8a')
  {
   ...
   {
    var Percent=((EmpKRARating/KRATarget)*KRAWeight)/100; 
    var MScore=document.getElementById("EmpKRAScore"+i).value=Math.round((Percent*KRAWeight)*115)/100;
   }
   var Score=document.getElementById("KraScore"+i).value=MScore;
  }
  else if(lgc=='Logic8a')
  {
   ...
   {
    var Percent=((EmpKRARating/KRATarget)*KRAWeight)/100; 
    var MScore=document.getElementById("EmpKRAScore"+i).value=Math.round((Percent*115)*100)/100;
   }
   var Score=document.getElementById("KraScore"+i).value=MScore;
  }
  else if(lgc=='Logic8b')
  {
   ...
   {
    var Percent=((EmpKRARating/KRATarget)*KRAWeight)/100; 
    var MScore=document.getElementById("EmpKRAScore"+i).value=Math.round((Percent*100)*100)/100;
   }
   var Score=document.getElementById("KraScore"+i).value=MScore;
  }
  else if(lgc=='Logic8c')
  {
   ...
   {
    var Percent=((EmpKRARating/KRATarget)*KRAWeight)/100; 
    var MScore=document.getElementById("EmpKRAScore"+i).value=Math.round((Percent*90)*100)/100;
   }
   var Score=document.getElementById("KraScore"+i).value=MScore;
  }
  else if(lgc=='Logic8d')
  {
   ...
   {
    var Percent=((EmpKRARating/KRATarget)*KRAWeight)/100; 
    var MScore=document.getElementById("EmpKRAScore"+i).value=Math.round((Percent*65)*100)/100;
   }
   var Score=document.getElementById("KraScore"+i).value=MScore;
  }
  else if(lgc=='Logic8e')
 ...
 else if(lgc=='Logic15a')
 {
  ...
  else if(EmpKRARating>Per99){var EScore=document.getElementById("EmpKRAScore"+i).value=KRATarget;} //110 
  else{var EScore=document.getElementById("EmpKRAScore"+i).value=0;}
  var MScore=document.getElementById("EmpKRAScore"+i).value=Math.round(((EScore/KRATarget)*KRAWeight)*100)/100;
  var Score=document.getElementById("KraScore"+i).value=MScore;
 }
...
{ 
  ...
  */
  else if(lgc=='Logic8a')
  {
   ...
   else
   {
    ...
    var MScore=document.getElementById("EmpKRAScore"+i+"_"+k).value=Math.round((Percent*115)*100)/100;
   }
    var Score=document.getElementById("KraScoreSub"+i+"_"+k).value=MScore;
  }
  else if(lgc=='Logic8b')
  {
   ...
   {
    var Percent=((Rating/Target)*Weight)/100; 
    var MScore=document.getElementById("EmpKRAScore"+i+"_"+k).value=Math.round((Percent*100)*100)/100;
   }
   var Score=document.getElementById("KraScoreSub"+i+"_"+k).value=MScore;
  }
  else if(lgc=='Logic8c')
  {
   ...
   {
    var Percent=((Rating/Target)*Weight)/100; 
    var MScore=document.getElementById("EmpKRAScore"+i+"_"+k).value=Math.round((Percent*90)*100)/100;
   }
   var Score=document.getElementById("KraScoreSub"+i+"_"+k).value=MScore;
  }
  else if(lgc=='Logic8d')
  {
   ...
   {
    var Percent=((Rating/Target)*Weight)/100; 
    var MScore=document.getElementById("EmpKRAScore"+i+"_"+k).value=Math.round((Percent*65)*100)/100;
   }
   var Score=document.getElementById("KraScoreSub"+i+"_"+k).value=MScore;
  }
  else if(lgc=='Logic8e')
 ...
 else if(lgc=='Logic15a')
 {
  ...
  else if(Rating>=Per99){var EScore=document.getElementById("EmpKRALogic"+i+"_"+k).value=Target;} //Per110
  else{var EScore=document.getElementById("EmpKRALogic"+i+"_"+k).value=0;}
  var MScore=document.getElementById("EmpKRAScore"+i+"_"+k).value=Math.round(((EScore/Target)*Weight)*100)/100;
  var Score=document.getElementById("KraScoreSub"+i+"_"+k).value=MScore;
...
<?php $sqD=mysql_query("select DepartmentId from hrm_employee_general where EmployeeID=".$EmployeeId,$con);
