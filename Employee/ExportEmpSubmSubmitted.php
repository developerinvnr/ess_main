...
$sql=mysql_query("select sb.*,EmpCode,Fname,Sname,Lname,department_name as DepartmentName from hrm_employee_investment_submission sb inner join hrm_employee e on sb.EmployeeID=e.EmployeeID inner join hrm_employee_general g on sb.EmployeeID=g.EmployeeID left join core_departments d on g.DepartmentId=d.id where Period='".$_REQUEST['prd']."' order by e.ECode ASC", $con);
