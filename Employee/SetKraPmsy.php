...
//$_SESSION['PmsYId']=$Yearp['CurrY'];

if($Keye['AppraisalForm']=='Y'){ $_SESSION['PmsYId']=$Yearp['CurrY']; }
elseif($Yeark['NewY_AllowEntry']=='Y'){ $_SESSION['PmsYId']=$Yeark['NewY']; }
else{ $_SESSION['PmsYId']=$Yeark['CurrY']; }


$_SESSION['KraYId']=$Yeark['CurrY'];  
$_SESSION['AllowDoj']=$Yearp['AllowEmpDoj']; $_SESSION['EffDate']=$Yearp['EffectedDate2'];
$_SESSION['KraYIdNew']=$Yeark['NewY'];
$_SESSION['NewY_AllowEntry']=$Yeark['NewY_AllowEntry'];
...
$sKSchn=mysql_query("select * from hrm_pms_kradate where AssessmentYear=".$_SESSION['KraYIdNew']." AND CompanyId=".$CompanyId, $con); $KSchn=mysql_fetch_assoc($sKSchn); 
$_SESSION['ekFromn']=$KSchn['EmpFromDate']; $_SESSION['ekTon']=$KSchn['EmpToDate']; $_SESSION['ekStsn']=$KSchn['EmpDateStatus'];
$_SESSION['akFromn']=$KSchn['AppFromDate']; $_SESSION['akTon']=$KSchn['AppToDate']; $_SESSION['akStsn']=$KSchn['AppDateStatus'];
