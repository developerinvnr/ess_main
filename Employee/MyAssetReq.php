...
{ 
  ...
  { document.getElementById("ForCar").style.display='block'; document.getElementById("ForNCar").style.display='none';    
	...
	document.getElementById("Max2Value").style.display='block';
  ...
  { 
	...
	document.getElementById("Max2Value").style.display='none';
  }
...
{  var Numfilter=/^[0-9 ]+$/;  var filter=/^[a-zA-Z. /]+$/;
   ...
   if(ReqAmt==0 || ReqAmt==''){ alert('please check the request amount'); return false; } 
...
<option value="<?php echo $resNA['AssetNId']; ?>"><?php echo strtoupper($resNA['AssetName']); ?></option><?php } ?>
     ...
     <td class="th"><span id="MaxValue">Maximum Limit :</span><span id="Max2Value" style="display:none;">Vehicle Value :</span></td>
