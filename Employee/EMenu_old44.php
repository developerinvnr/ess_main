...
if (($_SESSION['EmpType'] == 'E' or $_SESSION['EmpType'] == 'M') and $_SESSION['EmpStatus'] == 'A') { ?>
    ...
    ?>
        ...
        <ul id="nav">
            ...
            <li class="top"><?php if ($_SESSION['login'] = true) {
                                echo '<img src="../images/VNR_ico.png" style="height:33px;width:30px;" border="0">';
                            } ?></li>
            <li class="top"><a href="Index.php?log=<?php echo $_SESSION['logCheckEmp']; ?>" class="top_link"><span>Home</span></a></li>

            <?php if ($rowResig == 0) {
                /******************** Check Resignation Open 11 **********************/ ?>
                ...
                ?>
                    ...
                    ?>
                        ...
                        if ($CompanyId != 1 or $EmployeeId == 461 or $EmployeeId == 223 or $EmployeeId == 224 or $EmployeeId == 6 or $EmployeeId == 7 or $EmployeeId == 52 or $EmployeeId == 51 or $EmployeeId == 89 or $resDept['KRAUnBlock'] == 'Y' or ($RD['DateJoining'] >= '2024-01-01' and date("Y-m-d") <= $After31DayDoJ) or ($RD['DateJoining'] >= '2024-01-01' and date("Y-m-d") > $After31DayDoJ and $rowkk2 > 0) or ($RD['DateJoining'] < '2024-01-01' and date("Y-m-d") <= $KSch['EmpToDate']) or ($RD['DateJoining'] < '2024-01-01' and date("Y-m-d") > $KSch['EmpToDate'] and $rowkk2 > 0)) { 
                            ...
                            <li class="top"><a href="#nogo22" class="top_link"><span class="down">Salary</span></a>
                                <ul class="sub">
                                    ...
                                    ?>
                                            ...
                                            <?php if ($CompanyId == 1 and $resMK['Ctc'] == 'Y') { //MyCtcpfc.php 
                                            ?><li><a href="MyCtc.php?mnt=89we&p=345&ok=tt&r=101&prp=false_res##ius&log=%true%t&oo=4e&p=g&ok=trt">CTC</a></li>
                                            ...
                                            <?php } else { ?><li><a href="#">PaySlip</a></li>
                                                <li><a href="#">Annual Salary</a></li>
                                            <?php } ?>
                                    ...
                                    ?>
                                            ...
                                            <?php if ($EmployeeId == 169 or $EmployeeId == 386 or $EmployeeId == 1312) { ?>
                        ...
                        ?>
                                ...
                                <li class="top"><a href="#nogo22" class="top_link"><span class="down">Assets</span></a>
                                    <ul class="sub">
                                        ...
                                        $rowcr = mysql_num_rows($sqlcr);
                                        $rowcrd = mysql_num_rows($sqlcrd);
                                        if ($rowcr > 0) { ?>
                                        ...
                                        $sqlIT2 = mysql_query("select * from hrm_asset_dept_access where DepartmentId=9", $con);
                                        $resIT2 = mysql_fetch_assoc($sqlIT2);
                                        ...
                                        <?php $sqlAc = mysql_query("select * from hrm_asset_employee_request where ITApprovalStatus=2 AND (AccPayStatus=0 OR AccPayStatus=1)", $con);
                                        $rowAc = mysql_num_rows($sqlAc);
                                        $sqlAc2 = mysql_query("select * from hrm_asset_dept_access where DepartmentId=8", $con);
                                        $resAc2 = mysql_fetch_assoc($sqlAc2);
                                        if ($resAc2['EmployeeID'] == $EmployeeId or $resAc2['EmployeeID2'] == $EmployeeId or $resAc2['EmployeeID3'] == $EmployeeId or $resAc2['EmployeeID4'] == $EmployeeId or $EmployeeId == 169) { ?>
                        ...
                        ?>
                                ...
                                <?php if ($resMK['Query'] == 'Y') {
                                    ...
                                    $sqlQuery = mysql_query("select * from hrm_employee_queryemp where Level_1ID=" . $EmployeeId . " AND (QStatus=0 OR QStatus=1) AND (Level_1QStatus=0 OR Level_1QStatus=1) AND QueryStatus_Emp!=3 AND QueryStatus_Emp!=4 AND '" . $CurrDate . "'>=Level_1QToDT AND '" . $CurrDate . "'<Level_2QToDT order by QueryDT DESC", $con);
                                    $rowQuery = mysql_num_rows($sqlQuery); ?>
                                    <li class="top"><a href="#nogo22" class="top_link"><span class="down">Query</span></a>
                                        <ul class="sub">
                                            ...
                                            <?php if ($_SESSION['EmpType'] == 'E') {
                                                $sqlQuery = mysql_query("select * from hrm_employee_queryemp where Level_1ID=" . $EmployeeId . " AND (QStatus=0 OR QStatus=1) AND (Level_1QStatus=0 OR Level_1QStatus=1) AND QueryStatus_Emp!=3 AND QueryStatus_Emp!=4 AND '" . $CurrDate . "'>=Level_1QToDT AND '" . $CurrDate . "'<=Level_2QToDT order by QueryDT DESC", $con);
                                                $rowQuery = mysql_num_rows($sqlQuery); ?><li><a href="EmpDraftQ.php?page=1">Employee Query&nbsp;&nbsp;<font style="font-weight:bold;color:#FF860D; font-size:12px;"><?php echo '(' . $rowQuery . ')'; ?></font></a></li>
                                            <?php } elseif ($_SESSION['EmpType'] == 'M') {
                                                $sqlQuery = mysql_query("select * from hrm_employee_queryemp where Mngmt_ID=" . $EmployeeId . " AND (QStatus=0 OR QStatus=1) AND (Mngmt_QStatus=0 OR Mngmt_QStatus=1) AND QueryStatus_Emp!=3 AND QueryStatus_Emp!=4 AND '" . $CurrDate . "'>Mngmt_QToDT order by QueryDT DESC", $con);
                                                $rowQuery = mysql_num_rows($sqlQuery); ?><li><a href="MngmtEmpDraftQ.php?page=1">Employee Query&nbsp;&nbsp;<font style="font-weight:bold;color:#FF860D; font-size:12px;"><?php echo '(' . $rowQuery . ')'; ?></font></a></li>
                                            <?php } else {
                                                $sqlQuery = mysql_query("select * from hrm_employee_queryemp where Level_1ID=" . $EmployeeId . " AND (QStatus=0 OR QStatus=1) AND (Level_1QStatus=0 OR Level_1QStatus=1) AND QueryStatus_Emp!=3 AND QueryStatus_Emp!=4 AND '" . $CurrDate . "'>=Level_1QToDT AND '" . $CurrDate . "'<=Level_2QToDT order by QueryDT DESC", $con);
                                                $rowQuery = mysql_num_rows($sqlQuery); ?><li><a href="EmpDraftQ.php?page=1">Employee Query&nbsp;&nbsp;<font style="font-weight:bold;color:#FF860D; font-size:12px;"><?php echo '(' . $rowQuery . ')'; ?></font></a></li><?php } ?>

                                            <?php if ($rowApp > 0 and $rowHod > 0) {
                                                $sqlQA = mysql_query("select * from hrm_employee_queryemp where Level_2ID=" . $EmployeeId . " AND (QStatus=0 OR QStatus=1) AND (Level_2QStatus=0 OR Level_2QStatus=1) AND '" . date('Y-m-d h:i:s') . "'>=Level_2QToDT AND '" . date('Y-m-d h:i:s') . "'<=Level_3QToDT", $con);
                                                $rowQA = mysql_num_rows($sqlQA);
                                                $sqlQH = mysql_query("select * from hrm_employee_queryemp where Level_3ID=" . $EmployeeId . " AND (QStatus=0 OR QStatus=1) AND (Level_3QStatus=0 OR Level_3QStatus=1) AND '" . date('Y-m-d h:i:s') . "'>=Level_3QToDT AND '" . date('Y-m-d h:i:s') . "'<=Mngmt_QToDT", $con);
                                                $rowQH = mysql_num_rows($sqlQH);
                                                $QAH = $rowQA + $rowQH;
                                            } elseif ($rowApp > 0 and $rowHod == 0) {
                                                $sqlQA = mysql_query("select * from hrm_employee_queryemp where Level_2ID=" . $EmployeeId . " AND (QStatus=0 OR QStatus=1) AND (Level_2QStatus=0 OR Level_2QStatus=1) AND '" . date('Y-m-d h:i:s') . "'>=Level_2QToDT AND '" . date('Y-m-d h:i:s') . "'<=Level_3QToDT", $con);
                                                $rowQA = mysql_num_rows($sqlQA);
                                            } elseif ($rowApp == 0 and $rowHod > 0) {
                                                $sqlQH = mysql_query("select * from hrm_employee_queryemp where Level_3ID=" . $EmployeeId . " AND (QStatus=0 OR QStatus=1) AND (Level_3QStatus=0 OR Level_3QStatus=1) AND '" . date('Y-m-d h:i:s') . "'>=Level_3QToDT AND '" . date('Y-m-d h:i:s') . "'<=Mngmt_QToDT", $con);
                                            ...
                                            <?php if ($rowApp > 0 or $rowHod > 0) { ?>
                                                <li><a href="<?php if ($rowApp > 0 and $rowHod > 0) {
                                                                    echo 'AppMyTeamDraftQ.php?page=1';
                                                                } elseif ($rowApp > 0 and $rowHod == 0) {
                                                                    echo 'AppMyTeamDraftQ.php?page=1';
                                                                } elseif ($rowApp == 0 and $rowHod > 0) {
                                                                    echo 'HodMyTeamDraftQ.php?page=1';
                                                                } //MyTeamDraftQ.php
                                                                ?>">Escalated Query&nbsp;&nbsp;<font style="font-weight:bold;color:#FF860D; font-size:12px;">(<?php if ($rowApp > 0 and $rowHod > 0) {
                                                                                                                                                                                                                                                                                                                                                                                                    echo $QAH;
                                                                                                                                                                                                                                                                                                                                                                                                } elseif ($rowApp > 0 and $rowHod == 0) {
                                                                                                                                                                                                                                                                                                                                                                                                    echo $rowQA;
                                                                                                                                                                                                                                                                                                                                                                                                } elseif ($rowApp == 0 and $rowHod > 0) {
                                                ...
                                                <li><a href="<?php if ($rowApp > 0 and $rowHod > 0) {
                                                                    echo 'AppMyTeamPostQuery.php?page=1';
                                                                } elseif ($rowApp > 0 and $rowHod == 0) {
                                                                    echo 'AppMyTeamPostQuery.php?page=1';
                                                                } elseif ($rowApp == 0 and $rowHod > 0) {
                                                                    echo 'HodMyTeamPostQuery.php?page=1';
                                                                } ?>">View Team Query</a></li>
                                            <?php } ?>
...
<?php /* OPEN TEAMDETAILS OPEN TEAMDETAILS OPEN TEAMDETAILS OPEN TEAMDETAILS OPEN TEAMDETAILS OPEN TEAMDETAILS*************************** */ ?>
                                ...
                                <?php if ($rowApp > 0 or $rowHod > 0 or $resv['MoveRep'] == 'Y') { ?>
                                    <?php $CFromDate = date("Y-m-01");
                                    $CToDate = date("Y") . '-12-31';
                                    $sqlD_A = mysql_query("select * from hrm_employee_applyleave where Apply_SentToApp=" . $EmployeeId . " AND (LeaveStatus=0 OR LeaveStatus=1) AND (LeaveAppStatus=0 OR LeaveAppStatus=1) AND Apply_FromDate>='" . $CFromDate . "' AND LeaveEmpCancelStatus='N'", $con);
                                    $rowDP_A = mysql_num_rows($sqlD_A);
                                    $sqlD_H = mysql_query("select * from hrm_employee_applyleave where Apply_SentToHOD=" . $EmployeeId . " AND (LeaveStatus=0 OR LeaveStatus=1) AND (LeaveHodStatus=0 OR LeaveHodStatus=1) AND Apply_FromDate>='" . $CFromDate . "' AND Leave_Type='PL' AND LeaveEmpCancelStatus='N'", $con);
                                    $rowDP_H = mysql_num_rows($sqlD_H);
                                    $sqlC_A = mysql_query("select * from hrm_employee_applyleave where Apply_SentToApp=" . $EmployeeId . " AND LeaveEmpCancelStatus='Y' AND LeaveCancelStatus='N' AND Apply_FromDate>='" . $CFromDate . "'", $con);
                                    $rowC_A = mysql_num_rows($sqlC_A);
                                    $sqlC_H = mysql_query("select * from hrm_employee_applyleave where Apply_SentToHOD=" . $EmployeeId . " AND LeaveEmpCancelStatus='Y' AND LeaveCancelStatus='N' AND Apply_FromDate>='" . $CFromDate . "'", $con);
                                    $rowC_H = mysql_num_rows($sqlC_H); //$AHL=$rowDP_A+$rowDP_H; 
                                    $sqlD_R = mysql_query("select * from hrm_employee_applyleave where Apply_SentToRev=" . $EmployeeId . " AND (LeaveStatus=0 OR LeaveStatus=1) AND (LeaveHodStatus=0 OR LeaveHodStatus=1) AND Apply_FromDate>='" . $CFromDate . "' AND Leave_Type='PL' AND LeaveEmpCancelStatus='N'", $con);
                                    $rowDP_R = mysql_num_rows($sqlD_R);
                                    ...
                                    <li class="top"><a href="#nogo22" class="top_link"><span class="down">Team Details</span></a>
                                        <ul class="sub">
                                                ...
                                                <li><a href="#" class="fly">Leave Application</a>
                                                    <ul>
                                                        ...
                                                        if ($rowApp > 0 and $rowHod == 0) { ?>
                                                            ...
                                                            <li><a href="CLeave.php">Cancelled Leave&nbsp;&nbsp;<font style="font-weight:bold;color:#FF860D; font-size:12px;"><?php echo '(' . $rowC_A . ')'; ?></font></a></li>
                                                        <?php }
                                                        if ($rowApp == 0 and ($rowHod > 0 or $rowRev > 0)) { ?>
                                            ...
                                            <?php $cFDate = date("Y") . '-' . date("m") . '-01';
                                            $cTDate = date("Y") . '-' . date("m") . '-31';
                                            $sAttR = mysql_query("select * from hrm_employee_attendance_req where AttDate>='" . date("Y-m-01") . "' AND AttDate<='" . date("Y-12-31") . "' AND RId=" . $EmployeeId . " AND Status=0", $con);
                                            $rowAttR = mysql_num_rows($sAttR);  ?>
                                            ...
                                            <?php $sqlDept = mysql_query("select DepartmentId,Req_DrivLic,KRAUnBlock from hrm_employee_general where EmployeeID=" . $EmployeeId, $con);
...
<?php if($rowApp==0 AND $rowHod>0) { ?> <li><a href="AttHodMorEve.php?m=<?php echo date("m"); ?>&da=<?php echo date("d"); ?>&Y=<?php echo date("Y"); ?>&e=4e&w=234&tt=10234&a=f&e=4e2&e=4e&w=234&tt=110022344&retd=ee&wwrew=t%T@sed818&d=101">Morning-Evening Reports</a></li><?php } */ ?>
  ...
  if($rowst>0){while($rpvt=mysql_fetch_array($rpt)){$array_et[]=$rpvt['EmployeeID'];} $eet = implode(',', $array_et);}
            ...
            $resch = mysql_fetch_assoc($sqlch);  ?>
        
            <?php
       
            if ($CompanyId != 1 or $EmployeeId == 461 or $EmployeeId == 223 or $EmployeeId == 224 or $EmployeeId == 6 or $EmployeeId == 7 or $EmployeeId == 52 or $EmployeeId == 51 or $EmployeeId == 89 or $resDept['KRAUnBlock'] == 'Y' 
            or ($RD['DateJoining'] >= '2024-01-01' and date("Y-m-d") <= $After31DayDoJ) or ($RD['DateJoining'] >= '2024-01-01' and date("Y-m-d") > $After31DayDoJ and $rowkk2 > 0) or 
            ($RD['DateJoining'] < '2024-01-01' and date("Y-m-d") <= $KSch['EmpToDate']) or ($RD['DateJoining'] < '2024-01-01' and date("Y-m-d") > $KSch['EmpToDate'] and $rowkk2 > 0) or $rowch > 0) {
            ...
            ?>
                    ...
                    <?php if ($resCer['ProfileCertify'] == 'Y' or $EmployeeId == 223 or $EmployeeId == 461 or $EmployeeId == 224 or $EmployeeId == 233 or $EmployeeId == 234 or $EmployeeId == 235 or $EmployeeId == 259 or $EmployeeId == 260 or $EmployeeId == 6 or $EmployeeId == 7 or $EmployeeId == 52 or $EmployeeId == 51 or $EmployeeId == 89 or $EmployeeId == 1123 or $rowch > 0) {
                        /********* Check Certify 22 OPEN *********/ ?>
                                ...
                                <ul class="sub">
                                    ...
                                    <?php if ($rowApp > 0 or $rowHod > 0) { ?>
                                        <li><a href="#" class="fly">Team Resignation</a>
                                            <ul>
                                                <li><a href="TeamSprtion.php?e=4e&w=234&y=10234&a=<?php if (($rowApp > 0 and $rowHod > 0) or ($rowApp > 0 and $rowHod == 0)) {
                                                                                                        echo 'app';
                                                                                                    } elseif ($rowApp == 0 and $rowHod > 0) {
                                                                                                        echo 'hod';
                                                                                                    } ?>&e=4e2&e=4e&w=234&y=110022344&retd=ee&rr=09drfGe&S=eewwqq&wwrew=t%T@sed818&d=101">Apply Resignation</a></li>
                                                <li><a href="TeamCancelSprtion.php?e=4e&w=234&y=10234&a=<?php if (($rowApp > 0 and $rowHod > 0) or ($rowApp > 0 and $rowHod == 0)) {
                                                                                                            echo 'app';
                                                                                                        } elseif ($rowApp == 0 and $rowHod > 0) {
                                                                                                            echo 'hod';
                                                                                                        } ?>&e=4e2&e=4e&w=234&y=110022344&retd=ee&rr=09drfGe&S=eewwqq&wwrew=t%T@sed818&d=101">Apply Cancel Resignation</a></li>
                                            </ul>
                                        </li>
                                    <?php } ?>
                                    <?php if ($rowApp > 0) { ?>
                                    ...
                                    $rowLog = mysql_num_rows($sqlLog);
                                    if ($rowLog > 0) {
                                        $resLog = mysql_fetch_assoc($sqlLog); ?>
                                    ...
                                    <?php } ?>
                                    <?php $sqlNoc = mysql_query("select DepartmentId from hrm_employee_separation_nocdept_emp where EmployeeID=" . $EmployeeId . " AND Status='A'", $con);
                                    $rowNoc = mysql_num_rows($sqlNoc);
                                    if ($rowNoc > 0) {
            ...
            <?php if ($rowResig == 0) {
                ...
                ?>
                    ...
                    ?>
                        ...
                        $Lch = mysql_query("select * from hrm_sales_useremp where UserEmpId=" . $EmployeeId . " AND Status='A'", $con);
                        $rowLch = mysql_num_rows($Lch); ?>
                        <?php if (($rdept['DepartmentId'] == 5 or $rdept['DepartmentId'] == 7 or $rdept['DepartmentId'] == 8 or $rdept['DepartmentId'] == 11 or $rdept['DepartmentId'] == 12) and $rowLch > 0) { ?>
                            <li class="top"><a href="#" onclick="OpenSUserPlan(<?php echo $EmployeeId; ?>)" class="top_link">Sales Module</a></li>
                        <?php } elseif ($rdept['DepartmentId'] == 15 and $EmployeeId != 51 and $EmployeeId != 84) { ?>
                            <li class="top"><a href="#" onclick="OpenSEmpPlan(<?php echo $EmployeeId; ?>)" class="top_link">Sales Module</a></li>
                        <?php } elseif (($rdept['DepartmentId'] == 6 or $rdept['DepartmentId'] == 17 or $rdept['DepartmentId'] == 18 or $rdept['DepartmentId'] == 23) and ($EmployeeId == 51 or $EmployeeId == 84) and $rowLch > 0) { ?>
