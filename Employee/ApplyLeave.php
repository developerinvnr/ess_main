...
//**************************** Previous *********************************//   
  ...
  //AttValue='SL' OR AttValue='SH' OR AttValue='ASH' OR 
  $P1OTa=mysql_query("select AttId from hrm_employee_attendance where (AttValue='PL' OR AttValue='APH' OR AttValue='EL' OR AttValue='FL' OR AttValue='TL') AND EmployeeID=".$EmployeeId." AND AttDate='".$P1."'", $con);
  $P2OTa=mysql_query("select AttId from hrm_employee_attendance where (AttValue='PL' OR AttValue='APH' OR AttValue='EL' OR AttValue='FL' OR AttValue='TL') AND EmployeeID=".$EmployeeId." AND AttDate='".$P2."'", $con); 
  $P3OTa=mysql_query("select AttId from hrm_employee_attendance where (AttValue='PL' OR AttValue='APH' OR AttValue='EL' OR AttValue='FL' OR AttValue='TL') AND EmployeeID=".$EmployeeId." AND AttDate='".$P3."'", $con); 
  $P4OTa=mysql_query("select AttId from hrm_employee_attendance where (AttValue='PL' OR AttValue='APH' OR AttValue='EL' OR AttValue='FL' OR AttValue='TL') AND EmployeeID=".$EmployeeId." AND AttDate='".$P4."'", $con); 
  $rP1OTa=mysql_num_rows($P1OTa); $rP2OTa=mysql_num_rows($P2OTa); $rP3OTa=mysql_num_rows($P3OTa); $rP4OTa=mysql_num_rows($P4OTa);
  $P1OTp=mysql_query("select ApplyLeaveId from hrm_employee_applyleave where (Leave_Type!='CL' AND Leave_Type!='CH' AND Leave_Type!='SL' AND Leave_Type!='SH') AND LeaveStatus!=4 AND LeaveStatus!=3 AND EmployeeID=".$EmployeeId." AND Apply_ToDate='".$P1."'", $con); 
  $P2OTp=mysql_query("select ApplyLeaveId from hrm_employee_applyleave where (Leave_Type!='CL' AND Leave_Type!='CH' AND Leave_Type!='SL' AND Leave_Type!='SH') AND LeaveStatus!=4 AND LeaveStatus!=3 AND EmployeeID=".$EmployeeId." AND Apply_ToDate='".$P2."'", $con); 
  $P3OTp=mysql_query("select ApplyLeaveId from hrm_employee_applyleave where (Leave_Type!='CL' AND Leave_Type!='CH' AND Leave_Type!='SL' AND Leave_Type!='SH') AND LeaveStatus!=4 AND LeaveStatus!=3 AND EmployeeID=".$EmployeeId." AND Apply_ToDate='".$P3."'", $con); 
  $P4OTp=mysql_query("select ApplyLeaveId from hrm_employee_applyleave where (Leave_Type!='CL' AND Leave_Type!='CH' AND Leave_Type!='SL' AND Leave_Type!='SH') AND LeaveStatus!=4 AND LeaveStatus!=3 AND EmployeeID=".$EmployeeId." AND Apply_ToDate='".$P4."'", $con); 
...
//**************************** Next *********************************// 
  ...
  //AttValue='SL' OR AttValue='SH' OR AttValue='ASH' OR 
  $N1OTa=mysql_query("select AttId from hrm_employee_attendance where (AttValue='PL' OR AttValue='APH' OR AttValue='EL' OR AttValue='FL' OR AttValue='TL') AND EmployeeID=".$EmployeeId." AND AttDate='".$N1."'", $con);
  $N2OTa=mysql_query("select AttId from hrm_employee_attendance where (AttValue='PL' OR AttValue='APH' OR AttValue='EL' OR AttValue='FL' OR AttValue='TL') AND EmployeeID=".$EmployeeId." AND AttDate='".$N2."'", $con); 
  $N3OTa=mysql_query("select AttId from hrm_employee_attendance where (AttValue='PL' OR AttValue='APH' OR AttValue='EL' OR AttValue='FL' OR AttValue='TL') AND EmployeeID=".$EmployeeId." AND AttDate='".$N3."'", $con); 
  $N4OTa=mysql_query("select AttId from hrm_employee_attendance where (AttValue='PL' OR AttValue='APH' OR AttValue='EL' OR AttValue='FL' OR AttValue='TL') AND EmployeeID=".$EmployeeId." AND AttDate='".$N4."'", $con); 
  $rN1OTa=mysql_num_rows($N1OTa); $rN2OTa=mysql_num_rows($N2OTa); $rN3OTa=mysql_num_rows($N3OTa); $rN4OTa=mysql_num_rows($N4OTa);
  $N1OTp=mysql_query("select ApplyLeaveId from hrm_employee_applyleave where (Leave_Type!='CL' AND Leave_Type!='CH' AND Leave_Type!='SL' AND Leave_Type!='SH') AND LeaveStatus!=4 AND LeaveStatus!=3 AND EmployeeID=".$EmployeeId." AND Apply_FromDate='".$N1."'", $con); 
  $N2OTp=mysql_query("select ApplyLeaveId from hrm_employee_applyleave where (Leave_Type!='CL' AND Leave_Type!='CH' AND Leave_Type!='SL' AND Leave_Type!='SH') AND LeaveStatus!=4 AND LeaveStatus!=3 AND EmployeeID=".$EmployeeId." AND Apply_FromDate='".$N2."'", $con); 
  $N3OTp=mysql_query("select ApplyLeaveId from hrm_employee_applyleave where (Leave_Type!='CL' AND Leave_Type!='CH' AND Leave_Type!='SL' AND Leave_Type!='SH') AND LeaveStatus!=4 AND LeaveStatus!=3 AND EmployeeID=".$EmployeeId." AND Apply_FromDate='".$N3."'", $con); 
  $N4OTp=mysql_query("select ApplyLeaveId from hrm_employee_applyleave where (Leave_Type!='CL' AND Leave_Type!='CH' AND Leave_Type!='SL' AND Leave_Type!='SH') AND LeaveStatus!=4 AND LeaveStatus!=3 AND EmployeeID=".$EmployeeId." AND Apply_FromDate='".$N4."'", $con); 
...
$Ctime = date("H:i:s");
$FFDate=date("Y-m-d H:i:s".$Ctime,strtotime($_POST['FromDate'])); 
$TodayDate=date("Y-m-d 09:30:00");

if($AppFromDate<date("Y-m-d") && $_POST['LeaveType']!='SL'){ $msg='You can apply only current or future date'; }
elseif($AppFromDate<date("Y-m-d") && ($_POST['LeaveType']=='SL' OR $_POST['LeaveType']=='SH')){ $msg='You can apply only current date'; }
elseif($AppFromDate==date("Y-m-d") && $FFDate>$TodayDate && $_POST['LeaveType']!='SH' && $_POST['LeaveType']!='SL' && $_POST['LeaveType']!='CH' && $_POST['LeaveType']!='HF'){ $msg='You can apply only before 9:30 AM'; }   
...
elseif(($_POST['LeaveType']=='CL' OR $_POST['LeaveType']=='CH') AND $rP1CLa>0 AND ($PNum2==7 OR $rP2HOa>0) AND $rP3CHa>0 AND $rP4CHa>0){$msg='Error!.. CL can be taken maximum for 2 days.!'; }
elseif(($_POST['LeaveType']=='CL' OR $_POST['LeaveType']=='CH') AND $rP1CLp>0 AND ($PNum2==7 OR $rP2HOa>0) AND $rP3CHp>0 AND $rP4CHp>0){$msg='Error!.. CL can be taken maximum for 2 days.!'; }
elseif(($_POST['LeaveType']=='CL' OR $_POST['LeaveType']=='CH') AND $rP1CHa>0 AND $rP2CHa>0 AND ($PNum3==7 OR $rP3HOa>0) AND $rP4CHa>0 AND $rP5CHa>0){$msg='Error!.. CL can be taken maximum for 2 days.!'; }
elseif(($_POST['LeaveType']=='CL' OR $_POST['LeaveType']=='CH') AND $rP1CHp>0 AND $rP2CHp>0 AND ($PNum3==7 OR $rP3HOa>0) AND $rP4CHp>0 AND $rP5CHp>0){$msg='Error!.. CL can be taken maximum for 2 days.!'; }
elseif(($_POST['LeaveType']=='CL' OR $_POST['LeaveType']=='CH') AND $rP1CHa>0 AND $rP2CLa>0 AND ($PNum3==7 OR $rP3HOa>0) AND $rP4CHa>0){$msg='Error!.. CL can be taken maximum for 2 days.!'; }
elseif(($_POST['LeaveType']=='CL' OR $_POST['LeaveType']=='CH') AND $rP1CHp>0 AND $rP2CLp>0 AND ($PNum3==7 OR $rP3HOa>0) AND $rP4CHp>0){$msg='Error!.. CL can be taken maximum for 2 days.!'; }
elseif(($_POST['LeaveType']=='CL' OR $_POST['LeaveType']=='CH') AND $rP1CHa>0 AND ($PNum2==7 OR $rP2HOa>0) AND $rP3CLa>0 AND $rP4CHa>0){$msg='Error!.. CL can be taken maximum for 2 days.!'; }
elseif(($_POST['LeaveType']=='CL' OR $_POST['LeaveType']=='CH') AND $rP1CHp>0 AND ($PNum2==7 OR $rP2HOa>0) AND $rP3CLp>0 AND $rP4CHp>0){$msg='Error!.. CL can be taken maximum for 2 days.!'; }
...
elseif(($_POST['LeaveType']=='CL' OR $_POST['LeaveType']=='CH') AND ($PNum1==7 OR $rP1HOa>0) AND ($PNum2==7 OR $rP2HOa>0) AND $rP3CLa>0 AND $rP4CLa>0){ $msg='Error!.. CL can be taken maximum for 2 days.!'; }
elseif(($_POST['LeaveType']=='CL' OR $_POST['LeaveType']=='CH') AND ($PNum1==7 OR $rP1HOa>0) AND ($PNum2==7 OR $rP2HOa>0) AND $rP3CLp>0 AND $rP4CLp>0){ $msg='Error!.. CL can be taken maximum for 2 days.!'; }
elseif(($_POST['LeaveType']=='CL' OR $_POST['LeaveType']=='CH') AND ($PNum1==7 OR $rP1HOa>0) AND ($PNum2==7 OR $rP2HOa>0) AND ($PNum3==7 OR $rP3HOa>0) AND $rP4CLa>0 AND $rP5CLa>0){ $msg='Error!.. CL can be taken maximum for 2 days.!'; }
elseif(($_POST['LeaveType']=='CL' OR $_POST['LeaveType']=='CH') AND ($PNum1==7 OR $rP1HOa>0) AND ($PNum2==7 OR $rP2HOa>0) AND ($PNum3==7 OR $rP3HOa>0) AND $rP4CLp>0 AND $rP5CLp>0){ $msg='Error!.. CL can be taken maximum for 2 days.!'; }
elseif(($_POST['LeaveType']=='CL' OR $_POST['LeaveType']=='CH') AND $rP1CLp1>0){ $msg='Error!.. CL can be taken maximum for 2 days.!'; }
...
elseif(($_POST['LeaveType']=='CL' OR $_POST['LeaveType']=='CH') AND ($PNum1==7 OR $rP1HOa>0) AND ($PNum2==7 OR $rP2HOa>0) AND $rP1CLp3>0){ $msg='Error!.. CL can be taken maximum for 2 days.!'; }

elseif(($_POST['LeaveType']!='CL' AND $_POST['LeaveType']!='CH' AND $_POST['LeaveType']!='SL' AND $_POST['LeaveType']!='SH') AND ($rP1CLa>0 OR $rP1CHa>0)){ $msg='Error : CL can not be combined with any other leave!'; }
elseif(($_POST['LeaveType']!='CL' AND $_POST['LeaveType']!='CH' AND $_POST['LeaveType']!='SL' AND $_POST['LeaveType']!='SH') AND ($rP1CLp>0 OR $rP1CHp>0)){ $msg='Error : CL can not be combined with any other leave!'; }
elseif(($_POST['LeaveType']!='CL' AND $_POST['LeaveType']!='CH' AND $_POST['LeaveType']!='SL' AND $_POST['LeaveType']!='SH') AND ($PNum1==7 OR $rP1HOa>0) AND ($rP2CHa>0 OR $rP2CLa>0)){$msg='Error:CL can not be combined with any other leave!'; }
elseif(($_POST['LeaveType']!='CL' AND $_POST['LeaveType']!='CH' AND $_POST['LeaveType']!='SL' AND $_POST['LeaveType']!='SH') AND ($PNum1==7 OR $rP1HOa>0) AND ($rP2CHp>0 OR $rP2CLp>0)){$msg='Error:CL can not be combined with any other leave!'; }
elseif(($_POST['LeaveType']!='CL' AND $_POST['LeaveType']!='CH' AND $_POST['LeaveType']!='SL' AND $_POST['LeaveType']!='SH') AND ($PNum1==7 OR $rP1HOa>0) AND ($PNum2==7 OR $rP2HOa>0) AND ($rP3CLa>0 OR $rP3CHa>0)){ $msg='Error : CL can not be combined with any other leave!'; }
elseif(($_POST['LeaveType']!='CL' AND $_POST['LeaveType']!='CH' AND $_POST['LeaveType']!='SL' AND $_POST['LeaveType']!='SH') AND ($PNum1==7 OR $rP1HOa>0) AND ($PNum2==7 OR $rP2HOa>0) AND ($rP3CLp>0 OR $rP3CHp>0)){ $msg='Error : CL can not be combined with any other leave!'; }
elseif(($_POST['LeaveType']!='CL' AND $_POST['LeaveType']!='CH' AND $_POST['LeaveType']!='SL' AND $_POST['LeaveType']!='SH') AND ($PNum1==7 OR $rP1HOa>0) AND ($PNum2==7 OR $rP2HOa>0) AND ($PNum3==7 OR $rP3HOa>0) AND ($rP4CLa>0 OR $rP4CHa>0)){ $msg='Error : CL can not be combined with any other leave!'; }
elseif(($_POST['LeaveType']!='CL' AND $_POST['LeaveType']!='CH' AND $_POST['LeaveType']!='SL' AND $_POST['LeaveType']!='SH') AND ($PNum1==7 OR $rP1HOa>0) AND ($PNum2==7 OR $rP2HOa>0) AND ($PNum3==7 OR $rP3HOa>0) AND ($rP4CLp>0 OR $rP4CHp>0)){ $msg='Error : CL can not be combined with any other leave!'; }
...
elseif(($_POST['LeaveType']=='CL' OR $_POST['LeaveType']=='CH') AND ($PNum1==7 OR $rP1HOa>0) AND ($PNum2==7 OR $rP2HOa>0) AND $rP3OTa>0){ $msg='Error : CL can not be combined with any other leave!'; }
elseif(($_POST['LeaveType']=='CL' OR $_POST['LeaveType']=='CH') AND ($PNum1==7 OR $rP1HOa>0) AND ($PNum2==7 OR $rP2HOa>0) AND $rP3OTp>0){ $msg='Error : CL can not be combined with any other leave!'; }
elseif(($_POST['LeaveType']=='CL' OR $_POST['LeaveType']=='CH') AND ($PNum1==7 OR $rP1HOa>0) AND ($PNum2==7 OR $rP2HOa>0) AND ($PNum3==7 OR $rP3HOa>0) AND $rP4OTa>0){ $msg='Error : CL can not be combined with any other leave!'; }
elseif(($_POST['LeaveType']=='CL' OR $_POST['LeaveType']=='CH') AND ($PNum1==7 OR $rP1HOa>0) AND ($PNum2==7 OR $rP2HOa>0) AND ($PNum3==7 OR $rP3HOa>0) AND $rP4OTp>0){ $msg='Error : CL can not be combined with any other leave!'; }
...
elseif(($_POST['LeaveType']=='CL' OR $_POST['LeaveType']=='CH') AND $rN1CLa>0 AND ($NNum2==7 OR $rN2HOa>0) AND $rN3CHa>0 AND $rN4CHa>0){$msg='Error!.. CL can be taken maximum for 2 days.!'; }
elseif(($_POST['LeaveType']=='CL' OR $_POST['LeaveType']=='CH') AND $rN1CLp>0 AND ($NNum2==7 OR $rN2HOa>0) AND $rN3CHp>0 AND $rN4CHp>0){$msg='Error!.. CL can be taken maximum for 2 days.!'; }
elseif(($_POST['LeaveType']=='CL' OR $_POST['LeaveType']=='CH') AND $rN1CHa>0 AND $rN2CHa>0 AND ($NNum3==7 OR $rN3HOa>0) AND $rN4CHa>0 AND $rN5CHa>0){$msg='Error!.. CL can be taken maximum for 2 days.!'; }
elseif(($_POST['LeaveType']=='CL' OR $_POST['LeaveType']=='CH') AND $rN1CHp>0 AND $rN2CHp>0 AND ($NNum3==7 OR $rN3HOa>0) AND $rN4CHp>0 AND $rN5CHp>0){$msg='Error!.. CL can be taken maximum for 2 days.!'; }
elseif(($_POST['LeaveType']=='CL' OR $_POST['LeaveType']=='CH') AND $rN1CHa>0 AND $rN2CLa>0 AND ($NNum3==7 OR $rN3HOa>0) AND $rN4CHa>0){$msg='Error!.. CL can be taken maximum for 2 days.!'; }
elseif(($_POST['LeaveType']=='CL' OR $_POST['LeaveType']=='CH') AND $rN1CHp>0 AND $rN2CLp>0 AND ($NNum3==7 OR $rN3HOa>0) AND $rN4CHp>0){$msg='Error!.. CL can be taken maximum for 2 days.!'; }
elseif(($_POST['LeaveType']=='CL' OR $_POST['LeaveType']=='CH') AND $rN1CHa>0 AND ($NNum2==7 OR $rN2HOa>0) AND $rN3CLa>0 AND $rN4CHa>0){$msg='Error!.. CL can be taken maximum for 2 days.!'; }
elseif(($_POST['LeaveType']=='CL' OR $_POST['LeaveType']=='CH') AND $rN1CHp>0 AND ($NNum2==7 OR $rN2HOa>0) AND $rN3CLp>0 AND $rN4CHp>0){$msg='Error!.. CL can be taken maximum for 2 days.!'; }
...
elseif(($_POST['LeaveType']=='CL' OR $_POST['LeaveType']=='CH') AND ($NNum1==7 OR $rN1HOa>0) AND ($NNum2==7 OR $rN2HOa>0) AND $rN3CLa>0 AND $rN4CLa>0){ $msg='Error!.. CL can be taken maximum for 2 days.!'; }
elseif(($_POST['LeaveType']=='CL' OR $_POST['LeaveType']=='CH') AND ($NNum1==7 OR $rN1HOa>0) AND ($NNum2==7 OR $rN2HOa>0) AND $rN3CLp>0 AND $rN4CLp>0){ $msg='Error!.. CL can be taken maximum for 2 days.!'; }
elseif(($_POST['LeaveType']=='CL' OR $_POST['LeaveType']=='CH') AND ($NNum1==7 OR $rN1HOa>0) AND ($NNum2==7 OR $rN2HOa>0) AND ($NNum3==7 OR $rN3HOa>0) AND $rN4CLa>0 AND $rN5CLa>0){ $msg='Error!.. CL can be taken maximum for 2 days.!'; }
elseif(($_POST['LeaveType']=='CL' OR $_POST['LeaveType']=='CH') AND ($NNum1==7 OR $rN1HOa>0) AND ($NNum2==7 OR $rN2HOa>0) AND ($NNum3==7 OR $rN3HOa>0) AND $rN4CLp>0 AND $rN5CLp>0){ $msg='Error!.. CL can be taken maximum for 2 days.!'; }
elseif(($_POST['LeaveType']=='CL' OR $_POST['LeaveType']=='CH') AND $rN1CLp1>0){ $msg='Error!.. CL can be taken maximum for 2 days.!'; }
...
elseif(($_POST['LeaveType']=='CL' OR $_POST['LeaveType']=='CH') AND ($NNum1==7 OR $rN1HOa>0) AND ($NNum2==7 OR $rN2HOa>0) AND $rN1CLp3>0){ $msg='Error!.. CL can be taken maximum for 2 days.!'; }

elseif(($_POST['LeaveType']!='CL' AND $_POST['LeaveType']!='CH' AND $_POST['LeaveType']!='SL' AND $_POST['LeaveType']!='SH') AND ($rN1CLa>0 OR $rN1CHa>0)){ $msg='Error : CL can not be combined with any other leave!'; }
elseif(($_POST['LeaveType']!='CL' AND $_POST['LeaveType']!='CH' AND $_POST['LeaveType']!='SL' AND $_POST['LeaveType']!='SH') AND ($rN1CLp>0 OR $rN1CHp>0)){ $msg='Error : CL can not be combined with any other leave!'; }
elseif(($_POST['LeaveType']!='CL' AND $_POST['LeaveType']!='CH' AND $_POST['LeaveType']!='SL' AND $_POST['LeaveType']!='SH') AND ($NNum1==7 OR $rN1HOa>0) AND ($rN2CHa>0 OR $rN2CLa>0)){$msg='Error:CL can not be combined with any other leave!'; }
elseif(($_POST['LeaveType']!='CL' AND $_POST['LeaveType']!='CH' AND $_POST['LeaveType']!='SL' AND $_POST['LeaveType']!='SH') AND ($NNum1==7 OR $rN1HOa>0) AND ($rN2CHp>0 OR $rN2CLp>0)){$msg='Error:CL can not be combined with any other leave!'; }
elseif(($_POST['LeaveType']!='CL' AND $_POST['LeaveType']!='CH' AND $_POST['LeaveType']!='SL' AND $_POST['LeaveType']!='SH') AND ($NNum1==7 OR $rN1HOa>0) AND ($NNum2==7 OR $rN2HOa>0) AND ($rN3CLa>0 OR $rN3CHa>0)){ $msg='Error : CL can not be combined with any other leave!'; }
elseif(($_POST['LeaveType']!='CL' AND $_POST['LeaveType']!='CH' AND $_POST['LeaveType']!='SL' AND $_POST['LeaveType']!='SH') AND ($NNum1==7 OR $rN1HOa>0) AND ($NNum2==7 OR $rN2HOa>0) AND ($rN3CLp>0 OR $rN3CHp>0)){ $msg='Error : CL can not be combined with any other leave!'; }
elseif(($_POST['LeaveType']!='CL' AND $_POST['LeaveType']!='CH' AND $_POST['LeaveType']!='SL' AND $_POST['LeaveType']!='SH') AND ($NNum1==7 OR $rN1HOa>0) AND ($NNum2==7 OR $rN2HOa>0) AND ($NNum3==7 OR $rN3HOa>0) AND ($rN4CLa>0 OR $rN4CHa>0)){ $msg='Error : CL can not be combined with any other leave!'; }
elseif(($_POST['LeaveType']!='CL' AND $_POST['LeaveType']!='CH' AND $_POST['LeaveType']!='SL' AND $_POST['LeaveType']!='SH') AND ($NNum1==7 OR $rN1HOa>0) AND ($NNum2==7 OR $rN2HOa>0) AND ($NNum3==7 OR $rN3HOa>0) AND ($rN4CLp>0 OR $rN4CHp>0)){ $msg='Error : CL can not be combined with any other leave!'; }
...
elseif(($_POST['LeaveType']=='CL' OR $_POST['LeaveType']=='CH') AND ($NNum1==7 OR $rN1HOa>0) AND ($NNum2==7 OR $rN2HOa>0) AND $rN3OTa>0){ $msg='Error : CL can not be combined with any other leave!'; }
elseif(($_POST['LeaveType']=='CL' OR $_POST['LeaveType']=='CH') AND ($NNum1==7 OR $rN1HOa>0) AND ($NNum2==7 OR $rN2HOa>0) AND $rN3OTp>0){ $msg='Error : CL can not be combined with any other leave!'; }
elseif(($_POST['LeaveType']=='CL' OR $_POST['LeaveType']=='CH') AND ($NNum1==7 OR $rN1HOa>0) AND ($NNum2==7 OR $rN2HOa>0) AND ($NNum3==7 OR $rN3HOa>0) AND $rN4OTa>0){ $msg='Error : CL can not be combined with any other leave!'; }
elseif(($_POST['LeaveType']=='CL' OR $_POST['LeaveType']=='CH') AND ($NNum1==7 OR $rN1HOa>0) AND ($NNum2==7 OR $rN2HOa>0) AND ($NNum3==7 OR $rN3HOa>0) AND $rN4OTp>0){ $msg='Error : CL can not be combined with any other leave!'; }
else
...
{ var d1 = AskQform.FromDate.value; var d2 = AskQform.ToDate.value; 
  ...
  { if(New_date1==NextDate)     
    { if(LastAppL=='PL' || LastAppL=='EL' || LastAppL=='PH' || LastAppL=='FL') { alert("Error!.. CL can't be combined with any other leave."); return false; }  ////LastAppL=='SL' || || LastAppL=='SH'
  ...
  { 
  if(New_date1==NextDate)
    { if(LastAppL=='PL' || LastAppL=='EL' || LastAppL=='PH' || LastAppL=='FL') { alert("Error!.. Half Day of CL can't be combined with any other leave."); return false; } //LastAppL=='SH' || LastAppL=='SL' 
	  if(LastAppL=='CL' && LastAppLTotDay>=2) { alert("Error!.. Leave already applied for given dates."); return false; }
	} 
  ...
  if(LeaveType=='PL')
  { if(AppNOTimePL>3) { alert("PL cannot be applied more then thrice"); return false;}
