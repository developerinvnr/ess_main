...
?> 			
     ...
     <?php if($rL['Show_GradeDesig']=='Y'){ ?>
     <td class="tdl">&nbsp;<?php echo strtoupper($ResRep['DesigName']); ?>
     
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     <?php if($EmployeeId==1413 && $DepartmentId==9){
     echo '<a href="../AdminUser/EmpIncHis_Emp.php?action=Inc&V='.$ResRep['EmpCode'].'&C='.$CompanyId.'" target="_blank" style="color:#000000;text-decoration:none;">..</a>';
     } ?>
