...
{  
 $sqCheck=mysql_query("select * from hrm_pms_vertical_increment where VerticalId=".$_POST['VerticalId']." AND SectionId=".$_POST['SectionId']." AND Min_GradeId=".$_POST['Min_GradeId']." AND Max_GradeId=".$_POST['Max_GradeId']."",$con); $rowCheck=mysql_num_rows($sqCheck);
 
 if($rowCheck==0)
 {
 $SqlInseart = mysql_query("INSERT INTO hrm_pms_vertical_increment(DepId, VerticalId, SectionId, Min_GradeId, Max_GradeId, Min_Ctc, Max_Ctc, ComId, crby, crdate) VALUES('".$_POST['DepId']."', '".$_POST['VerticalId']."', '".$_POST['SectionId']."', '".$_POST['Min_GradeId']."', '".$_POST['Max_GradeId']."', '".$_POST['Min_Ctc']."', '".$_POST['Max_Ctc']."', ".$CompanyId.", ".$UserId.", '".date('Y-m-d')."')", $con);  
