...
&nbsp;&nbsp;
    &nbsp;&nbsp;&nbsp;&nbsp;<u>Total Proposed CTC</u>&nbsp;:&nbsp;<input class="rinput" style="width:120px;" id="MyTTProGross_22" value="<?php echo $TotNewGrossPM; ?>" />&nbsp;&nbsp;&nbsp;&nbsp;<u>Total Increment</u>&nbsp;:&nbsp;<input class="rinput" style="width:100px;" id="MyTTIncGross_22" value="<?php echo $Increment; ?>"/>&nbsp;<input class="rinput" style="width:60px;" id="MyTTIncGrossPercent_22" value="<?php echo $PerInc; ?>"/>&nbsp;%&nbsp;&nbsp;&nbsp;&nbsp;<u>SC</u>&nbsp;:&nbsp;<input class="rinput" style="width:60px;" id="MyTTSCPercent_22" value="<?php echo $TotalTPerPSC; ?>" />&nbsp;%
	 ...
	 //$sql3=mysql_query("select EmpPmsId from hrm_employee_pms where AssessmentYear=".$_SESSION['PmsYId']." AND HOD_EmployeeID=".$EmployeeId." AND Hod_IncNetMonthalySalary>0 AND HodSubmit_IncStatus=1", $con);
...
if($res['EmployeeID']!=108 AND $res['EmployeeID']!=179 AND $res['EmployeeID']!=209 AND $res['DepartmentId']==2 AND ($res['EmpVertical']==17 OR $res['EmpVertical']==18) AND $_SESSION['PmsYId']==11)
{ 
...
<?php //$sql3=mysql_query("select EmpPmsId from hrm_employee_pms where AssessmentYear=".$_SESSION['PmsYId']." AND HOD_EmployeeID=".$EmployeeId." AND Hod_IncNetMonthalySalary>0 AND HodSubmit_IncStatus=1", $con); 
