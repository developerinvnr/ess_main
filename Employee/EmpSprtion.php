...
{ 
  ...
  $sqlEmp=mysql_query("select EmpCode,Fname,Sname,Lname,g.DepartmentId,EmailId_Vnr,CostCenter,gr.GradeId,DepartmentCode,DepartmentName,GradeValue,DesigName,HqName,StateName from hrm_employee_general g left join hrm_employee e on g.EmployeeID=e.EmployeeID left join hrm_department d on g.DepartmentId=d.DepartmentId left join hrm_grade gr on g.GradeId=gr.GradeId left join hrm_designation de on g.DesigId=de.DesigId left join hrm_headquater hq on g.HqId=hq.HqId left join hrm_state st on g.CostCenter=st.StateId where g.EmployeeID=".$EmployeeId, $con); 
  $resEmp=mysql_fetch_assoc($sqlEmp); $Ename=$resEmp['Fname'].' '.$resEmp['Sname'].' '.$resEmp['Lname'];
  ...
  else
  {
   ...
   ///******************* Open Open **************************///
   $MaxId=0;
   $sqlq=mysql_query("select max(EmpSepId) as SepId from hrm_employee_separation",$con); $resq=mysql_fetch_assoc($sqlq);
   $MaxId=$resq['SepId']+1;
    
	/*********** Upload Document Open *************/
     $filename=strtolower(basename($_FILES['SCopy']['name'])); 
     $fileSize=$_FILES['SCopy']['size'];
     $type = $_FILES['SCopy']['type'];
     $ext = substr($filename, strrpos($filename, '.') + 1); 
     $EmpPhoto  = addslashes (fread (fopen($_FILES["SCopy"]["tmp_name"], "r"), filesize ($_FILES["SCopy"]["tmp_name"])));
     if($fileSize>1048576){ $msg = "<font style='color:#FF0000;'>Error: Your file size is large, accept only <=1000KB size........!</font>"; $ok=0; } 
     else if($ext!= "jpg" && $ext!= "jpeg" && $ext!= "pdf"){ $msg = "<font style='color:#FF0000;'>Error: Only jpg or pdf file allow.....!</font>"; }
     else
     {   
       if($ext == "jpeg"){ $extt='jpg'; }else{ $extt=$ext; }
       $newfile = $MaxId.'_'.$resEmp['EmpCode'].'.'.$extt;
	   $newname = dirname(__FILE__).'/SprUploadFile/'.$newfile;
	   if((move_uploaded_file($_FILES['SCopy']['tmp_name'],$newname)))
       { 
	      ...
	      /** ---------------------------------------------------- **/
           ...
           {  
            ...
            if($resRep['EmailId_Vnr']!='')
            {
             ...
             $email_message .=$Ename. "(".$resEmp['DepartmentName']."),EC: ".$resEmp['EmpCode']."  , Grade : ".$resEmp['GradeValue'].", Designation : ".$resEmp['DesigName'].", Location: ".$resEmp['HqName'].", ".$resEmp['StateName']." has submitted resignation application, that needs to be approved within 5 working days. For more details Kindly log on to ESS. \n\n";
            ...
            //$Ename. "(".$resEmp['DepartmentName']."),EC: ".$resEmp['EmpCode']."  , Grade : ".$resEmp['GradeValue'].", Designation : ".$resEmp['DesigName'].", Location: ".$resEmp['HqName'].", ".$resEmp['StateName'].", Reporting Manager: ".$Aname.", EC: ".$resApp['EmpCode']."., has submitted resignation application, for more details kindly log on to ESS."
            ...
            $email_message2 .=$Ename. "(".$resEmp['DepartmentName']."),EC: ".$resEmp['EmpCode']."  , Grade : ".$resEmp['GradeValue'].", Designation : ".$resEmp['DesigName'].", Location: ".$resEmp['HqName'].", ".$resEmp['StateName'].", Reporting Manager: ".$Aname.", EC: ".$resApp['EmpCode']." has submitted resignation application, for more details kindly log on to ESS.\n\n";
            
            //$email_message2 .=$Ename." (".$resEmp['DepartmentCode'].") has submitted resignation application, for more details kindly log on to ESS.\n\n";
	        ...
	        $email_messageH .=$Ename. "(".$resEmp['DepartmentName']."),EC: ".$resEmp['EmpCode']."  , Grade : ".$resEmp['GradeValue'].", Designation : ".$resEmp['DesigName'].", Location: ".$resEmp['HqName'].", ".$resEmp['StateName'].", Reporting Manager: ".$Aname.", EC: ".$resApp['EmpCode']." has submitted resignation application, for more details kindly log on to ESS.\n\n";
	        
            //$email_messageH .=$Ename." (".$resEmp['DepartmentCode'].") has submitted resignation application, for more details kindly log on to ESS.\n\n";
            ...
            if($resEmp['GradeId']>=67 && $resEmp['GradeId']<=77)
            {
             ...
             $email_messageM .=$Ename. "(".$resEmp['DepartmentName']."),EC: ".$resEmp['EmpCode']."  , Grade : ".$resEmp['GradeValue'].", Designation : ".$resEmp['DesigName'].", Location: ".$resEmp['HqName'].", ".$resEmp['StateName'].", Reporting Manager: ".$Aname.", EC: ".$resApp['EmpCode']." has submitted resignation application, for more details kindly log on to ESS.\n\n";
             
             //$email_messageM .=$Ename." (".$resEmp['DepartmentCode'].") has submitted resignation application.\n\n";
            ...
            if($resHod['EmailId_Vnr']!='')
            {
             ...
             $email_message3 .=$Ename. "(".$resEmp['DepartmentName']."),EC: ".$resEmp['EmpCode']."  , Grade : ".$resEmp['GradeValue'].", Designation : ".$resEmp['DesigName'].", Location: ".$resEmp['HqName'].", ".$resEmp['StateName'].", Reporting Manager: ".$Aname.", EC: ".$resApp['EmpCode']." has submitted resignation application, for more details kindly log on to ESS.\n\n";
             
             //$email_message3 .=$Ename." (".$resEmp['DepartmentCode'].") has submitted resignation application, for more details kindly log on to ESS.\n\n";
			...
			echo '<script>alert("Your resignation request sent successfully.....");window.location="EmpSprtion.php?e=4e&w=234&y=10234&a=f&e=4e2&e=4e&w=234&y=110022344&retd=ee&wwrew=t%T@sed818&d=101";</script>';
            $msg="<font style='color:#008800;'>Your resignation request sent successfully.....</font>"; 
...
{ var filter=/^[a-zA-Z. /]+$/; var Numfilter=/^[0-9. ]+$/;
  ...
  var SCopy = formname.SCopy.value;
  if(SCopy.length === 0){ alert("Please upload the copy of signed resignation letter.");  return false; }
  
  //var RetainQAns1 = formname.RetainQAns1.value; var RetainQAns2 = formname.RetainQAns2.value; 
  //var RetainQAns3 = formname.RetainQAns3.value;
...
<table border="0" cellspacing="5">
 <tr>
  <td colspan="2" class="heading">
   ...
   &nbsp;&nbsp;<font style="color:#EC0000;font-size:18px;font-family:Times New Roman;font-style:italic;"><blink>
...
<td style="display:<?php if($_REQUEST['a']=='f'){echo 'block';}elseif($_REQUEST['a']=='e' OR $_REQUEST['a']=='c'){echo 'none';}?>;">
 ...
 <tr>
  <td colspan="2"></td>
  <td colspan="7" valign="top" style='font-family:Times New Roman;font-size:17px;'>
	 <b><i><?php echo $msg; ?></i></b></td>
 </tr>
  <tr>
  <td align="left" class="font2" style="width:120px;">&nbsp;&nbsp;Resignation Date</td><td style="width:10px;"><b>&nbsp;:&nbsp;</b></td>
  <td style="width:120px;"><input class="input" name="ResDate" id="ResDate" value="<?php if($rowch>0){echo date("d-m-Y", strtotime($resch['Emp_ResignationDate']));}else{echo date("d-m-Y"); } ?>" readonly>&nbsp;<button id="f_btn1" class="CalenderButton" disabled></button>
  ...
  <td align="right" class="font2" style="width:250px;">&nbsp;&nbsp;Expected Relieving Date (By Employee)</td><td style="width:10px;"><b>&nbsp;:&nbsp;</b></td>
 ...
 <tr>
  ...
  <td colspan="5" valign="top"><textarea name="Reason" id="Reason" style="width:535px;border-bottom-color:#000000;background-color:#E0DBE3;" cols="47" rows="6" disabled><?php if($rowch>0){echo $resch['Emp_Reason'];}else{echo ''; } ?></textarea></td>
 </tr>
 
 <tr>
  <td align="left" class="font2" style="width:120px;" valign="top">&nbsp;&nbsp;Upload</td><td style="width:10px;" valign="top"><b>&nbsp;:&nbsp;</b></td>
  <td colspan="5" valign="top" class="font2"><b>Resignation letter (duly signed)</b>&nbsp;&nbsp;&nbsp;<input type="file" size="" name="SCopy" id="SCopy" required onClick="FunAlert()" disabled="disabled"><?php if($resch['SprUploadFile']!='' && file_exists('SprUploadFile/'.$resch['SprUploadFile'])){ echo '<font color="#006600"><u><a href="SprUploadFile/'.$resch["SprUploadFile"].'" target="_blank"/>File uploded</u></font>'; } ?>
  </td>
 </tr>
 <script type="text/javascript">
 function FunAlert()
 {
  alert("Please ensure that you have signed your resignation letter!");
 }
 </script>
 <tr>
  <td align="left" class="font2" style="width:120px;" valign="top">&nbsp;&nbsp;Instructions:</td><td style="width:10px;" valign="top"><b>&nbsp;:&nbsp;</b></td>
  <td colspan="5" valign="top" class="font2"><b>File format</b> - <font color="#FF0000">JPEG or PDF, </font> &nbsp;&nbsp;&nbsp;<b>File size allow </b>- <font color="#FF0000">Max <font size="4">1</font>MB</font>.</td>
 </tr>
 <tr>
  <td align="left" class="font2" style="width:120px;" valign="top">&nbsp;&nbsp;Note</td><td style="width:10px;" valign="top"><b>&nbsp;:&nbsp;</b></td>
  <td colspan="5" valign="top" class="font2"> <font color="#FF0000" style="font-size:14px;">Resignation letter to be duly signed and original to be couriered (forward POD on mail) to HR for proceeding further. </font></td>
 </tr>
 
 <tr><td>&nbsp;</td></tr>
 <input type="hidden" name="RetainQAns1" id="RetainQAns1" value=""/>
 <input type="hidden" name="RetainQAns2" id="RetainQAns2" value=""/>
 <input type="hidden" name="RetainQAns3" id="RetainQAns3" value=""/>
 
 <?php /*
 <tr><td colspan="7" style="font-family:Times New Roman;font-size:16px;" align="">&nbsp;&nbsp;<b>Q.&nbsp;What can company do to retain you?</b></td></tr>
 <tr>
  <td colspan="7" style="font-family:Times New Roman;font-size:16px;" valign="top">&nbsp;&nbsp;<b>(1)</b>&nbsp;<input name="RetainQAns1" id="RetainQAns1" style="width:655px;border-bottom-color:#000000;background-color:#E0DBE3;" maxlength="200" value="<?php if($rowch>0){echo $resch['RetainQAns1'];}else{echo ''; } ?>" disabled/></td>
 </tr>
 <tr>
  <td colspan="7" style="font-family:Times New Roman;font-size:16px;" valign="top">&nbsp;&nbsp;<b>(2)</b>&nbsp;<input name="RetainQAns2" id="RetainQAns2" style="width:655px;border-bottom-color:#000000;background-color:#E0DBE3;" maxlength="200" value="<?php if($rowch>0){echo $resch['RetainQAns2'];}else{echo ''; } ?>" disabled/></td>
 </tr>
 <tr>
  <td colspan="7" style="font-family:Times New Roman;font-size:16px;" valign="top">&nbsp;&nbsp;<b>(3)</b>&nbsp;<input name="RetainQAns3" id="RetainQAns3" style="width:655px;border-bottom-color:#000000;background-color:#E0DBE3;" maxlength="200" value="<?php if($rowch>0){echo $resch['RetainQAns3'];}else{echo ''; } ?>" disabled/></td>
 </tr>
 */ ?>
...
<form name="form3name" enctype="multipart/form-data" method="post" onSubmit="return Vvalidate3(this)">
