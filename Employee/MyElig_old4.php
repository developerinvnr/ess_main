...
<?php if($ResCtc['ESCI']>0){ echo ''; } else {?>			  
			  <tr>
			    <td style="width:485px;font-size:16px;height:22px;" align="left"><b>*.</b>&nbsp;Health Insurance (Sum Insured) </td>
...
<?php if($CompanyId==1) { //Group Personal Accident Insurance ?>  
              <tr>
			    <td style="width:485px;font-size:16px;height:22px;" align="left"><b>*.</b>&nbsp;Group Term Life Insurance (Sum Insured) </td>
